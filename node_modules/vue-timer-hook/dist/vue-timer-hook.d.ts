...
export declare function useStopwatch(offsetTimestamp?: number, autoStart?: boolean): ResUseStopwatch;

export declare function useTime(format?: '12-hour' | '24-hour'): ResUseTime;
...
export declare function useTimer(expiry?: number, autoStart?: boolean): UseTimer;
