...
//#region node_modules/simple-web-worker/dist/sww.min.js
var require_sww_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	function postAll() {
		...
		if (isValid(e)([
			...
			if (0 === e.length) return Promise.all(this.actions.map(function(e) {
				var n = e.message;
			...
			if (e.every(function(r) {
				...
				return r.postMessage(e);
			}));
			if (e.every(function(r) {
				return "object" === (void 0 === r ? "undefined" : _typeof(r)) && !Array.isArray(r);
			})) return Promise.all(e.map(function(e) {
				var n = e.message, t = e.args;
				return r.postMessage(n, t);
			}));
			if (e.every(function(r) {
				return Array.isArray(r);
			}) && e.length === this.actions.length) return Promise.all(e.map(function(e, n) {
				return r.postMessage(r.actions[n].message, e);
			}));
		}
	...
	var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(r) {
		...
		return function() {
			...
			return Array.isArray(e) ? e.some(function(e) {
				return isValidArg(r)(e);
			}) : !!isValidArg(r)(e);
		};
	}, argumentError = function(r) {
		var e = r.expected, n = void 0 === e ? "" : e, t = r.received, o = r.extraInfo, i = void 0 === o ? "" : o;
		try {
			return /* @__PURE__ */ new TypeError("You should provide " + n + "\n" + i + "\nReceived: " + JSON.stringify(t));
		} catch (r) {
			if ("Converting circular structure to JSON" === r.message) return /* @__PURE__ */ new TypeError("You should provide " + n + "\n" + i + "\nReceived a circular structure: " + t);
			throw r;
		}
	}, makeResponse = function(r) {
		return "\n  self.onmessage = event => {\n    const args = event.data.message.args\n    if (args) {\n      self.postMessage((" + r + ").apply(null, args))\n      return close()\n    }\n    self.postMessage((" + r + ")())\n    return close()\n  }\n";
	}, createDisposableWorker = function(r) {
		...
		if (n && t) return createDisposableWorker(makeResponse(r)).post({ args: e });
		...
		return function() {
			...
			return t || console.error(argumentError({
				expected: "a string",
				received: e
			})), o || console.error(argumentError({
				expected: "an array",
				received: n
			})), null;
		};
	}, makeOptionsFor = function(r) {
		return {
	...
	}, isActionOf = function(r) {
		return function(e) {
			return r.some(function(r) {
				return r.message === e.message;
			});
		};
	}, warnMsg = function(r) {
		...
		return function() {
			var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
			return isValid(e)(["action", "actionsArray"]) ? Array.isArray(e) ? e.reduce(function(r, e) {
				return pushInto(r)(e), r;
		...
		return function() {
			var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
			return isValid(e)(["string", "stringsArray"]) ? Array.isArray(e) ? e.reduce(function(r, e) {
				return removeFrom(r)(e), r;
		...
		return isValid(r)("actionsArray") ? {
			actions: r,
			postMessage: post(r),
			postAll,
			register: register(r),
			unregister: unregister(r)
		} : (console.error(argumentError(options(r))), null);
	}, createWrapper = function() {
		return window.Worker ? window.URL.createObjectURL || window.webkitURL.createObjectURL ? {
			create,
			run
		} : (console.error("This browser does not have URL.createObjectURL method."), null) : (console.error("This browser does not support Workers."), null);
	};
	module.exports = createWrapper();
}));
//#endregion
export { require_sww_min as t };

//# sourceMappingURL=sww.min-Baxw9RCc.js.map