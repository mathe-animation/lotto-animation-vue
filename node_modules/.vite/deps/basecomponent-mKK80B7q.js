import { It as onMounted, Kn as readonly, Ot as mergeProps, _n as watch, dt as getCurrentInstance, kt as nextTick, ln as useId, qn as ref } from "./runtime-dom.esm-bundler-Crpa9Jqi.js";
import "./vue.js";
	...
	if (a(e)) {
		...
		if (G$1(a, k)) {
			let n = a.replaceAll(k, (l) => {
				return `var(${ae(r, re(l.replace(/{|}/g, "").split(".").filter((m) => !s.some((d) => G$1(m, d))).join("-")))}${s$2(i) ? `, ${i}` : ""})`;
			});
...
var BaseStyle = {
	...
	load: function load(style) {
		...
		return s$2(computedStyle) ? useStyle(Y$2(computedStyle), _objectSpread$1({ name: this.name }, options)) : {};
	},
	...
	getThemeStyleSheet: function getThemeStyleSheet(params) {
		...
		if (this.style) {
			...
			var _props = Object.entries(props).reduce(function(acc, _ref4) {
				var _ref5 = _slicedToArray$1(_ref4, 2), k = _ref5[0], v = _ref5[1];
				return acc.push("".concat(k, "=\"").concat(v, "\"")) && acc;
			}, []).join(" ");
			s$2(_style) && css.push("<style type=\"text/css\" data-primevue-style-id=\"".concat(name, "\" ").concat(_props, ">").concat(_style, "</style>"));
		}
		return css.join("");
	},
...
var script = {
	...
	methods: {
		...
		_loadGlobalStyles: function _loadGlobalStyles() {
			...
			s$2(globalCSS) && BaseStyle.load(globalCSS, _objectSpread({ name: "global" }, this.$styleOptions));
		},
		...
		_getPTDatasets: function _getPTDatasets() {
			...
			return key !== "transition" && _objectSpread(_objectSpread({}, key === "root" && _objectSpread(_objectSpread(_defineProperty({}, "".concat(datasetPrefix, "name"), g$1(isExtended ? (_this$pt5 = this.pt) === null || _this$pt5 === void 0 ? void 0 : _this$pt5["data-pc-section"] : this.$.type.name)), isExtended && _defineProperty({}, "".concat(datasetPrefix, "extend"), g$1(this.$.type.name))), {}, _defineProperty({}, "".concat(this.$attrSelector), ""))), {}, _defineProperty({}, "".concat(datasetPrefix, "section"), g$1(key)));
		},
		_getPTClassValue: function _getPTClassValue() {
			var value = this._getOptionValue.apply(this, arguments);
			return a(value) || C$2(value) ? { "class": value } : value;
		},
...
//#endregion
export { a as $, Wt as A, tt as B, Q$1 as C, U as D, Tt as E, b$1 as F, s$1 as G, vt as H, bt as I, F$1 as J, B$1 as K, et as L, Yt as M, _t as N, V as O, at as P, X as Q, kt as R, P as S, S$1 as T, z as U, v$1 as V, f as W, M$1 as X, J$1 as Y, W$1 as Z, J as _, S as a, k$2 as at, Mt as b, $t as c, ne$1 as ct, D as d, s$2 as dt, c$1 as et, Dt as f, It as g, I as h, N as i, i as it, Y$1 as j, W as k, At as l, p as lt, Ht as m, BaseStyle as n, g$1 as nt, x as o, l as ot, G as p, C$2 as q, Base as r, h$2 as rt, s, m as st, script as t, ee as tt, C$1 as u, q as ut, K as v, Rt as w, Ot as x, Lt as y, pt as z };

//# sourceMappingURL=basecomponent-mKK80B7q.js.map