//#region node_modules/random/dist/index.js
...
function createRNG(seedOrRNG) {
	switch (typeof seedOrRNG) {
		...
		default: return new ARC4RNG(seedOrRNG);
	}
...
function mixKey(seed, key) {
	...
	let smear = 0;
	let j = 0;
	while (j < seedStr.length) key[255 & j] = 255 & (smear ^= ((_a = key[255 & j]) != null ? _a : 0) * 19) + seedStr.charCodeAt(j++);
...
var logSqrt2PI = .9189385332046727;
...
var Random = class _Random {
	...
	*/
	choice(array) {
		...
		if (length > 0) return array[this.uniformInt(0, length - 1)()];
		else return;
	}
	/**
...
//#endregion
export { ARC4RNG, FunctionRNG, MathRandomRNG, RNG, Random, XOR128RNG, createRNG, random_default as default, mixKey, shuffleInPlace, sparseFisherYates };
