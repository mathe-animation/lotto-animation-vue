import { t as en_default } from "./en-pPVWESl9.js";
//#region node_modules/vuetify/lib/locale/af.js
var af_default = {
	badge: "Kenteken",
	open: "Maak oop",
	close: "Maak toe",
	...
	datePicker: {
		...
		input: { placeholder: "Voer datum in" },
		ariaLabel: {
	...
	carousel: {
		...
		ariaLabel: { delimiter: "Carousel skyfie {0} van {1}" }
	},
	calendar: {
		moreEvents: "{0} meer",
		today: "Vandag"
	...
	rating: { ariaLabel: { item: "Gradering {0} van {1}" } },
	loading: "Laai...",
	infiniteScroll: {
		loadMore: "Laai meer",
		empty: "Geen meer nie"
	...
	command: { search: "Tik 'n opdrag of soek..." },
	hotkey: {
		then: "dan",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/ar.js
var ar_default = {
	badge: "شارة",
	open: "Open",
	close: "إغلاق",
	...
	carousel: {
		prev: "المعروض السابق",
		next: "المعروض التالي",
		ariaLabel: { delimiter: "المعروض رقم {0} من {1}" }
	},
	calendar: {
		moreEvents: "{0} أكثر",
		today: "Today"
	...
	rating: { ariaLabel: { item: "القييم {0} من {1}" } },
	loading: "Loading...",
	infiniteScroll: {
		loadMore: "Load more",
		empty: "No more"
	...
	command: { search: "اكتب أمراً أو ابحث..." },
	hotkey: {
		then: "ثم",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/bg.js
var bg_default = {
	badge: "Значка",
	open: "Отвори",
	close: "Затвори",
	...
	datePicker: {
		...
		input: { placeholder: "Въведете дата" },
		ariaLabel: {
	...
	carousel: {
		...
		ariaLabel: { delimiter: "Кадър {0} от {1} на въртележката" }
	},
	calendar: {
		moreEvents: "Още {0}",
		today: "Днес"
	...
	rating: { ariaLabel: { item: "Оценка {0} от {1}" } },
	loading: "Зареждане...",
	infiniteScroll: {
		loadMore: "Зареди още",
		empty: "Няма повече"
	...
	command: { search: "Въведете команда или търсете..." },
	hotkey: {
		then: "след това",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/ca.js
var ca_default = {
	badge: "Insígnia",
	open: "Obrir",
	close: "Tancar",
	...
	datePicker: {
		...
		input: { placeholder: "Introdueix la data" },
		ariaLabel: {
	...
	carousel: {
		...
		ariaLabel: { delimiter: "Diapositiva {0} de {1}" }
	},
	calendar: {
		moreEvents: "{0} més",
		today: "Avui"
	...
	rating: { ariaLabel: { item: "Puntuació {0} de {1}" } },
	loading: "Carregant...",
	infiniteScroll: {
	...
	command: { search: "Escriu una ordre o cerca..." },
	hotkey: {
		then: "després",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/ckb.js
var ckb_default = {
	badge: "باج",
	open: "کردنەوە",
	close: "داخستن",
	...
	datePicker: {
		...
		input: { placeholder: "بەروار بنووسە" },
		ariaLabel: {
	...
	carousel: {
		...
		ariaLabel: { delimiter: "سلایدی کارۆسێل {0} لە {1}" }
	},
	calendar: {
		moreEvents: "{0} زیاتر",
		today: "ئەمڕو"
	...
	rating: { ariaLabel: { item: "هەڵسەنگاندن {0} لە {1}" } },
	loading: "بارکردن...",
	infiniteScroll: {
	...
	command: { search: "فرمان بنووسە یان بگەڕە..." },
	hotkey: {
		then: "پاشان",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/cs.js
var cs_default = {
	badge: "Odznak",
	open: "Otevřít",
	close: "Zavřít",
	...
	carousel: {
		...
		next: "Další obrázek",
		ariaLabel: { delimiter: "Obrázek {0} z {1}" }
	},
	calendar: {
	...
	rating: { ariaLabel: { item: "Hodnocení {0} z {1}" } },
	loading: "Načítám...",
	infiniteScroll: {
	...
	command: { search: "Zadejte příkaz nebo hledejte..." },
	hotkey: {
		then: "poté",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/da.js
var da_default = {
	badge: "Emblem",
	open: "Åbn",
	close: "Luk",
	...
	datePicker: {
		...
		title: "Vælg dato",
		header: "Indtast dato",
		input: { placeholder: "Indtast dato" },
		ariaLabel: {
	...
	carousel: {
		...
		next: "Næste visuelle",
		ariaLabel: { delimiter: "Karrusel dias {0} af {1}" }
	},
	calendar: {
		moreEvents: "{0} mere",
		today: "I dag"
	...
	rating: { ariaLabel: { item: "Bedømmelse {0} af {1}" } },
	loading: "Indlæser...",
	infiniteScroll: {
	...
	command: { search: "Skriv en kommando eller søg..." },
	hotkey: {
		then: "derefter",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/de.js
var de_default = {
	badge: "Abzeichen",
	open: "Öffnen",
	close: "Schließen",
	...
	datePicker: {
		...
		input: { placeholder: "Datum eingeben" },
		ariaLabel: {
	...
	rating: { ariaLabel: { item: "Bewertung {0} von {1}" } },
	loading: "Laden...",
	infiniteScroll: {
		loadMore: "Mehr laden",
	...
	command: { search: "Geben Sie einen Befehl ein oder suchen Sie..." },
	hotkey: {
		then: "dann",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/el.js
var el_default = {
	badge: "Σήμα",
	open: "Άνοιγμα",
	close: "Κλείσιμο",
	...
	datePicker: {
		...
		input: { placeholder: "Εισαγάγετε ημερομηνία" },
		ariaLabel: {
	...
	carousel: {
		prev: "הקודם חזותי",
		next: "הבא חזותי",
		ariaLabel: { delimiter: "Διαφάνεια καρουζέλ {0} από {1}" }
	},
	calendar: {
		moreEvents: "{0} ακόμη",
		today: "Σήμερα"
	...
	rating: { ariaLabel: { item: "Βαθμολογία {0} από {1}" } },
	loading: "Φόρτωση...",
	infiniteScroll: {
	...
	command: { search: "Πληκτρολογήστε μια εντολή ή αναζητήστε..." },
	hotkey: {
		then: "στη συνέχεια",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/es.js
var es_default = {
	badge: "Placa",
	open: "Abrir",
	close: "Cerrar",
	...
	datePicker: {
		...
		input: { placeholder: "Introducir fecha" },
		ariaLabel: {
			previousMonth: "Mes anterior",
	...
	carousel: {
		...
		ariaLabel: { delimiter: "Visual {0} de {1}" }
	},
	calendar: {
		moreEvents: "{0} más",
		today: "Hoy"
	...
	rating: { ariaLabel: { item: "Puntuación {0} de {1}" } },
	loading: "Cargando...",
	infiniteScroll: {
		loadMore: "Cargar más",
		empty: "No hay más"
...
//#endregion
//#region node_modules/vuetify/lib/locale/et.js
var et_default = {
	badge: "Märk",
	open: "Ava",
	close: "Sulge",
	...
	datePicker: {
		...
		input: { placeholder: "Sisesta kuupäev" },
		ariaLabel: {
	...
	carousel: {
		...
		ariaLabel: { delimiter: "Karusselli slaid {0} {1}st" }
	},
	calendar: {
		moreEvents: "{0} veel",
		today: "Täna"
	...
	rating: { ariaLabel: { item: "Hinnang {0} {1}st" } },
	loading: "Laadimine...",
	infiniteScroll: {
	...
	command: { search: "Sisestage käsk või otsige..." },
	hotkey: {
		then: "siis",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/fa.js
var fa_default = {
	badge: "نشان",
	open: "باز کردن",
	close: "بستن",
	...
	datePicker: {
		...
		input: { placeholder: "تاریخ را وارد کنید" },
		ariaLabel: {
	...
	carousel: {
		prev: "اسلاید قبلی",
		next: "اسلاید بعدی",
		ariaLabel: { delimiter: "اسلاید {0} از {1}" }
	},
	calendar: {
		moreEvents: "{بیشتر {0",
		today: "امروز"
	...
	rating: { ariaLabel: { item: "امتیاز {0} از {1}" } },
	...
	command: { search: "دستور را تایپ کنید یا جستجو کنید..." },
	hotkey: {
		then: "سپس",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/fi.js
var fi_default = {
	badge: "Infopiste",
	open: "Avaa",
	close: "Sulje",
	...
	datePicker: {
		...
		input: { placeholder: "Syötä päivämäärä" },
		ariaLabel: {
	...
	carousel: {
		prev: "Edellinen kuva",
		next: "Seuraava kuva",
		ariaLabel: { delimiter: "Karusellin kuva {0}/{1}" }
	},
	calendar: {
		moreEvents: "{0} lisää",
		today: "Tänään"
	...
	rating: { ariaLabel: { item: "Luokitus {0}/{1}" } },
	loading: "Ladataan...",
	infiniteScroll: {
	...
	command: { search: "Kirjoita komento tai hae..." },
	hotkey: {
		then: "sitten",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/fr.js
var fr_default = {
	badge: "Badge",
	open: "Ouvrir",
	close: "Fermer",
	...
	datePicker: {
		...
		input: { placeholder: "Entrer une date" },
		ariaLabel: {
	...
	carousel: {
		...
		next: "Visuel suivant",
		ariaLabel: { delimiter: "Diapositive {0} de {1}" }
	},
	calendar: {
	...
	rating: { ariaLabel: { item: "Note de {0} sur {1}" } },
	loading: "Chargement...",
	infiniteScroll: {
...
//#endregion
//#region node_modules/vuetify/lib/locale/hr.js
var hr_default = {
	badge: "Bedž",
	open: "Otvori",
	close: "Zatvori",
	...
	datePicker: {
		...
		input: { placeholder: "Unesite datum" },
		ariaLabel: {
	...
	carousel: {
		prev: "Prethodno",
		next: "Sljedeće",
		ariaLabel: { delimiter: "Slajd {0} od {1}" }
	},
	calendar: {
		moreEvents: "Još {0}",
		today: "Danas"
	...
	rating: { ariaLabel: { item: "Ocjena {0} od {1}" } },
	loading: "Učitavanje...",
	infiniteScroll: {
	...
	command: { search: "Unesite naredbu ili pretražite..." },
	hotkey: {
		then: "zatim",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/hu.js
var hu_default = {
	badge: "Jelvény",
	open: "Megnyit",
	close: "Bezárás",
	...
	datePicker: {
		...
		input: { placeholder: "Adja meg a dátumot" },
		ariaLabel: {
	...
	rating: { ariaLabel: { item: "Értékelés: {0} / {1}" } },
	loading: "Betöltés...",
	infiniteScroll: {
	...
	command: { search: "Írjon be parancsot vagy keressen..." },
	hotkey: {
		then: "majd",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/he.js
var he_default = {
	badge: "תג",
	open: "פתח",
	close: "סגור",
	...
	carousel: {
		prev: "מצג קודם",
		next: "מצג הבא",
		ariaLabel: { delimiter: "שקופית {0} מתוך {1}" }
	},
	calendar: {
		moreEvents: "{0} נוספים",
		today: "היום"
	...
	rating: { ariaLabel: { item: "דירוג {0} מתוך {1}" } },
	loading: "טוען...",
	infiniteScroll: {
		loadMore: "טען עוד",
	...
	command: { search: "הקלד פקודה או חפש..." },
	hotkey: {
		then: "אז",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/id.js
var id_default = {
	badge: "Lencana",
	open: "Buka",
	close: "Tutup",
	...
	carousel: {
		...
		ariaLabel: { delimiter: "Slide {0} dari {1}" }
	},
	calendar: {
		moreEvents: "{0} lagi",
		today: "Hari ini"
	...
	rating: { ariaLabel: { item: "Penilaian {0} dari {1}" } },
	loading: "Memuat...",
	infiniteScroll: {
	...
	command: { search: "Ketik perintah atau cari..." },
	hotkey: {
		then: "kemudian",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/it.js
var it_default = {
	badge: "Distintivo",
	open: "Apri",
	close: "Chiudi",
	...
	carousel: {
		...
		next: "Prossima vista",
		ariaLabel: { delimiter: "Slide carosello {0} di {1}" }
	},
	calendar: {
		moreEvents: "{0} di più",
		today: "Oggi"
	...
	rating: { ariaLabel: { item: "Valutazione {0} di {1}" } },
	loading: "Caricamento...",
	infiniteScroll: {
	...
	command: { search: "Digita un comando o cerca..." },
	hotkey: {
		then: "poi",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/ja.js
var ja_default = {
	badge: "バッジ",
	open: "開く",
	close: "閉じる",
	...
	carousel: {
		prev: "前のビジュアル",
		next: "次のビジュアル",
		ariaLabel: { delimiter: "カルーセルのスライド {0}件目 / {1}件" }
	},
	calendar: {
		moreEvents: "さらに{0}",
		today: "今日"
	...
	rating: { ariaLabel: { item: "評価 {1} のうち {0}" } },
	loading: "ロード中...",
	infiniteScroll: {
		loadMore: "さらに読み込む",
		empty: "データがありません"
...
//#endregion
//#region node_modules/vuetify/lib/locale/km.js
var km_default = {
	badge: "ផ្លាក",
	open: "បើក",
	close: "បិទ",
	...
	datePicker: {
		...
		title: "ជ្រើសរើសកាលបរិច្ឆេទ",
		header: "បញ្ចូលកាលបរិច្ឆេទ",
		input: { placeholder: "បញ្ចូលកាលបរិច្ឆេទ" },
		ariaLabel: {
	...
	carousel: {
		...
		ariaLabel: { delimiter: "រូបភាពទី {0} នៃ {1} ក្នុងកម្រិតការរុករក" }
	},
	calendar: {
		moreEvents: "{0} ទៀត",
		today: "ថ្ងៃនេះ"
	...
	rating: { ariaLabel: { item: "ការវាយតម្លៃ {0} នៃ {1}" } },
	...
	command: { search: "វាយបញ្ចូលពាក្យបញ្ជា ឬស្វាគមន៍..." },
	hotkey: {
		then: "បន្ទាប់មក",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/ko.js
var ko_default = {
	badge: "배지",
	open: "열기",
	close: "닫기",
	...
	carousel: {
		prev: "이전 화면",
		next: "다음 화면",
		ariaLabel: { delimiter: "캐러셀 슬라이드 {0} / {1}" }
	},
	calendar: {
		moreEvents: "{0} 더보기",
		today: "오늘"
	...
	command: { search: "명령을 입력하거나 검색하세요..." },
	hotkey: {
		then: "그 다음",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/lv.js
var lv_default = {
	badge: "Žetons",
	open: "Atvērt",
	close: "Aizvērt",
	...
	datePicker: {
		...
		input: { placeholder: "Ievadiet datumu" },
		ariaLabel: {
	...
	carousel: {
		...
		ariaLabel: { delimiter: "Karuseļa slaids {0} no {1}" }
	},
	calendar: {
		moreEvents: "Vēl {0}",
		today: "Šodien"
	...
	rating: { ariaLabel: { item: "Vērtējums {0} no {1}" } },
	loading: "Ielādē...",
	infiniteScroll: {
	...
	command: { search: "Ierakstiet komandu vai meklējiet..." },
	hotkey: {
		then: "tad",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/lt.js
var lt_default = {
	badge: "Ženklelis",
	open: "Atidaryti",
	close: "Uždaryti",
	...
	datePicker: {
		...
		input: { placeholder: "Įveskite datą" },
		ariaLabel: {
	...
	carousel: {
		...
		next: "Kita skaidrė",
		ariaLabel: { delimiter: "Skaidrė {0} iš {1}" }
	},
	calendar: {
	...
	rating: { ariaLabel: { item: "Įvertinimas {0} iš {1}" } },
	loading: "Kraunama...",
	infiniteScroll: {
	...
	command: { search: "Įveskite komandą arba ieškokite..." },
	hotkey: {
		then: "tada",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/nl.js
var nl_default = {
	badge: "Insigne",
	open: "Openen",
	close: "Sluiten",
	...
	carousel: {
		...
		ariaLabel: { delimiter: "Carrousel afbeelding {0} van {1}" }
	},
	calendar: {
		moreEvents: "{0} meer",
		today: "Vandaag"
	...
	rating: { ariaLabel: { item: "Beoordeling {0} van {1}" } },
	...
	command: { search: "Typ een opdracht of zoek..." },
	hotkey: {
		then: "dan",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/no.js
var no_default = {
	badge: "Skilt",
	open: "Åpne",
	close: "Lukk",
	...
	datePicker: {
		...
		title: "Velg dato",
		header: "Velg dato",
		input: { placeholder: "Fyll inn dato" },
		ariaLabel: {
			previousMonth: "Forrige måned",
	...
	carousel: {
		prev: "Forrige bilde",
		next: "Neste bilde",
		ariaLabel: { delimiter: "Karusellbilde {0} av {1}" }
	},
	calendar: {
		moreEvents: "{0} flere",
		today: "I dag"
	...
	rating: { ariaLabel: { item: "Anmeldelse {0} av {1}" } },
	loading: "Laster...",
	infiniteScroll: {
		loadMore: "Last flere",
		empty: "Det var alt"
	...
	command: { search: "Skriv en kommando eller søk..." },
	hotkey: {
		then: "deretter",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/pl.js
var pl_default = {
	badge: "Odznaka",
	open: "Otwórz",
	close: "Zamknij",
	...
	datePicker: {
		...
		input: { placeholder: "Wprowadź datę" },
		ariaLabel: {
	...
	carousel: {
		...
		next: "Następny obraz",
		ariaLabel: { delimiter: "Obraz {0} z {1}" }
	},
	calendar: {
		moreEvents: "{0} więcej",
		today: "Dzisiaj"
	...
	rating: { ariaLabel: { item: "Ocena {0} na {1}" } },
	...
	command: { search: "Wpisz polecenie lub szukaj..." },
	hotkey: {
		then: "następnie",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/pt.js
var pt_default = {
	badge: "Distintivo",
	open: "Abrir",
	close: "Fechar",
	...
	carousel: {
		prev: "Visão anterior",
		next: "Próxima visão",
		ariaLabel: { delimiter: "Slide {0} de {1} do carrossel" }
	},
	calendar: {
		moreEvents: "Mais {0}",
		today: "Hoje"
	...
	command: { search: "Digite um comando ou pesquise..." },
	hotkey: {
		then: "então",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/ro.js
var ro_default = {
	badge: "Insignă",
	open: "Open",
	close: "Închideți",
	...
	dateRangeInput: { divider: "până la" },
	datePicker: {
		...
		input: { placeholder: "Introduceți data" },
		ariaLabel: {
	...
	carousel: {
		...
		ariaLabel: { delimiter: "Slide carusel {0} din {1}" }
	},
	calendar: {
		moreEvents: "încă {0}",
		today: "Today"
	...
	rating: { ariaLabel: { item: "Evaluare {0} din {1}" } },
	loading: "Se încarcă...",
	infiniteScroll: {
	...
	command: { search: "Tastați o comandă sau căutați..." },
	hotkey: {
		then: "apoi",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/ru.js
var ru_default = {
	badge: "Знак",
	open: "Открыть",
	close: "Закрыть",
	...
	rating: { ariaLabel: { item: "Рейтинг {0} из {1}" } },
	loading: "Загрузка...",
	infiniteScroll: {
	...
	command: { search: "Введите команду или введите..." },
	hotkey: {
		then: "затем",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/sk.js
var sk_default = {
	badge: "Odznak",
	open: "Otvoriť",
	close: "Zavrieť",
	...
	datePicker: {
		...
		input: { placeholder: "Zadajte dátum" },
		ariaLabel: {
	...
	carousel: {
		...
		next: "Další obrázok",
		ariaLabel: { delimiter: "Snímka {0} z {1}" }
	},
	calendar: {
	...
	rating: { ariaLabel: { item: "Hodnotenie {0} z {1}" } },
	loading: "Načítavam...",
	infiniteScroll: {
	...
	command: { search: "Zadajte príkaz alebo hľadajte..." },
	hotkey: {
		then: "potom",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/sl.js
var sl_default = {
	badge: "Značka",
	open: "Odpri",
	close: "Zapri",
	...
	datePicker: {
		...
		input: { placeholder: "Vnesite datum" },
		ariaLabel: {
	...
	carousel: {
		...
		ariaLabel: { delimiter: "Prikaz {0} od {1}" }
	},
	calendar: {
		moreEvents: "Še {0}",
		today: "Danes"
	...
	rating: { ariaLabel: { item: "Ocena {0} od {1}" } },
	loading: "Nalaganje ...",
	infiniteScroll: {
		loadMore: "Naloži več",
		empty: "Konec"
	...
	command: { search: "Vnesite ukaz ali iščite..." },
	hotkey: {
		then: "nato",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/sr-Cyrl.js
var sr_Cyrl_default = {
	badge: "Значка",
	open: "Отвори",
	close: "Затвори",
	...
	datePicker: {
		...
		input: { placeholder: "Унесите датум" },
		ariaLabel: {
			previousMonth: "Previous month",
			nextMonth: "Next month",
			selectYear: "Select year",
	...
	carousel: {
		...
		next: "Следећа слика",
		ariaLabel: { delimiter: "Слика {0} од {1}" }
	},
	calendar: {
		moreEvents: "{0} више",
		today: "Данас"
	...
	rating: { ariaLabel: { item: "Оцена {0} од {1}" } },
	loading: "Учитавање...",
	infiniteScroll: {
	...
	command: { search: "Унесите команду или претражите..." },
	hotkey: {
		then: "затим",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/sr-Latn.js
var sr_Latn_default = {
	badge: "Značka",
	open: "Otvori",
	close: "Zatvori",
	...
	carousel: {
		...
		next: "Sledeća slika",
		ariaLabel: { delimiter: "Slika {0} od {1}" }
	},
	calendar: {
		moreEvents: "{0} više",
		today: "Danas"
...
//#endregion
//#region node_modules/vuetify/lib/locale/sv.js
var sv_default = {
	badge: "Bricka",
	open: "Öppna",
	close: "Stäng",
	...
	carousel: {
		prev: "Föregående vy",
		next: "Nästa vy",
		ariaLabel: { delimiter: "Karusellvy {0} av {1}" }
	},
	calendar: {
		moreEvents: "{0} fler",
		today: "Idag"
	...
	rating: { ariaLabel: { item: "Betyg {0} av {1}" } },
	loading: "Laddar...",
	infiniteScroll: {
		loadMore: "Ladda fler",
		empty: "Inga fler"
	...
	command: { search: "Skriv ett kommando eller sök..." },
	hotkey: {
		then: "sedan",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/th.js
var th_default = {
	badge: "สัญลักษณ์",
	open: "เปิด",
	close: "ปิด",
	...
	carousel: {
		prev: "ภาพก่อนหน้า",
		next: "ภาพถัดไป",
		ariaLabel: { delimiter: "ภาพสไลด์ที่ {0} จาก {1}" }
	},
	calendar: {
		moreEvents: "มีอีก {0}",
		today: "วันนี้"
	...
	rating: { ariaLabel: { item: "คะแนน {0} จาก {1}" } },
	loading: "กำลังโหลด...",
	infiniteScroll: {
	...
	command: { search: "พิมพ์คำสั่งหรือค้นหา..." },
	hotkey: {
		then: "จากนั้น",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/tr.js
var tr_default = {
	badge: "Rozet",
	open: "Aç",
	close: "Kapat",
	...
	carousel: {
		prev: "Önceki görsel",
		next: "Sonraki görsel",
		ariaLabel: { delimiter: "Galeri sayfa {0} / {1}" }
	},
	calendar: {
	...
	rating: { ariaLabel: { item: "{1} üzerinden {0} puan" } },
	loading: "Yükleniyor...",
	infiniteScroll: {
	...
	command: { search: "Komut yazın veya arayın..." },
	hotkey: {
		then: "sonra",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/az.js
var az_default = {
	badge: "Nişan",
	open: "Açıq",
	close: "Bağla",
	...
	datePicker: {
		...
		input: { placeholder: "Tarixi daxil edin" },
		ariaLabel: {
	...
	carousel: {
		...
		ariaLabel: { delimiter: "Galereya səhifə {0} / {1}" }
	},
	calendar: {
	...
	rating: { ariaLabel: { item: "Reytinq {0}/{1}" } },
	loading: "Yüklənir...",
	infiniteScroll: {
	...
	command: { search: "Əmr yazın və ya axtarış edin..." },
	hotkey: {
		then: "sonra",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/uk.js
var uk_default = {
	badge: "Значок",
	open: "Відкрити",
	close: "Закрити",
	...
	carousel: {
		...
		next: "Наступий слайд",
		ariaLabel: { delimiter: "Слайд {0} з {1}" }
	},
	calendar: {
		moreEvents: "Ще {0}",
		today: "Сьогодні"
	...
	rating: { ariaLabel: { item: "Оцінка {0} з {1}" } },
	...
	command: { search: "Введіть команду або виконайте пошук..." },
	hotkey: {
		then: "потім",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/vi.js
var vi_default = {
	badge: "Huy hiệu",
	open: "Mở",
	close: "Đóng",
	...
	carousel: {
		prev: "Ảnh trước",
		next: "Ảnh tiếp theo",
		ariaLabel: { delimiter: "Carousel slide {0} trên {1}" }
	},
	calendar: {
		moreEvents: "{0} nữa",
		today: "Hôm nay"
	...
	command: { search: "Nhập lệnh hoặc tìm kiếm..." },
	hotkey: {
		then: "sau đó",
		ctrl: "Ctrl",
		command: "Command",
...
//#endregion
//#region node_modules/vuetify/lib/locale/zh-Hans.js
var zh_Hans_default = {
	badge: "徽章",
	open: "打开",
	close: "关闭",
...
//#endregion
//#region node_modules/vuetify/lib/locale/zh-Hant.js
var zh_Hant_default = {
	badge: "徽章",
	open: "開啟",
	close: "關閉",
	...
	carousel: {
		prev: "上一張",
		next: "下一張",
		ariaLabel: { delimiter: "第 {0} 張 / 共 {1} 張" }
	},
	calendar: {
		moreEvents: "還有其他 {0} 項",
		today: "今天"
...
//#endregion
export { af_default as af, ar_default as ar, az_default as az, bg_default as bg, ca_default as ca, ckb_default as ckb, cs_default as cs, da_default as da, de_default as de, el_default as el, en_default as en, es_default as es, et_default as et, fa_default as fa, fi_default as fi, fr_default as fr, he_default as he, hr_default as hr, hu_default as hu, id_default as id, it_default as it, ja_default as ja, km_default as km, ko_default as ko, lt_default as lt, lv_default as lv, nl_default as nl, no_default as no, pl_default as pl, pt_default as pt, ro_default as ro, ru_default as ru, sk_default as sk, sl_default as sl, sr_Cyrl_default as srCyrl, sr_Latn_default as srLatn, sv_default as sv, th_default as th, tr_default as tr, uk_default as uk, vi_default as vi, zh_Hans_default as zhHans, zh_Hant_default as zhHant };
