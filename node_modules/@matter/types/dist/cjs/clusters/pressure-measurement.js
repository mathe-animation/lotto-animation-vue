...
((PressureMeasurement2) => {
  ...
  PressureMeasurement2.ExtendedComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      scaledValue: (0, import_Cluster.Attribute)(16, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvInt16)),
      /**
       ...
       */
      minScaledValue: (0, import_Cluster.Attribute)(17, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvInt16.bound({ max: 32766 }))),
      /**
       ...
       */
      maxScaledValue: (0, import_Cluster.Attribute)(18, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvInt16)),
      /**
       ...
       */
      scale: (0, import_Cluster.Attribute)(20, import_TlvNumber.TlvInt8.bound({ min: -127 }))
    }
  });
