...
((TargetNavigator2) => {
  ...
  class TargetNotFoundError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "Requested target was not found in the TargetList", code = import_Status.Status.Failure, clusterCode = 1 /* TargetNotFound */) {
      super(message, code, clusterCode);
    }
  }
  TargetNavigator2.TargetNotFoundError = TargetNotFoundError;
  class NotAllowedError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "Target request is not allowed in current state", code = import_Status.Status.Failure, clusterCode = 2 /* NotAllowed */) {
      super(message, code, clusterCode);
    }
  }
  TargetNavigator2.NotAllowedError = NotAllowedError;
  ...
  TargetNavigator2.ClusterInstance = (0, import_MutableCluster.MutableCluster)({
    ...
    events: {
       ...
       */
      targetUpdated: (0, import_Cluster.OptionalEvent)(0, import_Priority.Priority.Info, TargetNavigator2.TlvTargetUpdatedEvent)
    }
  });
