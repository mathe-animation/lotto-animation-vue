...
var dishwasher_alarm_exports = {};
__export(dishwasher_alarm_exports, {
  DishwasherAlarm: () => DishwasherAlarm,
  DishwasherAlarmCluster: () => DishwasherAlarmCluster
});
module.exports = __toCommonJS(dishwasher_alarm_exports);
...
((DishwasherAlarm2) => {
  ...
  DishwasherAlarm2.TlvResetRequest = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    alarms: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt32, DishwasherAlarm2.Alarm))
  });
  DishwasherAlarm2.TlvModifyEnabledAlarmsRequest = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    mask: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt32, DishwasherAlarm2.Alarm))
  });
  DishwasherAlarm2.TlvNotifyEvent = (0, import_TlvObject.TlvObject)({
    /**
     * This field shall indicate those alarms that have become active.
     *
     * @see {@link MatterSpecification.v142.Cluster} § 1.15.8.1.1
     */
    active: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt32, DishwasherAlarm2.Alarm)),
    /**
     * This field shall indicate those alarms that have become inactive.
     *
     * @see {@link MatterSpecification.v142.Cluster} § 1.15.8.1.2
     */
    inactive: (0, import_TlvObject.TlvField)(1, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt32, DishwasherAlarm2.Alarm)),
    /**
     ...
     */
    state: (0, import_TlvObject.TlvField)(2, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt32, DishwasherAlarm2.Alarm)),
    /**
     ...
     */
    mask: (0, import_TlvObject.TlvField)(3, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt32, DishwasherAlarm2.Alarm))
  });
  DishwasherAlarm2.ResetComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      latch: (0, import_Cluster.FixedAttribute)(1, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt32, DishwasherAlarm2.Alarm))
    },
    commands: {
      /**
       ...
       */
      reset: (0, import_Cluster.Command)(0, DishwasherAlarm2.TlvResetRequest, 0, import_Cluster.TlvNoResponse)
    }
  });
  DishwasherAlarm2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      mask: (0, import_Cluster.Attribute)(0, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt32, DishwasherAlarm2.Alarm)),
      /**
       ...
       */
      state: (0, import_Cluster.Attribute)(2, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt32, DishwasherAlarm2.Alarm)),
      /**
       ...
       */
      supported: (0, import_Cluster.FixedAttribute)(3, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt32, DishwasherAlarm2.Alarm))
    },
    commands: {
      /**
       ...
       */
      modifyEnabledAlarms: (0, import_Cluster.OptionalCommand)(1, DishwasherAlarm2.TlvModifyEnabledAlarmsRequest, 1, import_Cluster.TlvNoResponse)
    },
    events: {
      /**
       ...
       */
      notify: (0, import_Cluster.Event)(0, import_Priority.Priority.Info, DishwasherAlarm2.TlvNotifyEvent)
    },
    /**
...
//# sourceMappingURL=dishwasher-alarm.js.map
