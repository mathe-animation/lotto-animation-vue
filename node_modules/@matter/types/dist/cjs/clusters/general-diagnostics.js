...
((GeneralDiagnostics2) => {
  ...
  GeneralDiagnostics2.TlvNetworkInterface = (0, import_TlvObject.TlvObject)({
     ...
     */
    iPv4Addresses: (0, import_TlvObject.TlvField)(5, (0, import_TlvArray.TlvArray)(import_TlvString.TlvByteString.bound({ length: 4 }), { maxLength: 4 })),
    /**
     ...
     */
    iPv6Addresses: (0, import_TlvObject.TlvField)(6, (0, import_TlvArray.TlvArray)(import_TlvString.TlvByteString.bound({ length: 16 }), { maxLength: 8 })),
    /**
  ...
  GeneralDiagnostics2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      hardwareFaultChange: (0, import_Cluster.OptionalEvent)(0, import_Priority.Priority.Critical, GeneralDiagnostics2.TlvHardwareFaultChangeEvent),
      /**
       ...
       */
      radioFaultChange: (0, import_Cluster.OptionalEvent)(1, import_Priority.Priority.Critical, GeneralDiagnostics2.TlvRadioFaultChangeEvent),
      /**
       ...
       */
      networkFaultChange: (0, import_Cluster.OptionalEvent)(2, import_Priority.Priority.Critical, GeneralDiagnostics2.TlvNetworkFaultChangeEvent),
      /**
       ...
       */
      bootReason: (0, import_Cluster.Event)(3, import_Priority.Priority.Critical, GeneralDiagnostics2.TlvBootReasonEvent)
    },
    /**
