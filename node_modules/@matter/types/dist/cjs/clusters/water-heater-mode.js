...
var water_heater_mode_exports = {};
__export(water_heater_mode_exports, {
  WaterHeaterMode: () => WaterHeaterMode,
  WaterHeaterModeCluster: () => WaterHeaterModeCluster
});
module.exports = __toCommonJS(water_heater_mode_exports);
...
((WaterHeaterMode2) => {
  ...
  })(Feature = WaterHeaterMode2.Feature || (WaterHeaterMode2.Feature = {}));
  let ModeTag;
  ((ModeTag2) => {
    ...
    ModeTag2[ModeTag2["Off"] = 16384] = "Off";
    ModeTag2[ModeTag2["Manual"] = 16385] = "Manual";
    ModeTag2[ModeTag2["Timed"] = 16386] = "Timed";
  })(ModeTag = WaterHeaterMode2.ModeTag || (WaterHeaterMode2.ModeTag = {}));
  WaterHeaterMode2.TlvModeTagStruct = (0, import_TlvObject.TlvObject)({
    /**
  ...
  WaterHeaterMode2.TlvModeOption = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    modeTags: (0, import_TlvObject.TlvField)(2, (0, import_TlvArray.TlvArray)(WaterHeaterMode2.TlvModeTagStruct, { maxLength: 8 }))
  });
  WaterHeaterMode2.Base = import_MutableCluster.MutableCluster.Component({
    id: 158,
    ...
    attributes: {
      ...
      supportedModes: (0, import_Cluster.FixedAttribute)(
        0,
        (0, import_TlvArray.TlvArray)(WaterHeaterMode2.TlvModeOption, { minLength: 2, maxLength: 255 }),
        { default: [] }
      ),
      /**
  ...
  WaterHeaterMode2.ClusterInstance = (0, import_MutableCluster.MutableCluster)(WaterHeaterMode2.Base);
  WaterHeaterMode2.Cluster = WaterHeaterMode2.ClusterInstance;
  WaterHeaterMode2.Complete = WaterHeaterMode2.Cluster;
})(WaterHeaterMode || (WaterHeaterMode = {}));
const WaterHeaterModeCluster = WaterHeaterMode.Cluster;
import_ClusterRegistry.ClusterRegistry.register(WaterHeaterMode.Complete);
//# sourceMappingURL=water-heater-mode.js.map
