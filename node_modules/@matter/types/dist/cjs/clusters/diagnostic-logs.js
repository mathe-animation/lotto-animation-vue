...
((DiagnosticLogs2) => {
  ...
  class ExhaustedError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "All logs has been transferred", code = import_Status.Status.Failure, clusterCode = 1 /* Exhausted */) {
      super(message, code, clusterCode);
    }
  }
  DiagnosticLogs2.ExhaustedError = ExhaustedError;
  class NoLogsError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "No logs of the requested type available", code = import_Status.Status.Failure, clusterCode = 2 /* NoLogs */) {
      super(message, code, clusterCode);
    }
  }
  DiagnosticLogs2.NoLogsError = NoLogsError;
  class BusyError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "Unable to handle request, retry later", code = import_Status.Status.Failure, clusterCode = 3 /* Busy */) {
      super(message, code, clusterCode);
    }
  }
  DiagnosticLogs2.BusyError = BusyError;
  class DeniedError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "The request is denied, no logs being transferred", code = import_Status.Status.Failure, clusterCode = 4 /* Denied */) {
      super(message, code, clusterCode);
    }
  }
