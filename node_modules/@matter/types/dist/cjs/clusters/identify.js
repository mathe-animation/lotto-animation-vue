...
((Identify2) => {
  ...
  Identify2.TlvIdentifyRequest = (0, import_TlvObject.TlvObject)({ identifyTime: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt16) });
  ...
  Identify2.TlvTriggerEffectRequest = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    effectVariant: (0, import_TlvObject.TlvField)(1, (0, import_TlvNumber.TlvEnum)())
  });
  Identify2.ClusterInstance = (0, import_MutableCluster.MutableCluster)({
    id: 3,
    name: "Identify",
    revision: 6,
    attributes: {
       ...
       */
      identifyTime: (0, import_Cluster.WritableAttribute)(0, import_TlvNumber.TlvUInt16),
      /**
       ...
       */
      identifyType: (0, import_Cluster.Attribute)(1, (0, import_TlvNumber.TlvEnum)())
    },
    commands: {
      /**
       ...
       */
      identify: (0, import_Cluster.Command)(0, Identify2.TlvIdentifyRequest, 0, import_Cluster.TlvNoResponse, { invokeAcl: import_model.AccessLevel.Manage }),
      /**
       ...
       */
      triggerEffect: (0, import_Cluster.OptionalCommand)(
        64,
...
import_ClusterRegistry.ClusterRegistry.register(Identify.Complete);
