...
((MicrowaveOvenControl2) => {
  ...
  MicrowaveOvenControl2.PowerNumberLimitsComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      minPower: (0, import_Cluster.FixedAttribute)(3, import_TlvNumber.TlvUInt8.bound({ min: 1, max: 99 })),
      /**
       ...
       */
      maxPower: (0, import_Cluster.FixedAttribute)(4, import_TlvNumber.TlvUInt8.bound({ max: 100 })),
      /**
       ...
       */
      powerStep: (0, import_Cluster.FixedAttribute)(5, import_TlvNumber.TlvUInt8)
    }
  });
  ...
  MicrowaveOvenControl2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      cookTime: (0, import_Cluster.Attribute)(0, import_TlvNumber.TlvUInt32.bound({ min: 1 })),
      /**
