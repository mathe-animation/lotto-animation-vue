...
((TimeSynchronization2) => {
  ...
  TimeSynchronization2.TlvSetTimeZoneResponse = (0, import_TlvObject.TlvObject)({
     ...
     */
    dstOffsetRequired: (0, import_TlvObject.TlvField)(0, import_TlvBoolean.TlvBoolean)
  });
  ...
  class TimeNotAcceptedError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "Node rejected the attempt to set the UTC time", code = import_Status.Status.Failure, clusterCode = 2 /* TimeNotAccepted */) {
      super(message, code, clusterCode);
    }
  }
  TimeSynchronization2.TimeNotAcceptedError = TimeNotAcceptedError;
  TimeSynchronization2.TimeSyncClientComponent = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      missingTrustedTimeSource: (0, import_Cluster.Event)(4, import_Priority.Priority.Info, import_TlvNoArguments.TlvNoArguments)
    }
  });
  ...
  TimeSynchronization2.TimeZoneComponent = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      dstTableEmpty: (0, import_Cluster.Event)(0, import_Priority.Priority.Info, import_TlvNoArguments.TlvNoArguments),
      /**
       ...
       */
      dstStatus: (0, import_Cluster.Event)(1, import_Priority.Priority.Info, TimeSynchronization2.TlvDstStatusEvent),
      /**
       ...
       */
      timeZoneStatus: (0, import_Cluster.Event)(2, import_Priority.Priority.Info, TimeSynchronization2.TlvTimeZoneStatusEvent)
    }
  });
  ...
  TimeSynchronization2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      timeFailure: (0, import_Cluster.Event)(3, import_Priority.Priority.Info, import_TlvNoArguments.TlvNoArguments)
    },
    /**
