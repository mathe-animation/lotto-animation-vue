...
((ContentControl2) => {
  ...
  ContentControl2.ScreenTimeComponent = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      remainingScreenTimeExpired: (0, import_Cluster.Event)(0, import_Priority.Priority.Info, import_TlvNoArguments.TlvNoArguments)
    }
  });
  ...
  ContentControl2.BlockContentTimeWindowComponent = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      enteringBlockContentTimeWindow: (0, import_Cluster.Event)(1, import_Priority.Priority.Info, import_TlvNoArguments.TlvNoArguments)
    }
  });
