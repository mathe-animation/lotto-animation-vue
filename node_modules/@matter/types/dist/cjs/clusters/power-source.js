...
((PowerSource2) => {
  ...
  PowerSource2.WiredComponent = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      wiredFaultChange: (0, import_Cluster.OptionalEvent)(0, import_Priority.Priority.Info, PowerSource2.TlvWiredFaultChangeEvent)
    }
  });
  PowerSource2.BatteryComponent = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      batFaultChange: (0, import_Cluster.OptionalEvent)(1, import_Priority.Priority.Info, PowerSource2.TlvBatFaultChangeEvent)
    }
  });
  ...
  PowerSource2.RechargeableComponent = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      batChargeFaultChange: (0, import_Cluster.OptionalEvent)(2, import_Priority.Priority.Info, PowerSource2.TlvBatChargeFaultChangeEvent)
    }
  });
