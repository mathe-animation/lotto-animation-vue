...
((WaterHeaterManagement2) => {
  ...
  WaterHeaterManagement2.EnergyManagementComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      tankVolume: (0, import_Cluster.Attribute)(2, import_TlvNumber.TlvUInt16),
      /**
       ...
       */
      estimatedHeatRequired: (0, import_Cluster.Attribute)(3, import_TlvNumber.TlvInt64.bound({ min: 0 }))
    }
  });
  WaterHeaterManagement2.TankPercentComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      tankPercentage: (0, import_Cluster.Attribute)(4, import_TlvNumber.TlvPercent)
    }
  });
  WaterHeaterManagement2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      boostState: (0, import_Cluster.Attribute)(5, (0, import_TlvNumber.TlvEnum)())
    },
    commands: {
      /**
    ...
    events: {
       ...
       */
      boostStarted: (0, import_Cluster.Event)(0, import_Priority.Priority.Info, WaterHeaterManagement2.TlvBoostStartedEvent),
      /**
       ...
       */
      boostEnded: (0, import_Cluster.Event)(1, import_Priority.Priority.Info, import_TlvNoArguments.TlvNoArguments)
    },
    /**
