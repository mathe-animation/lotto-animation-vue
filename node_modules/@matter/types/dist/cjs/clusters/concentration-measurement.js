...
((ConcentrationMeasurement2) => {
  ...
  ConcentrationMeasurement2.NumericMeasurementComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      measuredValue: (0, import_Cluster.Attribute)(0, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvFloat)),
      /**
       ...
       */
      minMeasuredValue: (0, import_Cluster.Attribute)(1, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvFloat)),
      /**
       ...
       */
      maxMeasuredValue: (0, import_Cluster.Attribute)(2, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvFloat)),
      /**
  ...
  ConcentrationMeasurement2.PeakMeasurementComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      peakMeasuredValue: (0, import_Cluster.Attribute)(3, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvFloat)),
      /**
       ...
       */
      peakMeasuredValueWindow: (0, import_Cluster.Attribute)(4, import_TlvNumber.TlvUInt32.bound({ max: 604800 }))
    }
  });
  ConcentrationMeasurement2.AverageMeasurementComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      averageMeasuredValue: (0, import_Cluster.Attribute)(5, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvFloat)),
      /**
       ...
       */
      averageMeasuredValueWindow: (0, import_Cluster.Attribute)(6, import_TlvNumber.TlvUInt32.bound({ max: 604800 }))
    }
  });
  ConcentrationMeasurement2.LevelIndicationComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      levelValue: (0, import_Cluster.Attribute)(10, (0, import_TlvNumber.TlvEnum)())
    }
  });
