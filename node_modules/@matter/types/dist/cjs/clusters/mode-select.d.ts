...
export declare namespace ModeSelect {
     ...
     */
    const TlvSemanticTag: import("../tlv/TlvObject.js").ObjectSchema<{
        /**
     ...
     * @see {@link MatterSpecification.v142.Cluster} § 1.9.5.1
     */
    interface SemanticTag extends TypeFromSchema<typeof TlvSemanticTag> {
    }
    /**
    ...
    const CompleteInstance: MutableCluster<{
        readonly id: import("#general").Branded<80, "ClusterId">;
        readonly name: "ModeSelect";
        readonly revision: 2;
        readonly features: {
            /**
...
export declare const ModeSelectCluster: ModeSelect.Cluster;
