...
((ContentLauncher2) => {
  ...
  class UrlNotAvailableError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "Requested URL could not be reached by device", code = import_Status.Status.Failure, clusterCode = 1 /* UrlNotAvailable */) {
      super(message, code, clusterCode);
    }
  }
  ContentLauncher2.UrlNotAvailableError = UrlNotAvailableError;
  class AuthFailedError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "Requested URL returned 401 error code", code = import_Status.Status.Failure, clusterCode = 2 /* AuthFailed */) {
      super(message, code, clusterCode);
    }
  }
  ContentLauncher2.AuthFailedError = AuthFailedError;
  class TextTrackNotAvailableError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "Requested Text Track (in PlaybackPreferences) not available", code = import_Status.Status.Failure, clusterCode = 3 /* TextTrackNotAvailable */) {
      super(message, code, clusterCode);
    }
  }
  ContentLauncher2.TextTrackNotAvailableError = TextTrackNotAvailableError;
  class AudioTrackNotAvailableError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "Requested Audio Track (in PlaybackPreferences) not available", code = import_Status.Status.Failure, clusterCode = 4 /* AudioTrackNotAvailable */) {
      super(message, code, clusterCode);
    }
  }
