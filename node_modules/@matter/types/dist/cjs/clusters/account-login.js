...
((AccountLogin2) => {
  ...
  AccountLogin2.ClusterInstance = (0, import_MutableCluster.MutableCluster)({
    ...
    events: {
       ...
       */
      loggedOut: (0, import_Cluster.OptionalEvent)(0, import_Priority.Priority.Critical, AccountLogin2.TlvLoggedOutEvent, { readAcl: import_model.AccessLevel.Administer })
    }
  });
