...
((ElectricalEnergyMeasurement2) => {
  ...
  ElectricalEnergyMeasurement2.ImportedEnergyAndCumulativeEnergyComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      cumulativeEnergyImported: (0, import_Cluster.Attribute)(1, (0, import_TlvNullable.TlvNullable)(ElectricalEnergyMeasurement2.TlvEnergyMeasurement))
    }
  });
  ElectricalEnergyMeasurement2.ExportedEnergyAndCumulativeEnergyComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      cumulativeEnergyExported: (0, import_Cluster.Attribute)(2, (0, import_TlvNullable.TlvNullable)(ElectricalEnergyMeasurement2.TlvEnergyMeasurement))
    }
  });
  ElectricalEnergyMeasurement2.ImportedEnergyAndPeriodicEnergyComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      periodicEnergyImported: (0, import_Cluster.Attribute)(3, (0, import_TlvNullable.TlvNullable)(ElectricalEnergyMeasurement2.TlvEnergyMeasurement))
    }
  });
  ElectricalEnergyMeasurement2.ExportedEnergyAndPeriodicEnergyComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      periodicEnergyExported: (0, import_Cluster.Attribute)(4, (0, import_TlvNullable.TlvNullable)(ElectricalEnergyMeasurement2.TlvEnergyMeasurement))
    }
  });
  ElectricalEnergyMeasurement2.CumulativeEnergyComponent = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      cumulativeEnergyMeasured: (0, import_Cluster.Event)(0, import_Priority.Priority.Info, ElectricalEnergyMeasurement2.TlvCumulativeEnergyMeasuredEvent)
    }
  });
  ElectricalEnergyMeasurement2.PeriodicEnergyComponent = import_MutableCluster.MutableCluster.Component({
    events: {
       ...
       */
      periodicEnergyMeasured: (0, import_Cluster.Event)(1, import_Priority.Priority.Info, ElectricalEnergyMeasurement2.TlvPeriodicEnergyMeasuredEvent)
    }
  });
