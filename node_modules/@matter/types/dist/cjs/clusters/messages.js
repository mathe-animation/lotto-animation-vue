...
((Messages2) => {
  ...
  Messages2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      messageQueued: (0, import_Cluster.Event)(0, import_Priority.Priority.Info, Messages2.TlvMessageQueuedEvent),
      /**
       ...
       */
      messagePresented: (0, import_Cluster.Event)(1, import_Priority.Priority.Info, Messages2.TlvMessagePresentedEvent),
      /**
       ...
       */
      messageComplete: (0, import_Cluster.Event)(2, import_Priority.Priority.Info, Messages2.TlvMessageCompleteEvent)
    },
    /**
