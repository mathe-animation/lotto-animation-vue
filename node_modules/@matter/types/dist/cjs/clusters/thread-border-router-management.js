...
((ThreadBorderRouterManagement2) => {
  ...
  ThreadBorderRouterManagement2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      interfaceEnabled: (0, import_Cluster.Attribute)(3, import_TlvBoolean.TlvBoolean, { persistent: true }),
      /**
       ...
       */
      activeDatasetTimestamp: (0, import_Cluster.Attribute)(4, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt64), { persistent: true }),
      /**
       ...
       */
      pendingDatasetTimestamp: (0, import_Cluster.Attribute)(5, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt64), { persistent: true })
    },
    commands: {
      /**
