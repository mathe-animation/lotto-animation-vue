...
((ThreadNetworkDiagnostics2) => {
  ...
  ThreadNetworkDiagnostics2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    events: {
       ...
       */
      connectionStatus: (0, import_Cluster.OptionalEvent)(0, import_Priority.Priority.Info, ThreadNetworkDiagnostics2.TlvConnectionStatusEvent),
      /**
       ...
       */
      networkFaultChange: (0, import_Cluster.OptionalEvent)(1, import_Priority.Priority.Info, ThreadNetworkDiagnostics2.TlvNetworkFaultChangeEvent)
    },
    /**
