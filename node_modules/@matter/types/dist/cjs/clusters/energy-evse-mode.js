...
((EnergyEvseMode2) => {
  ...
  ((ModeTag2) => {
    ...
    ModeTag2[ModeTag2["V2X"] = 16387] = "V2X";
  ...
  EnergyEvseMode2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    attributes: {
      ...
      supportedModes: (0, import_Cluster.FixedAttribute)(
        0,
        (0, import_TlvArray.TlvArray)(EnergyEvseMode2.TlvModeOption, { minLength: 2, maxLength: 255 }),
        { default: [] }
      ),
      /**
  ...
  EnergyEvseMode2.Complete = EnergyEvseMode2.Cluster;
})(EnergyEvseMode || (EnergyEvseMode = {}));
