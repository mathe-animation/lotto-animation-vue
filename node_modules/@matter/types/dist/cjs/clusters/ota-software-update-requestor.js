...
((OtaSoftwareUpdateRequestor2) => {
  ...
  OtaSoftwareUpdateRequestor2.ClusterInstance = (0, import_MutableCluster.MutableCluster)({
    ...
    events: {
       ...
       */
      stateTransition: (0, import_Cluster.Event)(0, import_Priority.Priority.Info, OtaSoftwareUpdateRequestor2.TlvStateTransitionEvent),
      /**
       ...
       */
      versionApplied: (0, import_Cluster.Event)(1, import_Priority.Priority.Critical, OtaSoftwareUpdateRequestor2.TlvVersionAppliedEvent),
      /**
       ...
       */
      downloadError: (0, import_Cluster.Event)(2, import_Priority.Priority.Info, OtaSoftwareUpdateRequestor2.TlvDownloadErrorEvent)
    }
  });
