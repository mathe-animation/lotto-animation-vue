...
var dishwasher_mode_exports = {};
__export(dishwasher_mode_exports, {
  DishwasherMode: () => DishwasherMode,
  DishwasherModeCluster: () => DishwasherModeCluster
});
module.exports = __toCommonJS(dishwasher_mode_exports);
...
((DishwasherMode2) => {
  ...
  DishwasherMode2.TlvModeTagStruct = (0, import_TlvObject.TlvObject)({
    /**
  ...
  DishwasherMode2.TlvModeOption = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    modeTags: (0, import_TlvObject.TlvField)(2, (0, import_TlvArray.TlvArray)(DishwasherMode2.TlvModeTagStruct, { maxLength: 8 }))
  });
  DishwasherMode2.Base = import_MutableCluster.MutableCluster.Component({
    id: 89,
    name: "DishwasherMode",
    revision: 3,
    features: {
    ...
    attributes: {
      ...
      supportedModes: (0, import_Cluster.FixedAttribute)(
        0,
        (0, import_TlvArray.TlvArray)(DishwasherMode2.TlvModeOption, { minLength: 2, maxLength: 255 }),
        { default: [] }
      ),
      /**
  ...
  DishwasherMode2.ClusterInstance = (0, import_MutableCluster.MutableCluster)(DishwasherMode2.Base);
...
import_ClusterRegistry.ClusterRegistry.register(DishwasherMode.Complete);
//# sourceMappingURL=dishwasher-mode.js.map
