...
var operational_credentials_exports = {};
__export(operational_credentials_exports, {
  OperationalCredentials: () => OperationalCredentials,
  OperationalCredentialsCluster: () => OperationalCredentialsCluster
});
module.exports = __toCommonJS(operational_credentials_exports);
...
((OperationalCredentials2) => {
  OperationalCredentials2.TlvNoc = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    vvsc: (0, import_TlvObject.TlvOptionalField)(3, import_TlvString.TlvByteString.bound({ maxLength: 400 })),
    fabricIndex: (0, import_TlvObject.TlvField)(254, import_FabricIndex.TlvFabricIndex)
  });
  OperationalCredentials2.TlvFabricDescriptor = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    vidVerificationStatement: (0, import_TlvObject.TlvOptionalField)(6, import_TlvString.TlvByteString.bound({ length: 85 })),
    fabricIndex: (0, import_TlvObject.TlvField)(254, import_FabricIndex.TlvFabricIndex)
  });
  OperationalCredentials2.TlvAttestationRequest = (0, import_TlvObject.TlvObject)({ attestationNonce: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ length: 32 })) });
  ...
  OperationalCredentials2.TlvCertificateChainRequest = (0, import_TlvObject.TlvObject)({ certificateType: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvEnum)()) });
  ...
  OperationalCredentials2.TlvCsrRequest = (0, import_TlvObject.TlvObject)({
  ...
  OperationalCredentials2.TlvRemoveFabricRequest = (0, import_TlvObject.TlvObject)({
    /**
  ...
  OperationalCredentials2.TlvSetVidVerificationStatementRequest = (0, import_TlvObject.TlvObject)({
    vendorId: (0, import_TlvObject.TlvOptionalField)(0, import_VendorId.TlvVendorId),
    vidVerificationStatement: (0, import_TlvObject.TlvOptionalField)(1, import_TlvString.TlvByteString.bound({ maxLength: 85 })),
    vvsc: (0, import_TlvObject.TlvOptionalField)(2, import_TlvString.TlvByteString.bound({ maxLength: 400 }))
  });
  OperationalCredentials2.TlvSignVidVerificationRequest = (0, import_TlvObject.TlvObject)({
    fabricIndex: (0, import_TlvObject.TlvField)(0, import_FabricIndex.TlvFabricIndex),
    clientChallenge: (0, import_TlvObject.TlvField)(1, import_TlvString.TlvByteString.bound({ length: 32 }))
  });
  OperationalCredentials2.TlvSignVidVerificationResponse = (0, import_TlvObject.TlvObject)({
    fabricIndex: (0, import_TlvObject.TlvField)(0, import_FabricIndex.TlvFabricIndex),
    fabricBindingVersion: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvUInt8.bound({ min: 1 })),
    signature: (0, import_TlvObject.TlvField)(2, import_TlvString.TlvByteString.bound({ minLength: 1 }))
  });
  OperationalCredentials2.ClusterInstance = (0, import_MutableCluster.MutableCluster)({
    id: 62,
    ...
    attributes: {
      ...
      nocs: (0, import_Cluster.FabricScopedAttribute)(
        0,
        (0, import_TlvArray.TlvArray)(OperationalCredentials2.TlvNoc),
        {
          persistent: true,
          omitChanges: true,
          default: [],
       ...
       */
      fabrics: (0, import_Cluster.FabricScopedAttribute)(1, (0, import_TlvArray.TlvArray)(OperationalCredentials2.TlvFabricDescriptor), { persistent: true, default: [] }),
      /**
       ...
       */
      commissionedFabrics: (0, import_Cluster.Attribute)(3, import_TlvNumber.TlvUInt8, { persistent: true }),
      /**
      ...
      trustedRootCertificates: (0, import_Cluster.Attribute)(
        4,
        (0, import_TlvArray.TlvArray)(import_TlvString.TlvByteString),
    ...
    commands: {
       ...
       */
      csrRequest: (0, import_Cluster.Command)(4, OperationalCredentials2.TlvCsrRequest, 5, OperationalCredentials2.TlvCsrResponse, { invokeAcl: import_model.AccessLevel.Administer }),
      /**
       ...
       */
      addNoc: (0, import_Cluster.Command)(6, OperationalCredentials2.TlvAddNocRequest, 8, OperationalCredentials2.TlvNocResponse, { invokeAcl: import_model.AccessLevel.Administer }),
      /**
       ...
       */
      updateNoc: (0, import_Cluster.Command)(7, OperationalCredentials2.TlvUpdateNocRequest, 8, OperationalCredentials2.TlvNocResponse, { invokeAcl: import_model.AccessLevel.Administer }),
      /**
       ...
       */
      setVidVerificationStatement: (0, import_Cluster.Command)(
        12,
        OperationalCredentials2.TlvSetVidVerificationStatementRequest,
        12,
        import_Cluster.TlvNoResponse,
        { invokeAcl: import_model.AccessLevel.Administer }
      ),
       ...
       */
      signVidVerificationRequest: (0, import_Cluster.Command)(
        13,
        OperationalCredentials2.TlvSignVidVerificationRequest,
        14,
        OperationalCredentials2.TlvSignVidVerificationResponse,
        { invokeAcl: import_model.AccessLevel.Administer }
      )
    }
  });
...
import_ClusterRegistry.ClusterRegistry.register(OperationalCredentials.Complete);
