...
import { Command, Event, OptionalFixedAttribute, OptionalWritableAttribute, Attribute, FixedAttribute, OptionalAttribute, OptionalEvent } from "../cluster/Cluster.js";
...
export declare namespace BridgedDeviceBasicInformation {
    ...
    const Base: {
        ...
        readonly attributes: {
             ...
             */
            readonly configurationVersion: OptionalAttribute<number, any>;
        };
        readonly events: {
            /**
             * @see {@link MatterSpecification.v142.Core} § 9.13.7
