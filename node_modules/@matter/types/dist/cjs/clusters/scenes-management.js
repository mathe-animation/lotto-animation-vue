...
var scenes_management_exports = {};
__export(scenes_management_exports, {
  ScenesManagement: () => ScenesManagement,
  ScenesManagementCluster: () => ScenesManagementCluster
});
module.exports = __toCommonJS(scenes_management_exports);
...
((ScenesManagement2) => {
  ...
  ScenesManagement2.TlvSceneInfo = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    sceneCount: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt8),
    /**
     ...
     */
    currentScene: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvUInt8),
    /**
     ...
     */
    currentGroup: (0, import_TlvObject.TlvField)(2, import_GroupId.TlvGroupId),
    /**
     ...
     */
    sceneValid: (0, import_TlvObject.TlvField)(3, import_TlvBoolean.TlvBoolean),
    /**
     ...
     */
    remainingCapacity: (0, import_TlvObject.TlvField)(4, import_TlvNumber.TlvUInt8.bound({ max: 253 })),
    fabricIndex: (0, import_TlvObject.TlvField)(254, import_FabricIndex.TlvFabricIndex)
  });
  ScenesManagement2.TlvAttributeValuePair = (0, import_TlvObject.TlvObject)({
    /**
    ...
    valueUnsigned8: (0, import_TlvObject.TlvOptionalField)(1, import_TlvNumber.TlvUInt8),
    valueSigned8: (0, import_TlvObject.TlvOptionalField)(2, import_TlvNumber.TlvInt8),
    valueUnsigned16: (0, import_TlvObject.TlvOptionalField)(3, import_TlvNumber.TlvUInt16),
    valueSigned16: (0, import_TlvObject.TlvOptionalField)(4, import_TlvNumber.TlvInt16),
    valueUnsigned32: (0, import_TlvObject.TlvOptionalField)(5, import_TlvNumber.TlvUInt32),
    valueSigned32: (0, import_TlvObject.TlvOptionalField)(6, import_TlvNumber.TlvInt32),
    valueUnsigned64: (0, import_TlvObject.TlvOptionalField)(7, import_TlvNumber.TlvUInt64),
    valueSigned64: (0, import_TlvObject.TlvOptionalField)(8, import_TlvNumber.TlvInt64)
  });
  ScenesManagement2.TlvExtensionFieldSet = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    clusterId: (0, import_TlvObject.TlvField)(0, import_ClusterId.TlvClusterId),
    /**
     ...
     */
    attributeValueList: (0, import_TlvObject.TlvField)(1, (0, import_TlvArray.TlvArray)(ScenesManagement2.TlvAttributeValuePair))
  });
  ScenesManagement2.TlvAddSceneRequest = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    sceneId: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvUInt8.bound({ max: 254 })),
    /**
     ...
     */
    transitionTime: (0, import_TlvObject.TlvField)(2, import_TlvNumber.TlvUInt32.bound({ max: 6e7 })),
    /**
     * This field shall indicate the name of the scene.
     *
     * @see {@link MatterSpecification.v142.Cluster} § 1.4.9.2.4
     */
    sceneName: (0, import_TlvObject.TlvField)(3, import_TlvString.TlvString.bound({ maxLength: 16 })),
    /**
     * This field shall contains the list of extension fields.
     *
     * @see {@link MatterSpecification.v142.Cluster} § 1.4.9.2.5
     */
    extensionFieldSetStructs: (0, import_TlvObject.TlvField)(4, (0, import_TlvArray.TlvArray)(ScenesManagement2.TlvExtensionFieldSet))
  });
  ScenesManagement2.TlvAddSceneResponse = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    sceneId: (0, import_TlvObject.TlvField)(2, import_TlvNumber.TlvUInt8.bound({ max: 254 }))
  });
  ScenesManagement2.TlvViewSceneRequest = (0, import_TlvObject.TlvObject)({
    /**
     * This field shall indicate the group identifier in the Group Table.
     *
  ...
  ScenesManagement2.TlvViewSceneResponse = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    transitionTime: (0, import_TlvObject.TlvOptionalField)(3, import_TlvNumber.TlvUInt32.bound({ max: 6e7 })),
    /**
     * This field shall be set to the corresponding field in the Scene Table entry.
     *
     * @see {@link MatterSpecification.v142.Cluster} § 1.4.9.5.5
     */
    sceneName: (0, import_TlvObject.TlvOptionalField)(4, import_TlvString.TlvString.bound({ maxLength: 16 })),
    /**
     * This field shall be set to the corresponding field in the Scene Table entry.
     *
     * @see {@link MatterSpecification.v142.Cluster} § 1.4.9.5.6
     */
    extensionFieldSetStructs: (0, import_TlvObject.TlvOptionalField)(5, (0, import_TlvArray.TlvArray)(ScenesManagement2.TlvExtensionFieldSet))
  });
  ScenesManagement2.TlvRemoveSceneRequest = (0, import_TlvObject.TlvObject)({
    /**
     * This field shall indicate the group identifier in the Group Table.
     *
  ...
  ScenesManagement2.TlvRemoveSceneResponse = (0, import_TlvObject.TlvObject)({
    /**
  ...
  ScenesManagement2.TlvRemoveAllScenesRequest = (0, import_TlvObject.TlvObject)({
    /**
     * This field shall indicate the group identifier in the Group Table.
     *
  ...
  ScenesManagement2.TlvRemoveAllScenesResponse = (0, import_TlvObject.TlvObject)({
    /**
  ...
  ScenesManagement2.TlvStoreSceneRequest = (0, import_TlvObject.TlvObject)({
    /**
     * This field shall indicate the group identifier in the Group Table.
     *
  ...
  ScenesManagement2.TlvStoreSceneResponse = (0, import_TlvObject.TlvObject)({
    /**
  ...
  ScenesManagement2.TlvRecallSceneRequest = (0, import_TlvObject.TlvObject)({
    /**
     * This field shall indicate the group identifier in the Group Table.
     *
     ...
     */
    transitionTime: (0, import_TlvObject.TlvOptionalField)(2, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt32.bound({ max: 6e7 })))
  });
  ScenesManagement2.TlvGetSceneMembershipRequest = (0, import_TlvObject.TlvObject)({
    /**
     * This field shall indicate the group identifier in the Group Table.
     *
  ...
  ScenesManagement2.TlvGetSceneMembershipResponse = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    capacity: (0, import_TlvObject.TlvField)(1, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8)),
    /**
     ...
     */
    sceneList: (0, import_TlvObject.TlvOptionalField)(3, (0, import_TlvArray.TlvArray)(import_TlvNumber.TlvUInt8))
  });
  ScenesManagement2.CopyMode = {
    /**
     * Copy all scenes in the scene table
     */
    copyAllScenes: (0, import_BitmapSchema.BitFlag)(0)
  };
  ScenesManagement2.TlvCopySceneRequest = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    mode: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ScenesManagement2.CopyMode)),
    /**
     ...
     */
    groupIdentifierFrom: (0, import_TlvObject.TlvField)(1, import_GroupId.TlvGroupId),
    /**
     ...
     */
    sceneIdentifierFrom: (0, import_TlvObject.TlvField)(2, import_TlvNumber.TlvUInt8.bound({ max: 254 })),
    /**
     ...
     */
    groupIdentifierTo: (0, import_TlvObject.TlvField)(3, import_GroupId.TlvGroupId),
    /**
     ...
     */
    sceneIdentifierTo: (0, import_TlvObject.TlvField)(4, import_TlvNumber.TlvUInt8.bound({ max: 254 }))
  });
  ScenesManagement2.TlvCopySceneResponse = (0, import_TlvObject.TlvObject)({
    /**
  ...
  ScenesManagement2.TlvLogicalSceneTable = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    sceneGroupId: (0, import_TlvObject.TlvField)(0, import_GroupId.TlvGroupId),
    /**
     ...
     */
    sceneName: (0, import_TlvObject.TlvOptionalField)(2, import_TlvString.TlvString.bound({ maxLength: 16 })),
    /**
     ...
     */
    sceneTransitionTime: (0, import_TlvObject.TlvField)(3, import_TlvNumber.TlvUInt32.bound({ max: 6e7 })),
    /**
     ...
     */
    extensionFields: (0, import_TlvObject.TlvField)(4, (0, import_TlvArray.TlvArray)(ScenesManagement2.TlvExtensionFieldSet))
  });
  ScenesManagement2.Base = import_MutableCluster.MutableCluster.Component({
    id: 98,
    ...
    features: {
       ...
       */
      sceneNames: (0, import_BitmapSchema.BitFlag)(0)
    },
    attributes: {
      /**
       ...
       */
      sceneTableSize: (0, import_Cluster.FixedAttribute)(1, import_TlvNumber.TlvUInt16),
      /**
       ...
       */
      fabricSceneInfo: (0, import_Cluster.FabricScopedAttribute)(2, (0, import_TlvArray.TlvArray)(ScenesManagement2.TlvSceneInfo), { default: [] })
    },
    commands: {
      /**
       ...
       */
      addScene: (0, import_Cluster.Command)(0, ScenesManagement2.TlvAddSceneRequest, 0, ScenesManagement2.TlvAddSceneResponse, { invokeAcl: import_model.AccessLevel.Manage }),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 1.4.9.4
       */
      viewScene: (0, import_Cluster.Command)(1, ScenesManagement2.TlvViewSceneRequest, 1, ScenesManagement2.TlvViewSceneResponse),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 1.4.9.6
       */
      removeScene: (0, import_Cluster.Command)(
        2,
       ...
       */
      removeAllScenes: (0, import_Cluster.Command)(
        3,
       ...
       */
      storeScene: (0, import_Cluster.Command)(
        4,
       ...
       */
      recallScene: (0, import_Cluster.Command)(5, ScenesManagement2.TlvRecallSceneRequest, 5, import_Cluster.TlvNoResponse),
      /**
       ...
       */
      getSceneMembership: (0, import_Cluster.Command)(6, ScenesManagement2.TlvGetSceneMembershipRequest, 6, ScenesManagement2.TlvGetSceneMembershipResponse),
      /**
       ...
       */
      copyScene: (0, import_Cluster.OptionalCommand)(
        64,
  ...
  ScenesManagement2.ClusterInstance = (0, import_MutableCluster.MutableCluster)(ScenesManagement2.Base);
...
import_ClusterRegistry.ClusterRegistry.register(ScenesManagement.Complete);
