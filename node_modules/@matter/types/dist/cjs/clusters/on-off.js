...
((OnOff2) => {
  ...
  OnOff2.LightingComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      globalSceneControl: (0, import_Cluster.Attribute)(16384, import_TlvBoolean.TlvBoolean),
      /**
       ...
       */
      onTime: (0, import_Cluster.WritableAttribute)(16385, import_TlvNumber.TlvUInt16),
      /**
       ...
       */
      offWaitTime: (0, import_Cluster.WritableAttribute)(16386, import_TlvNumber.TlvUInt16),
      /**
  ...
  OnOff2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      onOff: (0, import_Cluster.Attribute)(0, import_TlvBoolean.TlvBoolean, { scene: true, persistent: true })
    },
    commands: {
      /**
