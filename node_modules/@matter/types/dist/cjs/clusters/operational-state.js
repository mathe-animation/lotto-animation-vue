...
var operational_state_exports = {};
__export(operational_state_exports, {
  OperationalState: () => OperationalState,
  OperationalStateCluster: () => OperationalStateCluster
});
module.exports = __toCommonJS(operational_state_exports);
...
((OperationalState2) => {
  let OperationalStateEnum;
  ((OperationalStateEnum2) => {
    OperationalStateEnum2[OperationalStateEnum2["Stopped"] = 0] = "Stopped";
    OperationalStateEnum2[OperationalStateEnum2["Running"] = 1] = "Running";
    OperationalStateEnum2[OperationalStateEnum2["Paused"] = 2] = "Paused";
    OperationalStateEnum2[OperationalStateEnum2["Error"] = 3] = "Error";
  })(OperationalStateEnum = OperationalState2.OperationalStateEnum || (OperationalState2.OperationalStateEnum = {}));
  OperationalState2.TlvOperationalStateStruct = (0, import_TlvObject.TlvObject)({
    /**
  ...
  let ErrorState;
  ((ErrorState2) => {
    ErrorState2[ErrorState2["NoError"] = 0] = "NoError";
    ErrorState2[ErrorState2["UnableToStartOrResume"] = 1] = "UnableToStartOrResume";
    ErrorState2[ErrorState2["UnableToCompleteOperation"] = 2] = "UnableToCompleteOperation";
    ErrorState2[ErrorState2["CommandInvalidInState"] = 3] = "CommandInvalidInState";
  })(ErrorState = OperationalState2.ErrorState || (OperationalState2.ErrorState = {}));
  OperationalState2.TlvErrorStateStruct = (0, import_TlvObject.TlvObject)({
    /**
  ...
  OperationalState2.TlvOperationalCommandResponse = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    commandResponseState: (0, import_TlvObject.TlvField)(0, OperationalState2.TlvErrorStateStruct)
  });
  OperationalState2.TlvOperationalErrorEvent = (0, import_TlvObject.TlvObject)({ errorState: (0, import_TlvObject.TlvField)(0, OperationalState2.TlvErrorStateStruct) });
  OperationalState2.TlvOperationCompletionEvent = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    completionErrorCode: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt8),
    /**
     ...
     */
    totalOperationalTime: (0, import_TlvObject.TlvOptionalField)(1, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt32)),
    /**
     ...
     */
    pausedTime: (0, import_TlvObject.TlvOptionalField)(2, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt32))
  });
  OperationalState2.ClusterInstance = (0, import_MutableCluster.MutableCluster)({
    id: 96,
    ...
    attributes: {
       ...
       */
      operationalStateList: (0, import_Cluster.Attribute)(3, (0, import_TlvArray.TlvArray)(OperationalState2.TlvOperationalStateStruct), { default: [] }),
      /**
       ...
       */
      operationalError: (0, import_Cluster.Attribute)(5, OperationalState2.TlvErrorStateStruct)
    },
    commands: {
      /**
       ...
       */
      pause: (0, import_Cluster.OptionalCommand)(0, import_TlvNoArguments.TlvNoArguments, 4, OperationalState2.TlvOperationalCommandResponse),
      /**
       ...
       */
      stop: (0, import_Cluster.OptionalCommand)(1, import_TlvNoArguments.TlvNoArguments, 4, OperationalState2.TlvOperationalCommandResponse),
      /**
       ...
       */
      start: (0, import_Cluster.OptionalCommand)(2, import_TlvNoArguments.TlvNoArguments, 4, OperationalState2.TlvOperationalCommandResponse),
      /**
       ...
       */
      resume: (0, import_Cluster.OptionalCommand)(3, import_TlvNoArguments.TlvNoArguments, 4, OperationalState2.TlvOperationalCommandResponse)
    },
    events: {
      /**
       ...
       */
      operationalError: (0, import_Cluster.Event)(0, import_Priority.Priority.Critical, OperationalState2.TlvOperationalErrorEvent),
      /**
       ...
       */
      operationCompletion: (0, import_Cluster.OptionalEvent)(1, import_Priority.Priority.Info, OperationalState2.TlvOperationCompletionEvent)
    }
  });
...
import_ClusterRegistry.ClusterRegistry.register(OperationalState.Complete);
