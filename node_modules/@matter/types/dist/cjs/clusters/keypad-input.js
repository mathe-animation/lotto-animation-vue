...
var keypad_input_exports = {};
__export(keypad_input_exports, {
  KeypadInput: () => KeypadInput,
  KeypadInputCluster: () => KeypadInputCluster
});
module.exports = __toCommonJS(keypad_input_exports);
...
((KeypadInput2) => {
  ...
  class UnsupportedKeyError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "Key code is not supported", code = import_Status.Status.Failure, clusterCode = 1 /* UnsupportedKey */) {
      super(message, code, clusterCode);
    }
  }
  KeypadInput2.UnsupportedKeyError = UnsupportedKeyError;
  class InvalidKeyInCurrentStateError extends import_StatusResponseError.StatusResponseError {
    constructor(message = "Requested key code is invalid in the context of the responder\u2019s current state", code = import_Status.Status.Failure, clusterCode = 2 /* InvalidKeyInCurrentState */) {
      super(message, code, clusterCode);
    }
  }
  KeypadInput2.InvalidKeyInCurrentStateError = InvalidKeyInCurrentStateError;
  ...
  KeypadInput2.Base = import_MutableCluster.MutableCluster.Component({
    id: 1289,
    name: "KeypadInput",
    revision: 1,
    features: {
  ...
  KeypadInput2.ClusterInstance = (0, import_MutableCluster.MutableCluster)(KeypadInput2.Base);
...
import_ClusterRegistry.ClusterRegistry.register(KeypadInput.Complete);
