...
var MeasurementAccuracyRange_exports = {};
__export(MeasurementAccuracyRange_exports, {
  TlvMeasurementAccuracyRange: () => TlvMeasurementAccuracyRange
});
module.exports = __toCommonJS(MeasurementAccuracyRange_exports);
 ...
 */
const TlvMeasurementAccuracyRange = (0, import_TlvObject.TlvObject)({
  /**
   ...
   */
  rangeMin: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvInt64),
  /**
   ...
   */
  rangeMax: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvInt64),
  /**
   ...
   */
  percentMax: (0, import_TlvObject.TlvOptionalField)(2, import_TlvNumber.TlvPercent100ths),
  /**
   ...
   */
  percentMin: (0, import_TlvObject.TlvOptionalField)(3, import_TlvNumber.TlvPercent100ths),
  /**
   ...
   */
  percentTypical: (0, import_TlvObject.TlvOptionalField)(4, import_TlvNumber.TlvPercent100ths),
  /**
   ...
   */
  fixedMax: (0, import_TlvObject.TlvOptionalField)(5, import_TlvNumber.TlvUInt64),
  /**
   ...
   */
  fixedMin: (0, import_TlvObject.TlvOptionalField)(6, import_TlvNumber.TlvUInt64),
  /**
   ...
   */
  fixedTypical: (0, import_TlvObject.TlvOptionalField)(7, import_TlvNumber.TlvUInt64)
});
