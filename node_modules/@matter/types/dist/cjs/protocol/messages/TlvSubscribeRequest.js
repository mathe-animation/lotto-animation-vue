...
var TlvSubscribeRequest_exports = {};
__export(TlvSubscribeRequest_exports, {
  TlvSubscribeRequest: () => TlvSubscribeRequest
});
module.exports = __toCommonJS(TlvSubscribeRequest_exports);
...
const TlvSubscribeRequest = (0, import_TlvObject.TlvObject)({
  ...
  attributeRequests: (0, import_TlvObject.TlvOptionalField)(3, (0, import_TlvArray.TlvArray)(import_TlvAttributePath.TlvAttributePath)),
  /** A list of zero or more request paths to cluster events. */
  eventRequests: (0, import_TlvObject.TlvOptionalField)(4, (0, import_TlvArray.TlvArray)(import_TlvEventPath.TlvEventPath)),
  /** A list of zero or more minimum event numbers per specific node. */
  eventFilters: (0, import_TlvObject.TlvOptionalField)(5, (0, import_TlvArray.TlvArray)(import_TlvEventFilter.TlvEventFilter)),
  ...
  dataVersionFilters: (0, import_TlvObject.TlvOptionalField)(8, (0, import_TlvArray.TlvArray)(import_TlvDataVersionFilter.TlvDataVersionFilter)),
