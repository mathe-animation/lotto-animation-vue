...
var import_ClusterTypeModifier = require("./ClusterTypeModifier.js");
/**
 * @license
...
function MutableCluster(options, ...components) {
  ...
  Object.assign(cluster, {
    ...
    alter(alterations) {
      return new import_ClusterTypeModifier.ClusterTypeModifier(cluster).alter(alterations);
    },
    set(values) {
      return new import_ClusterTypeModifier.ClusterTypeModifier(cluster).set(values);
    },
    enable(flags) {
      return new import_ClusterTypeModifier.ClusterTypeModifier(cluster).enable(flags);
    }
  });
  return cluster;
}
