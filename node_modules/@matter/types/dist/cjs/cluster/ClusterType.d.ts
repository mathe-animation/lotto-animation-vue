...
export declare namespace ClusterType {
    ...
    type PatchType<V> = V extends (infer E)[] ? {
        readonly [K in `${number}`]: PatchType<E>;
    } | Readonly<PatchType<E>[]> : V extends boolean | number | bigint | string ? V : V extends object ? V extends (...args: any[]) => any ? never : {
