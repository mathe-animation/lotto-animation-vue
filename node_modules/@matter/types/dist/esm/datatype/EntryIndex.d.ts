...
export declare function EntryIndex(id: number): EntryIndex;
/** TLV schema for an entry index. */
export declare const TlvEntryIndex: TlvWrapper<EntryIndex, number>;
//# sourceMappingURL=EntryIndex.d.ts.map