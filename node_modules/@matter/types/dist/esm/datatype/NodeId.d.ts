 ...
 */
import { Branded, Crypto } from "#general";
...
export declare function NodeId(v: Parameters<typeof BigInt>[0]): NodeId;
export declare namespace NodeId {
    ...
    function strOf(nodeId: NodeId): string;
    /**
     ...
     */
    const randomOperationalNodeId: (crypto: Crypto) => NodeId;
    /**
