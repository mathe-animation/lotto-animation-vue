 ...
 */
export declare class ClusterTypeModifier<const T extends ClusterType> {
    cluster: T;
    constructor(cluster: T);
    /**
     * Create a new cluster with modified elements.
     */
    alter<const AlterationsT extends ClusterTypeModifier.Alterations<T>>(alterations: AlterationsT): ClusterTypeModifier.WithAlterations<T, AlterationsT>;
    /**
     ...
     */
    set<const ValuesT extends Partial<ClusterType.AttributeValues<T>>>(values: ValuesT): ClusterTypeModifier.WithValues<T, ValuesT>;
    /**
     ...
     */
    enable<const FlagsT extends ClusterTypeModifier.ElementFlags<T>>(flags: FlagsT): ClusterTypeModifier.WithAlterations<T, ClusterTypeModifier.ElementFlagAlterations<FlagsT>>;
}
export declare namespace ClusterTypeModifier {
    /**
     ...
     */
    type WithValues<T extends ClusterType, ValuesT extends Partial<ClusterType.AttributeValues<T>>> = WithAlterations<T, AttributeValueAlterations<ValuesT>>;
    /**
     ...
     */
    type AttributeValueAlterations<ValuesT extends Partial<ClusterType.AttributeValues<any>>> = {
        attributes: {
            [K in keyof ValuesT]: {
                default: ValuesT[K];
            };
...
//# sourceMappingURL=ClusterTypeModifier.d.ts.map