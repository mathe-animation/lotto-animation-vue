...
((Thermostat2) => {
  ...
  Thermostat2.TlvAtomicRequest = TlvObject({
    requestType: TlvField(0, TlvEnum()),
    attributeRequests: TlvField(1, TlvArray(TlvAttributeId)),
    timeout: TlvOptionalField(2, TlvUInt16)
  });
  Thermostat2.TlvEntry = TlvObject({
    attributeId: TlvField(0, TlvAttributeId),
    statusCode: TlvField(1, TlvEnum())
  });
  Thermostat2.TlvAtomicResponse = TlvObject({
    statusCode: TlvField(0, TlvEnum()),
    attributeStatus: TlvField(1, TlvArray(Thermostat2.TlvEntry)),
    timeout: TlvOptionalField(2, TlvUInt16)
  });
  ...
  Thermostat2.Base = MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      localTemperature: Attribute(0, TlvNullable(TlvInt16)),
      /**
    ...
    commands: {
      ...
      atomicRequest: Command(254, Thermostat2.TlvAtomicRequest, 253, Thermostat2.TlvAtomicResponse)
    },
    /**
