...
((DishwasherMode2) => {
  ...
  DishwasherMode2.TlvModeTagStruct = TlvObject({
    /**
  ...
  DishwasherMode2.TlvModeOption = TlvObject({
    /**
     ...
     */
    modeTags: TlvField(2, TlvArray(DishwasherMode2.TlvModeTagStruct, { maxLength: 8 }))
  });
  DishwasherMode2.Base = MutableCluster.Component({
    ...
    attributes: {
      ...
      supportedModes: FixedAttribute(
        0,
        TlvArray(DishwasherMode2.TlvModeOption, { minLength: 2, maxLength: 255 }),
        { default: [] }
      ),
      /**
