...
((OtaSoftwareUpdateProvider2) => {
  ...
  class UpdateAvailableError extends StatusResponseError {
    constructor(message = "Indicates that the OTA Provider has an update available", code = GlobalStatus.Failure, clusterCode = 0 /* UpdateAvailable */) {
  ...
  class BusyError extends StatusResponseError {
    constructor(message = "Indicates OTA Provider may have an update, but it is not ready yet", code = GlobalStatus.Failure, clusterCode = 1 /* Busy */) {
      super(message, code, clusterCode);
    }
  }
  OtaSoftwareUpdateProvider2.BusyError = BusyError;
  class NotAvailableError extends StatusResponseError {
    constructor(message = "Indicates that there is definitely no update currently available from the OTA Provider", code = GlobalStatus.Failure, clusterCode = 2 /* NotAvailable */) {
      super(message, code, clusterCode);
    }
  }
  ...
  class DownloadProtocolNotSupportedError extends StatusResponseError {
    constructor(message = "Indicates that the requested download protocol is not supported by the OTA Provider", code = GlobalStatus.Failure, clusterCode = 3 /* DownloadProtocolNotSupported */) {
      super(message, code, clusterCode);
    }
  }
