...
((TargetNavigator2) => {
  ...
  class TargetNotFoundError extends StatusResponseError {
    constructor(message = "Requested target was not found in the TargetList", code = GlobalStatus.Failure, clusterCode = 1 /* TargetNotFound */) {
  ...
  class NotAllowedError extends StatusResponseError {
    constructor(message = "Target request is not allowed in current state", code = GlobalStatus.Failure, clusterCode = 2 /* NotAllowed */) {
      super(message, code, clusterCode);
    }
  }
  ...
  TargetNavigator2.ClusterInstance = MutableCluster({
    ...
    events: {
       ...
       */
      targetUpdated: OptionalEvent(0, Priority.Info, TargetNavigator2.TlvTargetUpdatedEvent)
    }
  });
