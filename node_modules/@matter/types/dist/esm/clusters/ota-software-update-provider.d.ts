...
export declare namespace OtaSoftwareUpdateProvider {
     ...
     */
    const TlvQueryImageRequest: import("../tlv/TlvObject.js").ObjectSchema<{
        /**
         ...
         */
        protocolsSupported: import("../tlv/TlvObject.js").FieldType<DownloadProtocol[]>;
        /**
         ...
         */
        hardwareVersion: import("../tlv/TlvObject.js").OptionalFieldType<number>;
        /**
         ...
         */
        location: import("../tlv/TlvObject.js").OptionalFieldType<string>;
        /**
     ...
     * @see {@link MatterSpecification.v142.Core} § 11.20.6.5.1
     */
    interface QueryImageRequest extends TypeFromSchema<typeof TlvQueryImageRequest> {
    }
    /**
     ...
     * @see {@link MatterSpecification.v142.Core} § 11.20.6.4.1
     */
    class UpdateAvailableError extends StatusResponseError {
     ...
     * @see {@link MatterSpecification.v142.Core} § 11.20.6.4.1
     */
    class NotAvailableError extends StatusResponseError {
        constructor(message?: string, code?: GlobalStatus, clusterCode?: Status);
    }
    /**
     ...
     * @see {@link MatterSpecification.v142.Core} § 11.20.6.4.1
     */
    class DownloadProtocolNotSupportedError extends StatusResponseError {
        constructor(message?: string, code?: GlobalStatus, clusterCode?: Status);
    }
    /**
     * @see {@link MatterSpecification.v142.Core} § 11.20.6.5.2
     */
    const TlvQueryImageResponse: import("../tlv/TlvObject.js").ObjectSchema<{
        /**
         ...
         */
        delayedActionTime: import("../tlv/TlvObject.js").OptionalFieldType<number>;
        /**
         ...
         */
        imageUri: import("../tlv/TlvObject.js").OptionalFieldType<string>;
        /**
         ...
         */
        softwareVersion: import("../tlv/TlvObject.js").OptionalFieldType<number>;
        /**
         ...
         */
        softwareVersionString: import("../tlv/TlvObject.js").OptionalFieldType<string>;
        /**
         * Beware, this field is conditionally present based on the conformance listed in Section 11.20.6.5.2,
         * “QueryImageResponse Command”.
         *
     ...
     * @see {@link MatterSpecification.v142.Core} § 11.20.6.5.2
     */
    interface QueryImageResponse extends TypeFromSchema<typeof TlvQueryImageResponse> {
    }
    /**
    ...
    const TlvApplyUpdateRequest: import("../tlv/TlvObject.js").ObjectSchema<{
         ...
         */
        newVersion: import("../tlv/TlvObject.js").FieldType<number>;
    }>;
    /**
     * Input to the OtaSoftwareUpdateProvider applyUpdateRequest command
     *
     * @see {@link MatterSpecification.v142.Core} § 11.20.6.5.3
     */
    interface ApplyUpdateRequest extends TypeFromSchema<typeof TlvApplyUpdateRequest> {
    }
    /**
    ...
    const TlvApplyUpdateResponse: import("../tlv/TlvObject.js").ObjectSchema<{
         ...
         */
        action: import("../tlv/TlvObject.js").FieldType<ApplyUpdateAction>;
        /**
         ...
         */
        delayedActionTime: import("../tlv/TlvObject.js").FieldType<number>;
    }>;
    /**
     * @see {@link MatterSpecification.v142.Core} § 11.20.6.5.4
     */
    interface ApplyUpdateResponse extends TypeFromSchema<typeof TlvApplyUpdateResponse> {
    }
    /**
     ...
     */
    const TlvNotifyUpdateAppliedRequest: import("../tlv/TlvObject.js").ObjectSchema<{
        /**
     ...
     * @see {@link MatterSpecification.v142.Core} § 11.20.6.5.5
     */
    interface NotifyUpdateAppliedRequest extends TypeFromSchema<typeof TlvNotifyUpdateAppliedRequest> {
    }
    /**
     * @see {@link Cluster}
     */
    const ClusterInstance: MutableCluster<{
        ...
        readonly commands: {
             ...
             * @see {@link MatterSpecification.v142.Core} § 11.20.6.5.1
             */
            readonly queryImage: Command<import("../tlv/TlvObject.js").TypeFromFields<{
                /**
                 * The value shall be the Vendor ID applying to the OTA Requestor’s Node and shall match the value reported by
                 * the Basic Information Cluster VendorID attribute.
                 *
             ...
             * @see {@link MatterSpecification.v142.Core} § 11.20.6.5.5
             */
            readonly notifyUpdateApplied: Command<import("../tlv/TlvObject.js").TypeFromFields<{
                /**
                 * This field shall contain the UpdateToken as specified in Section 11.20.3.6.1, “UpdateToken usage”.
                 *
                 * @see {@link MatterSpecification.v142.Core} § 11.20.6.5.5.1
...
export declare const OtaSoftwareUpdateProviderCluster: OtaSoftwareUpdateProvider.Cluster;
//# sourceMappingURL=ota-software-update-provider.d.ts.map