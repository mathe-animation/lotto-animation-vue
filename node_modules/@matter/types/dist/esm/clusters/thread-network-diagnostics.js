...
((ThreadNetworkDiagnostics2) => {
  ...
  ThreadNetworkDiagnostics2.Base = MutableCluster.Component({
    ...
    events: {
       ...
       */
      connectionStatus: OptionalEvent(0, Priority.Info, ThreadNetworkDiagnostics2.TlvConnectionStatusEvent),
      /**
       ...
       */
      networkFaultChange: OptionalEvent(1, Priority.Info, ThreadNetworkDiagnostics2.TlvNetworkFaultChangeEvent)
    },
    /**
