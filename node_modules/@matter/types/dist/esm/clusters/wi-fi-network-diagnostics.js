...
((WiFiNetworkDiagnostics2) => {
  ...
  WiFiNetworkDiagnostics2.Base = MutableCluster.Component({
    ...
    events: {
       ...
       */
      disconnection: OptionalEvent(0, Priority.Info, WiFiNetworkDiagnostics2.TlvDisconnectionEvent),
      /**
       ...
       */
      associationFailure: OptionalEvent(1, Priority.Info, WiFiNetworkDiagnostics2.TlvAssociationFailureEvent),
      /**
       ...
       */
      connectionStatus: OptionalEvent(2, Priority.Info, WiFiNetworkDiagnostics2.TlvConnectionStatusEvent)
    },
    /**
