...
((OnOff2) => {
  ...
  OnOff2.LightingComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      globalSceneControl: Attribute(16384, TlvBoolean),
      /**
       ...
       */
      onTime: WritableAttribute(16385, TlvUInt16),
      /**
       ...
       */
      offWaitTime: WritableAttribute(16386, TlvUInt16),
      /**
  ...
  OnOff2.Base = MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      onOff: Attribute(0, TlvBoolean, { scene: true, persistent: true })
    },
    commands: {
      /**
