...
((BasicInformation2) => {
  ...
  BasicInformation2.ClusterInstance = MutableCluster({
    ...
    attributes: {
       ...
       */
      configurationVersion: Attribute(24, TlvUInt32.bound({ min: 1 }), { persistent: true, default: 1 })
    },
    events: {
      /**
       ...
       */
      startUp: Event(0, Priority.Critical, BasicInformation2.TlvStartUpEvent),
      /**
       ...
       */
      leave: OptionalEvent(2, Priority.Info, BasicInformation2.TlvLeaveEvent),
      /**
       ...
       */
      reachableChanged: OptionalEvent(3, Priority.Info, BasicInformation2.TlvReachableChangedEvent)
    }
  });
