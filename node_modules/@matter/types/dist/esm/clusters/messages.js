...
((Messages2) => {
  ...
  Messages2.Base = MutableCluster.Component({
    ...
    events: {
       ...
       */
      messageQueued: Event(0, Priority.Info, Messages2.TlvMessageQueuedEvent),
      /**
       ...
       */
      messagePresented: Event(1, Priority.Info, Messages2.TlvMessagePresentedEvent),
      /**
       ...
       */
      messageComplete: Event(2, Priority.Info, Messages2.TlvMessageCompleteEvent)
    },
    /**
