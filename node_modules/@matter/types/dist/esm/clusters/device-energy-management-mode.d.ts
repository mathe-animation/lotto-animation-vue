...
export declare namespace DeviceEnergyManagementMode {
    ...
    const Base: {
        readonly id: 159;
        readonly name: "DeviceEnergyManagementMode";
        readonly revision: 2;
        readonly features: {
            /**
             * Dependency with the OnOff cluster
...
export declare const DeviceEnergyManagementModeCluster: DeviceEnergyManagementMode.Cluster;
//# sourceMappingURL=device-energy-management-mode.d.ts.map