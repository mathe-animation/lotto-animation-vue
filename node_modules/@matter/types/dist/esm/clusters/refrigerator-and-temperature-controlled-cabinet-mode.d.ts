...
export declare namespace RefrigeratorAndTemperatureControlledCabinetMode {
    ...
    const Base: {
        readonly id: 82;
        readonly name: "RefrigeratorAndTemperatureControlledCabinetMode";
        readonly revision: 3;
        readonly features: {
            /**
             * Dependency with the OnOff cluster
...
export declare const RefrigeratorAndTemperatureControlledCabinetModeCluster: RefrigeratorAndTemperatureControlledCabinetMode.Cluster;
//# sourceMappingURL=refrigerator-and-temperature-controlled-cabinet-mode.d.ts.map