...
((KeypadInput2) => {
  ...
  class UnsupportedKeyError extends StatusResponseError {
    constructor(message = "Key code is not supported", code = GlobalStatus.Failure, clusterCode = 1 /* UnsupportedKey */) {
  ...
  class InvalidKeyInCurrentStateError extends StatusResponseError {
    constructor(message = "Requested key code is invalid in the context of the responder\u2019s current state", code = GlobalStatus.Failure, clusterCode = 2 /* InvalidKeyInCurrentState */) {
      super(message, code, clusterCode);
    }
  }
