...
((ColorControl2) => {
  ...
  ColorControl2.HueSaturationComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      currentHue: Attribute(0, TlvUInt8.bound({ max: 254 }), { persistent: true }),
      /**
       ...
       */
      currentSaturation: Attribute(1, TlvUInt8.bound({ max: 254 }), { scene: true, persistent: true })
    },
    commands: {
      /**
  ...
  ColorControl2.XyComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      currentX: Attribute(3, TlvUInt16.bound({ max: 65279 }), { scene: true, persistent: true }),
      /**
       ...
       */
      currentY: Attribute(4, TlvUInt16.bound({ max: 65279 }), { scene: true, persistent: true })
    },
    commands: {
      /**
  ...
  ColorControl2.ColorTemperatureComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      colorTemperatureMireds: Attribute(7, TlvUInt16, { scene: true, persistent: true }),
      /**
  ...
  ColorControl2.EnhancedHueComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      enhancedCurrentHue: Attribute(16384, TlvUInt16, { scene: true, persistent: true })
    },
    commands: {
      /**
  ...
  ColorControl2.ColorLoopComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      colorLoopActive: Attribute(16386, TlvEnum(), { scene: true, persistent: true }),
      /**
       ...
       */
      colorLoopDirection: Attribute(16387, TlvEnum(), { scene: true, persistent: true }),
      /**
       ...
       */
      colorLoopTime: Attribute(16388, TlvUInt16, { scene: true, persistent: true }),
      /**
       ...
       */
      colorLoopStartEnhancedHue: Attribute(16389, TlvUInt16),
      /**
       ...
       */
      colorLoopStoredEnhancedHue: Attribute(16390, TlvUInt16)
    },
    commands: {
      /**
  ...
  ColorControl2.Base = MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      enhancedColorMode: Attribute(16385, TlvEnum(), { scene: true, persistent: true }),
      /**
