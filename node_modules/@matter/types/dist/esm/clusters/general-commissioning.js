...
((GeneralCommissioning2) => {
  ...
  GeneralCommissioning2.TlvSetTcAcknowledgementsRequest = TlvObject({
    /**
  ...
  GeneralCommissioning2.TlvSetTcAcknowledgementsResponse = TlvObject({
    /**
  ...
  GeneralCommissioning2.TermsAndConditionsComponent = MutableCluster.Component({
    attributes: {
      /**
  ...
  GeneralCommissioning2.Base = MutableCluster.Component({
    id: 48,
  ...
  GeneralCommissioning2.ClusterInstance = MutableCluster(GeneralCommissioning2.Base);
  GeneralCommissioning2.Cluster = GeneralCommissioning2.ClusterInstance;
  const TC = { termsAndConditions: true };
  GeneralCommissioning2.CompleteInstance = MutableCluster({
