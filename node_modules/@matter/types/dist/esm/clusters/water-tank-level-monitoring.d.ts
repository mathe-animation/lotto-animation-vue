...
export declare namespace WaterTankLevelMonitoring {
    const Base: {
        readonly id: 121;
        readonly name: "WaterTankLevelMonitoring";
        readonly features: {
...
export declare const WaterTankLevelMonitoringCluster: WaterTankLevelMonitoring.Cluster;
//# sourceMappingURL=water-tank-level-monitoring.d.ts.map