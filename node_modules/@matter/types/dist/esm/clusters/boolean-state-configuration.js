...
((BooleanStateConfiguration2) => {
  ...
  BooleanStateConfiguration2.TlvEnableDisableAlarmRequest = TlvObject({
    /**
     ...
     */
    alarmsToEnableDisable: TlvField(0, TlvBitmap(TlvUInt8, BooleanStateConfiguration2.AlarmMode))
  });
  BooleanStateConfiguration2.TlvAlarmsStateChangedEvent = TlvObject({
    /**
     ...
     */
    alarmsActive: TlvField(0, TlvBitmap(TlvUInt8, BooleanStateConfiguration2.AlarmMode)),
    /**
     ...
     */
    alarmsSuppressed: TlvOptionalField(1, TlvBitmap(TlvUInt8, BooleanStateConfiguration2.AlarmMode))
  });
  BooleanStateConfiguration2.TlvSuppressAlarmRequest = TlvObject({
    /**
     * This field shall indicate the alarm modes to suppress.
     *
     * @see {@link MatterSpecification.v142.Cluster} § 1.8.7.1.1
     */
    alarmsToSuppress: TlvField(0, TlvBitmap(TlvUInt8, BooleanStateConfiguration2.AlarmMode))
  });
  ...
  BooleanStateConfiguration2.TlvSensorFaultEvent = TlvObject({
    /**
     ...
     */
    sensorFault: TlvField(0, TlvBitmap(TlvUInt16, BooleanStateConfiguration2.SensorFault))
  });
  BooleanStateConfiguration2.SensitivityLevelComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      currentSensitivityLevel: WritableAttribute(0, TlvUInt8, { persistent: true }),
      /**
       ...
       */
      supportedSensitivityLevels: FixedAttribute(1, TlvUInt8.bound({ min: 2, max: 10 })),
      /**
       * Indicates the default sensitivity level selected by the manufacturer.
       *
       * @see {@link MatterSpecification.v142.Cluster} § 1.8.6.3
       */
      defaultSensitivityLevel: OptionalFixedAttribute(2, TlvUInt8)
    }
  });
  BooleanStateConfiguration2.VisualOrAudibleComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      alarmsActive: Attribute(3, TlvBitmap(TlvUInt8, BooleanStateConfiguration2.AlarmMode)),
      /**
       ...
       */
      alarmsEnabled: OptionalAttribute(5, TlvBitmap(TlvUInt8, BooleanStateConfiguration2.AlarmMode), { persistent: true }),
      /**
       ...
       */
      alarmsSupported: FixedAttribute(6, TlvBitmap(TlvUInt8, BooleanStateConfiguration2.AlarmMode))
    },
    commands: {
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 1.8.7.2
       */
      enableDisableAlarm: Command(1, BooleanStateConfiguration2.TlvEnableDisableAlarmRequest, 1, TlvNoResponse)
    },
    events: {
      /**
       ...
       */
      alarmsStateChanged: Event(0, Priority.Info, BooleanStateConfiguration2.TlvAlarmsStateChangedEvent)
    }
  });
  BooleanStateConfiguration2.AlarmSuppressComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      alarmsSuppressed: Attribute(4, TlvBitmap(TlvUInt8, BooleanStateConfiguration2.AlarmMode))
    },
    commands: {
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 1.8.7.1
       */
      suppressAlarm: Command(0, BooleanStateConfiguration2.TlvSuppressAlarmRequest, 0, TlvNoResponse)
    }
  });
  BooleanStateConfiguration2.Base = MutableCluster.Component({
    id: 128,
    ...
    attributes: {
       ...
       */
      sensorFault: OptionalAttribute(7, TlvBitmap(TlvUInt16, BooleanStateConfiguration2.SensorFault))
    },
    events: {
      /**
       ...
       */
      sensorFault: OptionalEvent(1, Priority.Info, BooleanStateConfiguration2.TlvSensorFaultEvent)
    },
    /**
  ...
  BooleanStateConfiguration2.ClusterInstance = MutableCluster(BooleanStateConfiguration2.Base);
  ...
  BooleanStateConfiguration2.CompleteInstance = MutableCluster({
