...
import { WritableAttribute, Attribute, FixedAttribute, Command } from "../cluster/Cluster.js";
...
export declare namespace ThreadNetworkDirectory {
     ...
     */
    const TlvThreadNetwork: import("../tlv/TlvObject.js").ObjectSchema<{
        /**
         ...
         */
        extendedPanId: import("../tlv/TlvObject.js").FieldType<AllowSharedBufferSource>;
        /**
         ...
         */
        networkName: import("../tlv/TlvObject.js").FieldType<string>;
        /**
         ...
         */
        channel: import("../tlv/TlvObject.js").FieldType<number>;
        /**
         ...
         */
        activeTimestamp: import("../tlv/TlvObject.js").FieldType<number | bigint>;
    }>;
    /**
     * Represents the data associated with a Thread Network.
     *
     * @see {@link MatterSpecification.v142.Cluster} § 10.4.4.1
     */
    interface ThreadNetwork extends TypeFromSchema<typeof TlvThreadNetwork> {
    }
    /**
     ...
     */
    const TlvAddNetworkRequest: import("../tlv/TlvObject.js").ObjectSchema<{
        /**
     ...
     * @see {@link MatterSpecification.v142.Cluster} § 10.4.6.1
     */
    interface AddNetworkRequest extends TypeFromSchema<typeof TlvAddNetworkRequest> {
    }
    /**
     ...
     */
    const TlvGetOperationalDatasetRequest: import("../tlv/TlvObject.js").ObjectSchema<{
        extendedPanId: import("../tlv/TlvObject.js").FieldType<AllowSharedBufferSource>;
    }>;
    /**
     * Input to the ThreadNetworkDirectory getOperationalDataset command
     ...
     * @see {@link MatterSpecification.v142.Cluster} § 10.4.6.3
     */
    interface GetOperationalDatasetRequest extends TypeFromSchema<typeof TlvGetOperationalDatasetRequest> {
    }
    /**
     ...
     */
    const TlvOperationalDatasetResponse: import("../tlv/TlvObject.js").ObjectSchema<{
        operationalDataset: import("../tlv/TlvObject.js").FieldType<AllowSharedBufferSource>;
    }>;
    /**
     * Contains the Thread Operational Dataset for the Extended PAN specified in GetOperationalDataset.
     ...
     * @see {@link MatterSpecification.v142.Cluster} § 10.4.6.4
     */
    interface OperationalDatasetResponse extends TypeFromSchema<typeof TlvOperationalDatasetResponse> {
    }
    /**
     * @see {@link Cluster}
     */
    const ClusterInstance: MutableCluster<{
        readonly id: 1107;
        readonly name: "ThreadNetworkDirectory";
        readonly revision: 1;
        readonly attributes: {
            /**
             ...
             */
            readonly preferredExtendedPanId: WritableAttribute<AllowSharedBufferSource | null, any>;
            /**
             ...
             */
            readonly threadNetworks: Attribute<import("../tlv/TlvObject.js").TypeFromFields<{
                /**
                 * This field shall indicate the Extended PAN ID from the OperationalDataset for the given Thread network.
                 *
                 * @see {@link MatterSpecification.v142.Cluster} § 10.4.4.1.1
             ...
             */
            readonly threadNetworkTableSize: FixedAttribute<number, any>;
        };
        readonly commands: {
            /**
             ...
             * @see {@link MatterSpecification.v142.Cluster} § 10.4.6.1
             */
            readonly addNetwork: Command<import("../tlv/TlvObject.js").TypeFromFields<{
                /**
                 * This field shall represent the Operational Dataset for the network, using the encoding defined in the Thread
                 * specification. It shall contain at least the following sub-TLVs: Active Timestamp, Channel, Channel Mask,
                 * Extended PAN ID, Network Key, Network Mesh-Local Prefix, Network Name, PAN ID, PSKc, and Security Policy.
             ...
             * @see {@link MatterSpecification.v142.Cluster} § 10.4.6.3
             */
            readonly getOperationalDataset: Command<import("../tlv/TlvObject.js").TypeFromFields<{
                extendedPanId: import("../tlv/TlvObject.js").FieldType<AllowSharedBufferSource>;
...
export declare const ThreadNetworkDirectoryCluster: ThreadNetworkDirectory.Cluster;
//# sourceMappingURL=thread-network-directory.d.ts.map