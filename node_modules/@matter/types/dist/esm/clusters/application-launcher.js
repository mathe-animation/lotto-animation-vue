...
((ApplicationLauncher2) => {
  ...
  class AppNotAvailableError extends StatusResponseError {
    constructor(message = "Requested app is not available", code = GlobalStatus.Failure, clusterCode = 1 /* AppNotAvailable */) {
  ...
  class SystemBusyError extends StatusResponseError {
    constructor(message = "Video platform unable to honor command", code = GlobalStatus.Failure, clusterCode = 2 /* SystemBusy */) {
      super(message, code, clusterCode);
    }
  }
  ApplicationLauncher2.SystemBusyError = SystemBusyError;
  class PendingUserApprovalError extends StatusResponseError {
    constructor(message = "User approval for app download is pending", code = GlobalStatus.Failure, clusterCode = 3 /* PendingUserApproval */) {
      super(message, code, clusterCode);
    }
  }
  ApplicationLauncher2.PendingUserApprovalError = PendingUserApprovalError;
  class DownloadingError extends StatusResponseError {
    constructor(message = "Downloading the requested app", code = GlobalStatus.Failure, clusterCode = 4 /* Downloading */) {
      super(message, code, clusterCode);
    }
  }
  ApplicationLauncher2.DownloadingError = DownloadingError;
  class InstallingError extends StatusResponseError {
    constructor(message = "Installing the requested app", code = GlobalStatus.Failure, clusterCode = 5 /* Installing */) {
      super(message, code, clusterCode);
    }
  }
