...
((AccountLogin2) => {
  ...
  AccountLogin2.TlvLoggedOutEvent = TlvObject({
    /**
  ...
  AccountLogin2.ClusterInstance = MutableCluster({
    id: 1294,
    name: "AccountLogin",
    revision: 2,
    commands: {
       ...
       */
      logout: Command(3, AccountLogin2.TlvLogoutRequest, 3, TlvNoResponse, { timed: true })
    },
    events: {
      /**
       ...
       */
      loggedOut: OptionalEvent(0, Priority.Critical, AccountLogin2.TlvLoggedOutEvent, { readAcl: AccessLevel.Administer })
    }
  });
