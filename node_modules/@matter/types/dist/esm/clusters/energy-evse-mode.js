...
((EnergyEvseMode2) => {
  ...
  EnergyEvseMode2.Base = MutableCluster.Component({
    id: 157,
    name: "EnergyEvseMode",
    revision: 2,
    features: {
    ...
    attributes: {
      ...
      supportedModes: FixedAttribute(
        0,
        TlvArray(EnergyEvseMode2.TlvModeOption, { minLength: 2, maxLength: 255 }),
        { default: [] }
      ),
      /**
  ...
  EnergyEvseMode2.ClusterInstance = MutableCluster(EnergyEvseMode2.Base);
