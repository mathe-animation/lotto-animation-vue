...
((WaterHeaterMode2) => {
  ...
  WaterHeaterMode2.TlvModeTagStruct = TlvObject({
    /**
  ...
  WaterHeaterMode2.TlvModeOption = TlvObject({
    /**
     ...
     */
    modeTags: TlvField(2, TlvArray(WaterHeaterMode2.TlvModeTagStruct, { maxLength: 8 }))
  });
  WaterHeaterMode2.Base = MutableCluster.Component({
    id: 158,
    ...
    attributes: {
      ...
      supportedModes: FixedAttribute(
        0,
        TlvArray(WaterHeaterMode2.TlvModeOption, { minLength: 2, maxLength: 255 }),
        { default: [] }
      ),
      /**
  ...
  WaterHeaterMode2.ClusterInstance = MutableCluster(WaterHeaterMode2.Base);
