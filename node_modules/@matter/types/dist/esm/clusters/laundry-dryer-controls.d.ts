...
export declare namespace LaundryDryerControls {
    ...
    const ClusterInstance: MutableCluster<{
        readonly id: 74;
        readonly name: "LaundryDryerControls";
        readonly revision: 1;
        readonly attributes: {
            /**
...
export declare const LaundryDryerControlsCluster: LaundryDryerControls.Cluster;
//# sourceMappingURL=laundry-dryer-controls.d.ts.map