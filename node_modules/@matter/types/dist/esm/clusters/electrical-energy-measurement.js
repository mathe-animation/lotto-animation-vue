...
((ElectricalEnergyMeasurement2) => {
  ...
  ElectricalEnergyMeasurement2.TlvEnergyMeasurement = TlvObject({
    /**
  ...
  ElectricalEnergyMeasurement2.TlvCumulativeEnergyReset = TlvObject({
    /**
  ...
  ElectricalEnergyMeasurement2.TlvCumulativeEnergyMeasuredEvent = TlvObject({
    /**
     ...
     */
    energyImported: TlvOptionalField(0, ElectricalEnergyMeasurement2.TlvEnergyMeasurement),
    /**
     ...
     */
    energyExported: TlvOptionalField(1, ElectricalEnergyMeasurement2.TlvEnergyMeasurement)
  });
  ElectricalEnergyMeasurement2.TlvPeriodicEnergyMeasuredEvent = TlvObject({
    /**
  ...
  ((MeasurementType2) => {
    ...
    MeasurementType2[MeasurementType2["ReactiveEnergy"] = 15] = "ReactiveEnergy";
    MeasurementType2[MeasurementType2["ApparentEnergy"] = 16] = "ApparentEnergy";
  })(MeasurementType = ElectricalEnergyMeasurement2.MeasurementType || (ElectricalEnergyMeasurement2.MeasurementType = {}));
  ElectricalEnergyMeasurement2.ImportedEnergyAndCumulativeEnergyComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      cumulativeEnergyImported: Attribute(1, TlvNullable(ElectricalEnergyMeasurement2.TlvEnergyMeasurement))
    }
  });
  ElectricalEnergyMeasurement2.ExportedEnergyAndCumulativeEnergyComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      cumulativeEnergyExported: Attribute(2, TlvNullable(ElectricalEnergyMeasurement2.TlvEnergyMeasurement))
    }
  });
  ElectricalEnergyMeasurement2.ImportedEnergyAndPeriodicEnergyComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      periodicEnergyImported: Attribute(3, TlvNullable(ElectricalEnergyMeasurement2.TlvEnergyMeasurement))
    }
  });
  ElectricalEnergyMeasurement2.ExportedEnergyAndPeriodicEnergyComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      periodicEnergyExported: Attribute(4, TlvNullable(ElectricalEnergyMeasurement2.TlvEnergyMeasurement))
    }
  });
  ElectricalEnergyMeasurement2.CumulativeEnergyComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      cumulativeEnergyReset: OptionalAttribute(5, TlvNullable(ElectricalEnergyMeasurement2.TlvCumulativeEnergyReset), { default: null })
    },
    events: {
      /**
       ...
       */
      cumulativeEnergyMeasured: Event(0, Priority.Info, ElectricalEnergyMeasurement2.TlvCumulativeEnergyMeasuredEvent)
    }
  });
  ElectricalEnergyMeasurement2.PeriodicEnergyComponent = MutableCluster.Component({
    events: {
      /**
       ...
       */
      periodicEnergyMeasured: Event(1, Priority.Info, ElectricalEnergyMeasurement2.TlvPeriodicEnergyMeasuredEvent)
    }
  });
  ElectricalEnergyMeasurement2.Base = MutableCluster.Component({
    id: 145,
    ...
    attributes: {
       ...
       */
      accuracy: FixedAttribute(0, TlvMeasurementAccuracy)
    },
    /**
  ...
  ElectricalEnergyMeasurement2.ClusterInstance = MutableCluster.ExtensibleOnly(ElectricalEnergyMeasurement2.Base);
  ...
  ElectricalEnergyMeasurement2.CompleteInstance = MutableCluster({
