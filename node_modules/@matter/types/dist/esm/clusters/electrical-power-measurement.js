...
((ElectricalPowerMeasurement2) => {
  ...
  ElectricalPowerMeasurement2.TlvMeasurementPeriodRangesEvent = TlvObject({
     ...
     */
    ranges: TlvField(0, TlvArray(ElectricalPowerMeasurement2.TlvMeasurementRange, { minLength: 1 }))
  });
  ElectricalPowerMeasurement2.AlternatingCurrentComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      apparentCurrent: OptionalAttribute(7, TlvNullable(TlvInt64), { default: null }),
      /**
  ...
  ElectricalPowerMeasurement2.HarmonicsComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      harmonicCurrents: Attribute(15, TlvNullable(TlvArray(ElectricalPowerMeasurement2.TlvHarmonicMeasurement, { maxLength: 25 })))
    }
  });
  ElectricalPowerMeasurement2.PowerQualityComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      harmonicPhases: Attribute(16, TlvNullable(TlvArray(ElectricalPowerMeasurement2.TlvHarmonicMeasurement, { maxLength: 25 })))
    }
  });
  ...
  ElectricalPowerMeasurement2.Base = MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      numberOfMeasurementTypes: FixedAttribute(1, TlvUInt8.bound({ max: 32 })),
      /**
       ...
       */
      activePower: Attribute(8, TlvNullable(TlvInt64))
    },
    events: {
      /**
       ...
       */
      measurementPeriodRanges: OptionalEvent(0, Priority.Info, ElectricalPowerMeasurement2.TlvMeasurementPeriodRangesEvent)
    },
    /**
