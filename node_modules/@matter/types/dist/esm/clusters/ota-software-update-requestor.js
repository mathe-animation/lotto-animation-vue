...
((OtaSoftwareUpdateRequestor2) => {
  OtaSoftwareUpdateRequestor2.TlvProviderLocation = TlvObject({
    /**
  ...
  OtaSoftwareUpdateRequestor2.ClusterInstance = MutableCluster({
    id: 42,
    ...
    attributes: {
      ...
      defaultOtaProviders: WritableFabricScopedAttribute(
        0,
        TlvArray(OtaSoftwareUpdateRequestor2.TlvProviderLocation),
    ...
    events: {
       ...
       */
      stateTransition: Event(0, Priority.Info, OtaSoftwareUpdateRequestor2.TlvStateTransitionEvent),
      /**
       ...
       */
      versionApplied: Event(1, Priority.Critical, OtaSoftwareUpdateRequestor2.TlvVersionAppliedEvent),
      /**
       ...
       */
      downloadError: Event(2, Priority.Info, OtaSoftwareUpdateRequestor2.TlvDownloadErrorEvent)
    }
  });
