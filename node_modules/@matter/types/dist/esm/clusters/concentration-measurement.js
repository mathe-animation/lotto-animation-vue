...
((ConcentrationMeasurement2) => {
  ...
  ConcentrationMeasurement2.NumericMeasurementComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      measuredValue: Attribute(0, TlvNullable(TlvFloat)),
      /**
       ...
       */
      minMeasuredValue: Attribute(1, TlvNullable(TlvFloat)),
      /**
       ...
       */
      maxMeasuredValue: Attribute(2, TlvNullable(TlvFloat)),
      /**
  ...
  ConcentrationMeasurement2.PeakMeasurementComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      peakMeasuredValue: Attribute(3, TlvNullable(TlvFloat)),
      /**
       ...
       */
      peakMeasuredValueWindow: Attribute(4, TlvUInt32.bound({ max: 604800 }))
    }
  });
  ConcentrationMeasurement2.AverageMeasurementComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      averageMeasuredValue: Attribute(5, TlvNullable(TlvFloat)),
      /**
       ...
       */
      averageMeasuredValueWindow: Attribute(6, TlvUInt32.bound({ max: 604800 }))
    }
  });
  ConcentrationMeasurement2.LevelIndicationComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      levelValue: Attribute(10, TlvEnum())
    }
  });
