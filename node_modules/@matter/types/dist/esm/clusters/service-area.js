...
((ServiceArea2) => {
  ...
  ServiceArea2.TlvProgress = TlvObject({
    /**
  ...
  ServiceArea2.TlvLandmarkInfo = TlvObject({
    /**
  ...
  ServiceArea2.TlvAreaInfo = TlvObject({
    /**
     ...
     */
    landmarkInfo: TlvField(1, TlvNullable(ServiceArea2.TlvLandmarkInfo))
  });
  ServiceArea2.TlvArea = TlvObject({
    /**
     ...
     */
    areaInfo: TlvField(2, ServiceArea2.TlvAreaInfo)
  });
  ServiceArea2.TlvSelectAreasRequest = TlvObject({
    /**
  ...
  ServiceArea2.TlvSkipAreaRequest = TlvObject({
    /**
  ...
  ServiceArea2.TlvSkipAreaResponse = TlvObject({
    /**
  ...
  ServiceArea2.MapsComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      supportedMaps: Attribute(1, TlvArray(ServiceArea2.TlvMap, { maxLength: 255 }), { default: [] })
    }
  });
  ServiceArea2.ProgressReportingComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      progress: Attribute(5, TlvArray(ServiceArea2.TlvProgress, { maxLength: 255 }), { default: [] })
    }
  });
  ServiceArea2.Base = MutableCluster.Component({
    id: 336,
    name: "ServiceArea",
    revision: 2,
    features: {
    ...
    attributes: {
       ...
       */
      supportedAreas: Attribute(0, TlvArray(ServiceArea2.TlvArea, { maxLength: 255 }), { default: [] }),
      /**
       ...
       */
      selectedAreas: Attribute(2, TlvArray(TlvUInt32), { default: [] }),
      /**
       ...
       */
      currentArea: OptionalAttribute(3, TlvNullable(TlvUInt32), { default: null }),
      /**
       ...
       */
      estimatedEndTime: OptionalAttribute(4, TlvNullable(TlvEpochS), { default: null })
    },
    commands: {
      /**
       ...
       */
      selectAreas: Command(0, ServiceArea2.TlvSelectAreasRequest, 1, ServiceArea2.TlvSelectAreasResponse),
      /**
       ...
       */
      skipArea: OptionalCommand(2, ServiceArea2.TlvSkipAreaRequest, 3, ServiceArea2.TlvSkipAreaResponse)
    },
    /**
  ...
  ServiceArea2.ClusterInstance = MutableCluster(ServiceArea2.Base);
  ServiceArea2.Cluster = ServiceArea2.ClusterInstance;
  const MAPS = { maps: true };
  const PROG = { progressReporting: true };
  ServiceArea2.CompleteInstance = MutableCluster({
