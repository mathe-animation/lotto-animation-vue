...
((PressureMeasurement2) => {
  ...
  PressureMeasurement2.ExtendedComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      scaledValue: Attribute(16, TlvNullable(TlvInt16)),
      /**
       ...
       */
      minScaledValue: Attribute(17, TlvNullable(TlvInt16.bound({ max: 32766 }))),
      /**
       ...
       */
      maxScaledValue: Attribute(18, TlvNullable(TlvInt16)),
      /**
       ...
       */
      scale: Attribute(20, TlvInt8.bound({ min: -127 }))
    }
  });
