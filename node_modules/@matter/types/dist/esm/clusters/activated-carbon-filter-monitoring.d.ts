...
export declare namespace ActivatedCarbonFilterMonitoring {
    const Base: {
        readonly id: 114;
        readonly name: "ActivatedCarbonFilterMonitoring";
        readonly features: {
...
export declare const ActivatedCarbonFilterMonitoringCluster: ActivatedCarbonFilterMonitoring.Cluster;
//# sourceMappingURL=activated-carbon-filter-monitoring.d.ts.map