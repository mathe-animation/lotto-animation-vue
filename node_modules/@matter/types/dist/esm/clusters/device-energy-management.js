...
((DeviceEnergyManagement2) => {
  ...
  DeviceEnergyManagement2.TlvPowerAdjust = TlvObject({
    /**
  ...
  DeviceEnergyManagement2.TlvPowerAdjustCapability = TlvObject({
    /**
     ...
     */
    powerAdjustCapability: TlvField(0, TlvNullable(TlvArray(DeviceEnergyManagement2.TlvPowerAdjust, { maxLength: 8 }))),
  ...
  DeviceEnergyManagement2.TlvPowerAdjustRequest = TlvObject({
    /**
  ...
  DeviceEnergyManagement2.TlvPowerAdjustEndEvent = TlvObject({
    /**
  ...
  DeviceEnergyManagement2.TlvCost = TlvObject({
    /**
  ...
  DeviceEnergyManagement2.TlvSlot = TlvObject({
    /**
     ...
     */
    costs: TlvOptionalField(13, TlvArray(DeviceEnergyManagement2.TlvCost, { maxLength: 5 })),
    /**
  ...
  DeviceEnergyManagement2.TlvForecast = TlvObject({
    /**
     ...
     */
    slots: TlvField(7, TlvArray(DeviceEnergyManagement2.TlvSlot, { maxLength: 10 })),
    /**
  ...
  DeviceEnergyManagement2.TlvPauseRequest = TlvObject({
    /**
  ...
  DeviceEnergyManagement2.TlvResumedEvent = TlvObject({
    /**
  ...
  DeviceEnergyManagement2.TlvStartTimeAdjustRequest = TlvObject({
    /**
  ...
  DeviceEnergyManagement2.TlvSlotAdjustment = TlvObject({
    /**
  ...
  DeviceEnergyManagement2.TlvModifyForecastRequest = TlvObject({
    /**
     ...
     */
    slotAdjustments: TlvField(1, TlvArray(DeviceEnergyManagement2.TlvSlotAdjustment, { maxLength: 10 })),
    /**
     * This field shall indicate the cause of the request from the EMS.
     *
  ...
  DeviceEnergyManagement2.TlvConstraints = TlvObject({
    /**
  ...
  DeviceEnergyManagement2.TlvRequestConstraintBasedForecastRequest = TlvObject({
    /**
     ...
     */
    constraints: TlvField(0, TlvArray(DeviceEnergyManagement2.TlvConstraints, { maxLength: 10 })),
    /**
     * This field shall indicate the cause of the request from the EMS.
     *
  ...
  DeviceEnergyManagement2.PowerAdjustmentComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      powerAdjustmentCapability: Attribute(5, TlvNullable(DeviceEnergyManagement2.TlvPowerAdjustCapability))
    },
    commands: {
      /**
       ...
       */
      powerAdjustRequest: Command(0, DeviceEnergyManagement2.TlvPowerAdjustRequest, 0, TlvNoResponse),
      /**
       * Allows a client to cancel an ongoing PowerAdjustmentRequest operation.
       *
       * @see {@link MatterSpecification.v142.Cluster} § 9.2.9.2
       */
      cancelPowerAdjustRequest: Command(1, TlvNoArguments, 1, TlvNoResponse)
    },
    events: {
      /**
       ...
       */
      powerAdjustStart: Event(0, Priority.Info, TlvNoArguments),
      /**
       * This event shall be generated when the Power Adjustment session ends.
       *
       * @see {@link MatterSpecification.v142.Cluster} § 9.2.10.2
       */
      powerAdjustEnd: Event(1, Priority.Info, DeviceEnergyManagement2.TlvPowerAdjustEndEvent)
    }
  });
  DeviceEnergyManagement2.PowerForecastReportingOrStateForecastReportingComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      forecast: Attribute(6, TlvNullable(DeviceEnergyManagement2.TlvForecast))
    }
  });
  DeviceEnergyManagement2.PowerAdjustmentOrStartTimeAdjustmentOrPausableOrForecastAdjustmentOrConstraintBasedAdjustmentComponent = MutableCluster.Component({
    attributes: {
      /**
       ...
       */
      optOutState: Attribute(7, TlvEnum())
    }
  });
  DeviceEnergyManagement2.PausableComponent = MutableCluster.Component({
    commands: {
      /**
       ...
       */
      pauseRequest: Command(3, DeviceEnergyManagement2.TlvPauseRequest, 3, TlvNoResponse),
      /**
       * Allows a client to cancel the PauseRequest command and enable earlier resumption of operation.
       *
       * @see {@link MatterSpecification.v142.Cluster} § 9.2.9.5
       */
      resumeRequest: Command(4, TlvNoArguments, 4, TlvNoResponse)
    },
    events: {
      /**
       ...
       */
      paused: Event(2, Priority.Info, TlvNoArguments),
      /**
       ...
       */
      resumed: Event(3, Priority.Info, DeviceEnergyManagement2.TlvResumedEvent)
    }
  });
  DeviceEnergyManagement2.StartTimeAdjustmentComponent = MutableCluster.Component({
    commands: {
      /**
       ...
       */
      startTimeAdjustRequest: Command(2, DeviceEnergyManagement2.TlvStartTimeAdjustRequest, 2, TlvNoResponse)
    }
  });
  DeviceEnergyManagement2.ForecastAdjustmentComponent = MutableCluster.Component({
    commands: {
      /**
       ...
       */
      modifyForecastRequest: Command(5, DeviceEnergyManagement2.TlvModifyForecastRequest, 5, TlvNoResponse)
    }
  });
  DeviceEnergyManagement2.ConstraintBasedAdjustmentComponent = MutableCluster.Component({
    commands: {
      /**
       ...
       */
      requestConstraintBasedForecast: Command(6, DeviceEnergyManagement2.TlvRequestConstraintBasedForecastRequest, 6, TlvNoResponse)
    }
  });
  DeviceEnergyManagement2.StartTimeAdjustmentOrForecastAdjustmentOrConstraintBasedAdjustmentComponent = MutableCluster.Component({
    commands: {
      /**
       ...
       */
      cancelRequest: Command(7, TlvNoArguments, 7, TlvNoResponse)
    }
  });
  DeviceEnergyManagement2.Base = MutableCluster.Component({
    id: 152,
    ...
    attributes: {
       ...
       */
      esaType: FixedAttribute(0, TlvEnum()),
      /**
       ...
       */
      esaCanGenerate: FixedAttribute(1, TlvBoolean),
      /**
       ...
       */
      absMinPower: Attribute(3, TlvInt64),
      /**
       ...
       */
      absMaxPower: Attribute(4, TlvInt64)
    },
    /**
  ...
  DeviceEnergyManagement2.ClusterInstance = MutableCluster.ExtensibleOnly(DeviceEnergyManagement2.Base);
  ...
  DeviceEnergyManagement2.CompleteInstance = MutableCluster({
    ...
    commands: {
      ...
      pauseRequest: MutableCluster.AsConditional(DeviceEnergyManagement2.PausableComponent.commands.pauseRequest, { mandatoryIf: [PAU] }),
    ...
    events: {
      ...
      paused: MutableCluster.AsConditional(DeviceEnergyManagement2.PausableComponent.events.paused, { mandatoryIf: [PAU] }),
      resumed: MutableCluster.AsConditional(DeviceEnergyManagement2.PausableComponent.events.resumed, { mandatoryIf: [PAU] })
    }
  });
