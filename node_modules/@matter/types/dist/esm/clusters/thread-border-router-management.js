...
((ThreadBorderRouterManagement2) => {
  ...
  ThreadBorderRouterManagement2.Base = MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      interfaceEnabled: Attribute(3, TlvBoolean, { persistent: true }),
      /**
       ...
       */
      activeDatasetTimestamp: Attribute(4, TlvNullable(TlvUInt64), { persistent: true }),
      /**
       ...
       */
      pendingDatasetTimestamp: Attribute(5, TlvNullable(TlvUInt64), { persistent: true })
    },
    commands: {
      /**
