...
((EnergyEvse2) => {
  ...
  EnergyEvse2.V2XComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      dischargingEnabledUntil: Attribute(4, TlvNullable(TlvEpochS), { persistent: true }),
      /**
       ...
       */
      maximumDischargeCurrent: Attribute(8, TlvInt64.bound({ min: 0 }), { persistent: true }),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 9.3.8
       */
      sessionEnergyDischarged: Attribute(67, TlvNullable(TlvInt64.bound({ min: 0 })), { persistent: true })
    },
    commands: {
      /**
  ...
  EnergyEvse2.ChargingPreferencesComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      nextChargeStartTime: Attribute(35, TlvNullable(TlvEpochS)),
      /**
       ...
       */
      nextChargeTargetTime: Attribute(36, TlvNullable(TlvEpochS)),
      /**
       ...
       */
      nextChargeRequiredEnergy: Attribute(37, TlvNullable(TlvInt64.bound({ min: 0 }))),
      /**
       ...
       */
      nextChargeTargetSoC: Attribute(38, TlvNullable(TlvPercent)),
      /**
  ...
  EnergyEvse2.SoCReportingComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      stateOfCharge: Attribute(48, TlvNullable(TlvPercent)),
      /**
       ...
       */
      batteryCapacity: Attribute(49, TlvNullable(TlvInt64.bound({ min: 0 })))
    }
  });
  EnergyEvse2.PlugAndChargeComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      vehicleId: Attribute(50, TlvNullable(TlvString.bound({ maxLength: 32 })))
    }
  });
  EnergyEvse2.RfidComponent = MutableCluster.Component({
    events: {
       ...
       */
      rfid: OptionalEvent(5, Priority.Info, EnergyEvse2.TlvRfidEvent)
    }
  });
  EnergyEvse2.Base = MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      chargingEnabledUntil: Attribute(3, TlvNullable(TlvEpochS), { persistent: true }),
      /**
       ...
       */
      circuitCapacity: Attribute(5, TlvInt64.bound({ min: 0 }), { persistent: true }),
      /**
       ...
       */
      minimumChargeCurrent: Attribute(6, TlvInt64.bound({ min: 0 }), { persistent: true }),
      /**
       ...
       */
      maximumChargeCurrent: Attribute(7, TlvInt64.bound({ min: 0 }), { persistent: true }),
      /**
       ...
       * @see {@link MatterSpecification.v142.Cluster} § 9.3.8
       */
      sessionId: Attribute(64, TlvNullable(TlvUInt32), { persistent: true }),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 9.3.8
       */
      sessionDuration: Attribute(65, TlvNullable(TlvUInt32), { persistent: true }),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 9.3.8
       */
      sessionEnergyCharged: Attribute(66, TlvNullable(TlvInt64.bound({ min: 0 })), { persistent: true })
    },
    commands: {
      /**
    ...
    events: {
       ...
       */
      evConnected: Event(0, Priority.Info, EnergyEvse2.TlvEvConnectedEvent),
      /**
       ...
       */
      evNotDetected: Event(1, Priority.Info, EnergyEvse2.TlvEvNotDetectedEvent),
      /**
       ...
       */
      energyTransferStarted: Event(2, Priority.Info, EnergyEvse2.TlvEnergyTransferStartedEvent),
      /**
       ...
       */
      energyTransferStopped: Event(3, Priority.Info, EnergyEvse2.TlvEnergyTransferStoppedEvent),
      /**
       ...
       */
      fault: Event(4, Priority.Critical, EnergyEvse2.TlvFaultEvent)
    },
    /**
