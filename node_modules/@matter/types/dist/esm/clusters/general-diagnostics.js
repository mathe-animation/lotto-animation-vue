...
((GeneralDiagnostics2) => {
  ...
  GeneralDiagnostics2.TlvPayloadTestRequest = TlvObject({
    /**
  ...
  GeneralDiagnostics2.TlvPayloadTestResponse = TlvObject({
    /**
  ...
  GeneralDiagnostics2.TlvNetworkInterface = TlvObject({
    /**
  ...
  GeneralDiagnostics2.TlvTestEventTriggerRequest = TlvObject({
    /**
  ...
  GeneralDiagnostics2.TlvTimeSnapshotResponse = TlvObject({
    /**
  ...
  GeneralDiagnostics2.TlvHardwareFaultChangeEvent = TlvObject({
    /**
     ...
     */
    current: TlvField(0, TlvArray(TlvEnum(), { maxLength: 11 })),
    /**
     ...
     */
    previous: TlvField(1, TlvArray(TlvEnum(), { maxLength: 11 }))
  });
  GeneralDiagnostics2.TlvRadioFaultChangeEvent = TlvObject({
    /**
     ...
     */
    current: TlvField(0, TlvArray(TlvEnum(), { maxLength: 7 })),
    /**
     ...
     */
    previous: TlvField(1, TlvArray(TlvEnum(), { maxLength: 7 }))
  });
  GeneralDiagnostics2.TlvNetworkFaultChangeEvent = TlvObject({
    /**
  ...
  GeneralDiagnostics2.TlvBootReasonEvent = TlvObject({
    /**
     * This field shall contain the reason for this BootReason event.
     *
     * @see {@link MatterSpecification.v142.Core} § 11.12.8.4.1
     */
    bootReason: TlvField(0, TlvEnum())
  });
  GeneralDiagnostics2.DataModelTestComponent = MutableCluster.Component({
    commands: {
      /**
  ...
  GeneralDiagnostics2.Base = MutableCluster.Component({
    id: 51,
    ...
    attributes: {
       ...
       */
      networkInterfaces: Attribute(0, TlvArray(GeneralDiagnostics2.TlvNetworkInterface, { maxLength: 8 }), { default: [] }),
      /**
       ...
       */
      rebootCount: Attribute(1, TlvUInt16, { persistent: true }),
      /**
       ...
       */
      upTime: Attribute(2, TlvUInt64, { omitChanges: true }),
      /**
       ...
       */
      totalOperationalHours: OptionalAttribute(3, TlvUInt32, { persistent: true, omitChanges: true }),
      /**
       ...
       */
      bootReason: OptionalAttribute(4, TlvEnum()),
      /**
    ...
    commands: {
       ...
       */
      timeSnapshot: Command(1, TlvNoArguments, 2, GeneralDiagnostics2.TlvTimeSnapshotResponse)
    },
    events: {
      /**
       ...
       */
      hardwareFaultChange: OptionalEvent(0, Priority.Critical, GeneralDiagnostics2.TlvHardwareFaultChangeEvent),
      /**
       ...
       */
      radioFaultChange: OptionalEvent(1, Priority.Critical, GeneralDiagnostics2.TlvRadioFaultChangeEvent),
      /**
       ...
       */
      networkFaultChange: OptionalEvent(2, Priority.Critical, GeneralDiagnostics2.TlvNetworkFaultChangeEvent),
      /**
       ...
       */
      bootReason: Event(3, Priority.Critical, GeneralDiagnostics2.TlvBootReasonEvent)
    },
    /**
     * This metadata controls which GeneralDiagnosticsCluster elements matter.js activates for specific feature
     * combinations.
     */
    extensions: MutableCluster.Extensions({ flags: { dataModelTest: true }, component: GeneralDiagnostics2.DataModelTestComponent })
  });
  GeneralDiagnostics2.ClusterInstance = MutableCluster(GeneralDiagnostics2.Base);
  GeneralDiagnostics2.Cluster = GeneralDiagnostics2.ClusterInstance;
  const DMTEST = { dataModelTest: true };
  GeneralDiagnostics2.CompleteInstance = MutableCluster({
