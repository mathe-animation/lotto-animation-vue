...
((ApplicationBasic2) => {
  ApplicationBasic2.TlvApplication = TlvObject({
    /**
  ...
  ApplicationBasic2.ClusterInstance = MutableCluster({
    id: 1293,
    ...
    attributes: {
       ...
       */
      vendorName: OptionalFixedAttribute(0, TlvString.bound({ maxLength: 32 })),
      /**
       ...
       */
      vendorId: OptionalFixedAttribute(1, TlvVendorId),
      /**
       ...
       */
      productId: OptionalFixedAttribute(3, TlvUInt16),
      /**
       ...
       */
      application: FixedAttribute(4, ApplicationBasic2.TlvApplication),
      /**
