...
export declare namespace ApplicationLauncher {
    ...
    const Base: {
        ...
        readonly features: {
             ...
             * supported application catalogs
             */
            readonly applicationPlatform: BitFlag;
        };
        readonly attributes: {
            /**
        ...
        readonly extensions: readonly [{
            readonly flags: {
                readonly applicationPlatform: true;
            };
            readonly component: {
                readonly attributes: {
                    /**
    ...
    const CompleteInstance: MutableCluster<{
        readonly id: import("#general").Branded<1292, "ClusterId">;
        readonly name: "ApplicationLauncher";
        readonly revision: 2;
        readonly features: {
            /**
...
export declare const ApplicationLauncherCluster: ApplicationLauncher.Cluster;
//# sourceMappingURL=application-launcher.d.ts.map