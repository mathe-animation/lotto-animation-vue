...
((PumpConfigurationAndControl2) => {
  ...
  PumpConfigurationAndControl2.Base = MutableCluster.Component({
    ...
    events: {
       ...
       */
      supplyVoltageLow: OptionalEvent(0, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      supplyVoltageHigh: OptionalEvent(1, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      powerMissingPhase: OptionalEvent(2, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      systemPressureLow: OptionalEvent(3, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      systemPressureHigh: OptionalEvent(4, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      dryRunning: OptionalEvent(5, Priority.Critical, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      motorTemperatureHigh: OptionalEvent(6, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      pumpMotorFatalFailure: OptionalEvent(7, Priority.Critical, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      electronicTemperatureHigh: OptionalEvent(8, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      pumpBlocked: OptionalEvent(9, Priority.Critical, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      sensorFailure: OptionalEvent(10, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      electronicNonFatalFailure: OptionalEvent(11, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      electronicFatalFailure: OptionalEvent(12, Priority.Critical, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      generalFault: OptionalEvent(13, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      leakage: OptionalEvent(14, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      airDetection: OptionalEvent(15, Priority.Info, TlvNoArguments),
      /**
       * @see {@link MatterSpecification.v142.Cluster} § 4.2.8
       */
      turbineOperation: OptionalEvent(16, Priority.Info, TlvNoArguments)
    },
    /**
