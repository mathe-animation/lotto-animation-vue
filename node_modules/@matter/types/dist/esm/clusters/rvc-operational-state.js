...
((RvcOperationalState2) => {
  ...
  ((OperationalState2) => {
    OperationalState2[OperationalState2["Stopped"] = 0] = "Stopped";
    OperationalState2[OperationalState2["Running"] = 1] = "Running";
    OperationalState2[OperationalState2["Paused"] = 2] = "Paused";
    OperationalState2[OperationalState2["Error"] = 3] = "Error";
    ...
    OperationalState2[OperationalState2["EmptyingDustBin"] = 67] = "EmptyingDustBin";
    OperationalState2[OperationalState2["CleaningMop"] = 68] = "CleaningMop";
    OperationalState2[OperationalState2["FillingWaterTank"] = 69] = "FillingWaterTank";
    OperationalState2[OperationalState2["UpdatingMaps"] = 70] = "UpdatingMaps";
  ...
  ((ErrorState2) => {
    ...
    ErrorState2[ErrorState2["LowBattery"] = 72] = "LowBattery";
    ErrorState2[ErrorState2["CannotReachTargetArea"] = 73] = "CannotReachTargetArea";
    ErrorState2[ErrorState2["DirtyWaterTankFull"] = 74] = "DirtyWaterTankFull";
    ErrorState2[ErrorState2["DirtyWaterTankMissing"] = 75] = "DirtyWaterTankMissing";
    ErrorState2[ErrorState2["WheelsJammed"] = 76] = "WheelsJammed";
    ErrorState2[ErrorState2["BrushJammed"] = 77] = "BrushJammed";
    ErrorState2[ErrorState2["NavigationSensorObscured"] = 78] = "NavigationSensorObscured";
  ...
  RvcOperationalState2.ClusterInstance = MutableCluster({
    ...
    attributes: {
       ...
       */
      countdownTime: OptionalAttribute(2, TlvNullable(TlvUInt32.bound({ max: 259200 })), { default: null }),
      /**
    ...
    events: {
       ...
       */
      operationalError: Event(0, Priority.Critical, RvcOperationalState2.TlvOperationalErrorEvent),
      /**
...
//# sourceMappingURL=rvc-operational-state.js.map
