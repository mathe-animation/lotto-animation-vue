 ...
 */
import { Bytes, Merge } from "#general";
...
export declare class ByteArrayBitmapSchemaInternal<T extends BitSchema> extends Schema<TypeFromBitSchema<T>> {
    private readonly bitSchemas;
    ...
    decodeInternal(data: Bytes): TypeFromBitSchema<T>;
}
