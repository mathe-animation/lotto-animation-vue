...
class QrPairingCodeSchema extends Schema {
  encodeInternal(payloadData) {
    ...
    const result = PREFIX + payloadData.map((payloadData2) => {
      ...
      const data = tlvData !== void 0 && tlvData.byteLength > 0 ? Bytes.of(Bytes.concat(QrCodeDataSchema.encode(payloadData2), tlvData)) : QrCodeDataSchema.encode(payloadData2);
      const result2 = Base38.encode(data);
...
export {
  ...
  MATTER_QR_CODE_ALL_PAYLOAD_MAX_LENGTH,
  MATTER_QR_CODE_SINGLE_PAYLOAD_MAX_LENGTH,
