...
Resource.add({
  ...
  children: [
    ...
    },
    {
      tag: "attribute",
      name: "MaxConstTemp",
      xref: "cluster\xA74.2.7.13",
      details: "This attribute specifies the maximum temperature the pump can maintain in the system when it is working with the ControlMode attribute set to ConstantTemperature.\nMaxConstTemp shall be greater than or equal to MinConstTemp Valid range is \u2013273.15 \xB0C to 327.67 \xB0C (steps of 0.01 \xB0C). Null if the value is invalid."
    },
    {
      tag: "attribute",
      name: "PumpStatus",
      xref: "cluster\xA74.2.7.14",
    ...
    { tag: "attribute", name: "AlarmMask", xref: "cluster\xA74.2.7" },
    { tag: "event", name: "SupplyVoltageLow", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "SupplyVoltageHigh", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "PowerMissingPhase", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "SystemPressureLow", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "SystemPressureHigh", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "DryRunning", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "MotorTemperatureHigh", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "PumpMotorFatalFailure", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "ElectronicTemperatureHigh", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "PumpBlocked", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "SensorFailure", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "ElectronicNonFatalFailure", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "ElectronicFatalFailure", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "GeneralFault", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "Leakage", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "AirDetection", xref: "cluster\xA74.2.8" },
    { tag: "event", name: "TurbineOperation", xref: "cluster\xA74.2.8" },
    {
      tag: "datatype",
      name: "PumpStatusBitmap",
      xref: "cluster\xA74.2.6.1",
      children: [
        {
          tag: "field",
          name: "DeviceFault",
          description: "A fault related to the system or pump device is detected.",
          xref: "cluster\xA74.2.6.1.1",
...
//# sourceMappingURL=pump-configuration-and-control.resource.js.map
