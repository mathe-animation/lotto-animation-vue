...
Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      xref: "cluster\xA71.14.5.6",
      details: "This attribute shall specify the details of any current error condition being experienced on the device when the OperationalState attribute is populated with Error. See Section 1.14.4.4, \u201CErrorStateStruct Type\u201D for general requirements on the population of this attribute.\nWhen there is no error detected, this shall have an ErrorStateID of NoError."
    },
    {
      tag: "event",
      name: "OperationalError",
      xref: "cluster\xA71.14.7.1",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          xref: "cluster\xA71.14.7.2.2",
          details: "The total operational time, in seconds, from when the operation was started via an initial Start command or autonomous/manual starting action, until the operation completed. This includes any time spent while paused. There may be cases whereby the total operational time exceeds the maximum value that can be conveyed by this attribute, in such instances, this attribute shall be populated with null."
        },
        {
          tag: "field",
          name: "PausedTime",
          xref: "cluster\xA71.14.7.2.3",
    ...
    },
    {
      ...
      children: [{
        ...
        xref: "cluster\xA71.14.6.5.1",
        details: "This shall indicate the success or otherwise of the attempted command invocation. On a successful invocation of the attempted command, the ErrorStateID shall be populated with NoError. See the individual command sections for additional specific requirements on population."
      }]
    },
    {
      tag: "datatype",
      name: "OperationalStateEnum",
      xref: "cluster\xA71.14.4.1",
    ...
    },
    {
      ...
      xref: "cluster\xA71.14.4.2",
      details: "The OperationalStateStruct is used to indicate a possible state of the device.",
      children: [
        {
          tag: "field",
          name: "OperationalStateId",
          xref: "cluster\xA71.14.4.2.1",
          details: "This shall be populated with a value from the OperationalStateEnum."
        },
        {
          tag: "field",
          name: "OperationalStateLabel",
          xref: "cluster\xA71.14.4.2.2",
          details: "This field is present when the OperationalStateID is from the set reserved for Manufacturer Specific States. If present, this shall contain a human-readable description of the operational state."
        }
      ]
    },
    {
    ...
    {
      tag: "datatype",
      name: "ErrorStateStruct",
      xref: "cluster\xA71.14.4.4",
      children: [
        {
          tag: "field",
          name: "ErrorStateId",
          xref: "cluster\xA71.14.4.4.1",
          details: "This shall be populated with a value from the ErrorStateEnum."
        },
        {
          tag: "field",
          name: "ErrorStateLabel",
          xref: "cluster\xA71.14.4.4.2",
          details: "This field is present when the ErrorStateID is from the set reserved for Manufacturer Specific errors. If present, this shall contain a human-readable description of the error state."
        },
        {
          tag: "field",
          name: "ErrorStateDetails",
          xref: "cluster\xA71.14.4.4.3",
...
//# sourceMappingURL=operational-state.resource.js.map
