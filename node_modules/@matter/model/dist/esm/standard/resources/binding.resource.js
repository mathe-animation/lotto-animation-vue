...
Resource.add({
  ...
  children: [
    { tag: "attribute", name: "Binding", xref: "core\xA79.6.6.1", details: "Each entry shall represent a binding." },
    {
      tag: "datatype",
      name: "TargetStruct",
      xref: "core\xA79.6.5.1",
      children: [
        {
          tag: "field",
          name: "Node",
          xref: "core\xA79.6.5.1.1",
          details: "This field is the remote target node ID. If the Endpoint field is present, this field shall be present."
        },
        {
          tag: "field",
          name: "Group",
          xref: "core\xA79.6.5.1.2",
...
//# sourceMappingURL=binding.resource.js.map
