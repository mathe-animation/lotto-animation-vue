...
Resource.add({
  ...
  children: [
    ...
    { tag: "attribute", name: "CurrentMode", xref: "cluster\xA79.6.6" },
    { tag: "attribute", name: "StartUpMode", xref: "cluster\xA79.6.6" },
    { tag: "attribute", name: "OnMode", xref: "cluster\xA79.6.6" },
    {
      tag: "datatype",
      name: "ModeOptionStruct",
      xref: "cluster\xA79.6.5.1",
    ...
    },
    {
      ...
      name: "ModeTag",
      children: [
        { tag: "field", name: "Auto", xref: "cluster\xA79.6.7.1" },
        { tag: "field", name: "Quick", xref: "cluster\xA79.6.7.1" },
        { tag: "field", name: "Quiet", xref: "cluster\xA79.6.7.1" },
        { tag: "field", name: "LowNoise", xref: "cluster\xA79.6.7.1" },
        { tag: "field", name: "LowEnergy", xref: "cluster\xA79.6.7.1" },
        { tag: "field", name: "Vacation", xref: "cluster\xA79.6.7.1" },
        { tag: "field", name: "Min", xref: "cluster\xA79.6.7.1" },
        { tag: "field", name: "Max", xref: "cluster\xA79.6.7.1" },
        { tag: "field", name: "Night", xref: "cluster\xA79.6.7.1" },
        { tag: "field", name: "Day", xref: "cluster\xA79.6.7.1" },
        {
          tag: "field",
          name: "Off",
          xref: "cluster\xA79.6.7.1.1",
          details: "While in modes with this tag, the device will not attempt to keep the water warm."
        },
        {
          tag: "field",
          name: "Manual",
          xref: "cluster\xA79.6.7.1.2",
...
//# sourceMappingURL=water-heater-mode.resource.js.map
