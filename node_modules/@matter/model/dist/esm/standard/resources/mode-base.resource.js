  ...
  children: [
    {
      tag: "attribute",
      name: "FeatureMap",
      xref: "cluster\xA71.10.4",
      children: [{
        tag: "field",
        name: "DEPONOFF",
        xref: "cluster\xA71.10.4.1",
    ...
    },
    {
      ...
      name: "ModeTag",
      children: [
        { tag: "field", name: "Auto", xref: "cluster\xA71.10.8" },
        { tag: "field", name: "Quick", xref: "cluster\xA71.10.8" },
        { tag: "field", name: "Quiet", xref: "cluster\xA71.10.8" },
        { tag: "field", name: "LowNoise", xref: "cluster\xA71.10.8" },
        { tag: "field", name: "LowEnergy", xref: "cluster\xA71.10.8" },
        { tag: "field", name: "Vacation", xref: "cluster\xA71.10.8" },
        { tag: "field", name: "Min", xref: "cluster\xA71.10.8" },
        { tag: "field", name: "Max", xref: "cluster\xA71.10.8" },
        { tag: "field", name: "Night", xref: "cluster\xA71.10.8" },
        { tag: "field", name: "Day", xref: "cluster\xA71.10.8" }
      ]
    }
  ]
});
//# sourceMappingURL=mode-base.resource.js.map
