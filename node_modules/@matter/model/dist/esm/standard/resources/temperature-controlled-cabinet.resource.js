...
Resource.add({
  ...
  children: [
    { tag: "requirement", name: "TemperatureControl", xref: "device\xA713.4.4" },
    { tag: "requirement", name: "TemperatureMeasurement", xref: "device\xA713.4.4" },
    { tag: "requirement", name: "RefrigeratorAndTemperatureControlledCabinetMode", xref: "device\xA713.4.4" },
    { tag: "requirement", name: "OvenMode", xref: "device\xA713.4.4" },
    { tag: "requirement", name: "OvenCavityOperationalState", xref: "device\xA713.4.4" },
    {
      tag: "field",
      name: "conditions",
      children: [
...
//# sourceMappingURL=temperature-controlled-cabinet.resource.js.map
