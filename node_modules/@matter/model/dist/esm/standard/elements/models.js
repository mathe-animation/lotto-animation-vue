...
const JointFabricDatastore = new ClusterModel(definitions.JointFabricDatastore);
const JointFabricAdministrator = new ClusterModel(definitions.JointFabricAdministrator);
...
const powerMVa = new DatatypeModel(definitions.powerMVa);
const energyMVAh = new DatatypeModel(definitions.energyMVAh);
const powerMVar = new DatatypeModel(definitions.powerMVar);
const energyMVaRh = new DatatypeModel(definitions.energyMVaRh);
const money = new DatatypeModel(definitions.money);
...
const ThreeLevelAutoEnum = new DatatypeModel(definitions.ThreeLevelAutoEnum);
...
const currency = new DatatypeModel(definitions.currency);
const price = new DatatypeModel(definitions.price);
...
const duration = new DatatypeModel(definitions.duration);
...
const ThermostatControllerDt = new DeviceTypeModel(definitions.ThermostatControllerDt);
