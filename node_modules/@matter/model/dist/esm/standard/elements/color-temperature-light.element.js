...
const ColorTemperatureLightDt = DeviceType(
  { name: "ColorTemperatureLight", id: 268, classification: "simple" },
  Requirement(
  ...
  Requirement({ name: "Groups", id: 4, conformance: "M", element: "serverCluster" }),
  Requirement(
  ...
  Requirement({ name: "OccupancySensing", id: 1030, conformance: "O", element: "clientCluster" })
);
MatterDefinition.children.push(ColorTemperatureLightDt);
export {
  ColorTemperatureLightDt
};
//# sourceMappingURL=color-temperature-light.element.js.map
