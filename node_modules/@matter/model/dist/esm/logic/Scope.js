...
function Scope(subject, options = {}) {
  ...
  if (subject.isScope || options.forceOwner) {
    ...
    const scope2 = new ModelTraversal().findScope(subject);
    if (scope2 === void 0) {
  ...
  let level = 0;
  new ModelTraversal().visitInheritance(owner, (scope2) => {
    level++;
