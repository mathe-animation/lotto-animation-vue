...
export declare class ModelTraversal {
     ...
     */
    findAspect<T extends Aspect, N extends string, M extends Model & {
        [n in N]: T;
    }>(model: M | undefined, name: N, factory: new (definition: undefined) => T): T | undefined;
    /**
     ...
     */
    findBitDefinition(scope: Model | undefined, bit: number): import("../models/FieldModel.js").FieldModel | undefined;
    /**
     ...
     */
    findParent(model?: Model): Model<import("../elements/BaseElement.js").BaseElement, Model<import("../elements/BaseElement.js").BaseElement, any>> | undefined;
    /**
