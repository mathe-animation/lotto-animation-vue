...
class Access extends import_Aspect.Aspect {
   ...
   */
  get complete() {
    return this.rw !== void 0 && (!this.readable || this.readPriv !== void 0) && (!this.writable || this.writePriv !== void 0);
  }
  /**
  ...
  constructor(definition) {
    ...
    this.readPriv = definition?.readPriv;
    this.writePriv = definition?.writePriv;
    this.fabric = definition?.fabric;
    this.timed = definition?.timed;
    this.isEmpty = (!this.rw || this.rw === Access.Rw.Read) && !this.fabric && !this.readPriv && !this.writePriv && !this.timed;
    this.freeze();
  }
  extend(other) {
    if (other.isEmpty) {
