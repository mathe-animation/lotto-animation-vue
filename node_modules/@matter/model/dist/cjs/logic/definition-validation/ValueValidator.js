...
class ValueValidator extends import_ModelValidator.ModelValidator {
  validate() {
    ...
    this.model.conformance.validateComputation(this, this.model.owner(import_models.ClusterModel)?.definedFeatures);
  ...
  #correctCaseFromShadow() {
    ...
    return false === new import_ModelTraversal.ModelTraversal().visitInheritance(this.model.parent?.base, (owner) => {
