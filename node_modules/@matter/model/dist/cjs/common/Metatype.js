...
__export(Metatype_exports, {
  Metatype: () => Metatype,
  UnsupportedCastError: () => UnsupportedCastError
});
module.exports = __toCommonJS(Metatype_exports);
 ...
 */
class UnsupportedCastError extends import_general.UnexpectedDataError {
}
...
((Metatype2) => {
  ...
  function native(type) {
    switch (type) {
      ...
      case "duration" /* duration */:
        return import_general.Duration;
    }
  }
  ...
  cast.bytes = (value) => {
    if (value === void 0 || value === null || import_general.Bytes.isBytes(value)) {
      return value;
    }
    if (typeof value === "string") {
  ...
  cast.date = (value) => {
    ...
    throw new import_general.UnexpectedDataError("Invalid date value");
  };
  cast.duration = (value) => {
    if (value === void 0 || value === null) {
      return value;
    }
    return (0, import_general.Duration)(value);
  };
})(Metatype || (Metatype = {}));
