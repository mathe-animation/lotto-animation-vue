...
function FieldValue(value) {
  if (typeof value === "function") {
    throw new import_general.UnexpectedDataError("Cannot cast function to FieldValue");
  }
...
((FieldValue2) => {
  ...
  FieldValue2.is = is;
  FieldValue2.Invalid = /* @__PURE__ */ Symbol("invalid");
  FieldValue2.None = {
  ...
  function Bytes(value) {
    return { type: FieldValue2.bytes, value: typeof value === "string" ? value : import_general.Bytes.toHex(import_general.Bytes.of(value)) };
  }
  FieldValue2.Bytes = Bytes;
  ...
  function unwrap(value, typeName) {
    ...
    switch (type) {
      ...
      case void 0:
        throw new import_general.UnexpectedDataError(`Field value objects must be wrappers with "type" field`);
      default:
        throw new import_general.UnexpectedDataError(`Unsupported wrapped object type "${type}"`);
    }
  }
