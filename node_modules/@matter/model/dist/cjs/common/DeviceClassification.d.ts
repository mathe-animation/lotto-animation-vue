...
export declare namespace DeviceClassification {
    function isUtility(classification: DeviceClassification | undefined): boolean;
    function isApplication(classification: DeviceClassification | undefined): boolean;
}
