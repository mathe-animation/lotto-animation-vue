...
var microwave_oven_element_exports = {};
__export(microwave_oven_element_exports, {
  MicrowaveOvenDt: () => MicrowaveOvenDt
});
module.exports = __toCommonJS(microwave_oven_element_exports);
 ...
 */
const MicrowaveOvenDt = (0, import_elements.DeviceTypeElement)(
  { name: "MicrowaveOven", id: 121, classification: "simple" },
  (0, import_elements.RequirementElement)(
    { name: "Descriptor", id: 29, element: "serverCluster" },
    (0, import_elements.RequirementElement)({ name: "DeviceTypeList", default: [{ deviceType: 121, revision: 2 }], element: "attribute" })
  ),
  ...
  (0, import_elements.RequirementElement)(
    ...
    (0, import_elements.RequirementElement)({ name: "CountdownTime", conformance: "M", element: "attribute" }),
    (0, import_elements.RequirementElement)({ name: "OperationCompletion", conformance: "M", element: "event" })
  ),
  (0, import_elements.RequirementElement)(
    { name: "FanControl", id: 514, conformance: "O", element: "serverCluster" },
