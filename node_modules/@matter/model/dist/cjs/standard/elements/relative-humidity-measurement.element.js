...
var relative_humidity_measurement_element_exports = {};
__export(relative_humidity_measurement_element_exports, {
  RelativeHumidityMeasurement: () => RelativeHumidityMeasurement
});
module.exports = __toCommonJS(relative_humidity_measurement_element_exports);
...
const RelativeHumidityMeasurement = (0, import_elements.ClusterElement)(
  { name: "RelativeHumidityMeasurement", id: 1029, classification: "application" },
  ...
  (0, import_elements.AttributeElement)({ name: "Tolerance", id: 3, type: "uint16", access: "R V", conformance: "O", constraint: "max 2048" })
);
import_MatterDefinition.MatterDefinition.children.push(RelativeHumidityMeasurement);
//# sourceMappingURL=relative-humidity-measurement.element.js.map
