...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      xref: "cluster\xA76.13.5.2",
      children: [
        {
          tag: "field",
          name: "RatingName",
          xref: "cluster\xA76.13.5.2.1",
    ...
    {
      tag: "datatype",
      name: "BlockChannelStruct",
      xref: "cluster\xA76.13.5.3",
      children: [
        {
          tag: "field",
          name: "BlockChannelIndex",
          xref: "cluster\xA76.13.5.3.1",
    ...
    },
    {
      tag: "datatype",
      name: "AppInfoStruct",
      xref: "cluster\xA76.13.5.4",
      children: [
        {
          tag: "field",
          name: "CatalogVendorId",
          xref: "cluster\xA76.13.5.4.1",
    ...
    },
    {
      ...
      xref: "cluster\xA76.13.5.5",
      children: [
        {
          tag: "field",
          name: "TimeWindowIndex",
          xref: "cluster\xA76.13.5.5.1",
        ...
        },
        {
          tag: "field",
          name: "DayOfWeek",
          xref: "cluster\xA76.13.5.5.2",
          details: "This field shall indicate a day of week."
        },
        {
          tag: "field",
          name: "TimePeriod",
          xref: "cluster\xA76.13.5.5.3",
    ...
    },
    {
      ...
      children: [
        ...
        {
          tag: "field",
          name: "UnidentifiableApplication",
          description: "Provided Application(s) is not identified."
        },
        {
          tag: "field",
          name: "ApplicationAlreadyExist",
...
//# sourceMappingURL=content-control.resource.js.map
