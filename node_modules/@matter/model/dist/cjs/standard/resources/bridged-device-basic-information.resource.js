...
import_Resource.Resource.add({
  ...
  children: [
    ...
    { tag: "attribute", name: "DataModelRevision", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "VendorName", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "VendorId", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "ProductName", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "ProductId", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "NodeLabel", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "Location", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "HardwareVersion", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "HardwareVersionString", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "SoftwareVersion", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "SoftwareVersionString", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "ManufacturingDate", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "PartNumber", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "ProductUrl", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "ProductLabel", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "SerialNumber", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "LocalConfigDisabled", xref: "core\xA79.13.5" },
    {
      tag: "attribute",
      name: "Reachable",
      xref: "core\xA79.13.5.2",
    ...
    { tag: "attribute", name: "CapabilityMinima", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "ProductAppearance", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "SpecificationVersion", xref: "core\xA79.13.5" },
    { tag: "attribute", name: "MaxPathsPerInvoke", xref: "core\xA79.13.5" },
    {
      tag: "attribute",
      name: "ConfigurationVersion",
      xref: "core\xA79.13.5.4",
      details: "This attribute shall contain the current version number for the configuration of the bridged device.\nIf the bridge detects a change on a bridged device, which it deems as a change in the configuration of the bridged device, it shall increase this attribute as described in Section 9.2.9, \u201CNode Configuration Changes\u201D.\nThe ability and the method used to detect such a change on a bridged device is manufacturer specific."
    },
    { tag: "event", name: "StartUp", xref: "core\xA79.13.7" },
    { tag: "event", name: "ShutDown", xref: "core\xA79.13.7" },
    {
      tag: "event",
      name: "Leave",
      xref: "core\xA79.13.7.1",
    ...
    },
    {
      ...
      xref: "core\xA79.13.7.2",
      details: "This event shall be generated when there is a change in the Reachable attribute. Its purpose is to provide an indication towards interested parties that the reachability of a bridged device has changed over its native connectivity technology, so they may take appropriate action. After (re)start of a bridge this event may be generated."
    },
    {
      tag: "event",
      name: "ActiveChanged",
      xref: "core\xA79.13.7.3",
      details: "This event (when supported) shall be generated the next time a bridged device becomes active after a KeepActive command is received. See KeepActive for more details.",
      children: [{
        tag: "field",
        name: "PromisedActiveDuration",
        xref: "core\xA79.13.7.3.1",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          tag: "field",
          name: "TimeoutMs",
          xref: "core\xA79.13.6.1.2",
          details: 'This field shall indicate the period, in milliseconds, that the server will wait before the "pending active" state expires. See the KeepActive Command description for details.\n> [!NOTE]\n> TimeoutMs is a timeout for the request, NOT the time the device will be awake for. The server will wait for up to TimeoutMs for the device. If after TimeoutMs the ICD device does NOT check-in, the server will not perform any actions.'
        }
      ]
    }
  ]
});
//# sourceMappingURL=bridged-device-basic-information.resource.js.map
