    ...
    children: [
      {
        tag: "attribute",
        name: "FeatureMap",
        xref: "cluster\xA74.4.4",
        children: [
          {
            tag: "field",
            name: "SPD",
            xref: "cluster\xA74.4.4.1",
      ...
      },
      {
        ...
        xref: "cluster\xA74.4.6.2",
        details: "This attribute indicates the fan speed ranges that shall be supported by the server."
      },
      {
        tag: "attribute",
        name: "PercentSetting",
        xref: "cluster\xA74.4.6.3",
        details: "Indicates the speed setting for the fan with a value of 0 indicating that the fan is off and a value of 100 indicating that the fan is set to run at its maximum speed. If the FanMode attribute is set to Auto, the value of this attribute shall be set to null.\nThis attribute may be written to by a client to indicate a new fan speed. If a client writes null to this attribute, the attribute value shall NOT change. If the fan is in a state where this attribute cannot be changed to the requested value, the server shall return INVALID_IN_STATE.\nWhen this attribute is successfully written, the server shall set the value of the FanMode and SpeedSetting (if present) attributes to values that abide by the mapping requirements listed below."
      },
      {
        tag: "attribute",
        name: "PercentCurrent",
        xref: "cluster\xA74.4.6.4",
        details: "Indicates the actual currently operating fan speed, or zero to indicate that the fan is off. There may be a temporary mismatch between the value of this attribute and the value of the PercentSetting attribute due to other system requirements or constraints that would not allow the fan to operate at the requested setting.\nFor example, if the value of this attribute is currently 50%, and the PercentSetting attribute is newly set to 25%, the value of this attribute may stay above 25% for a period necessary to dissipate internal heat, maintain product operational safety, etc.\nWhen the value of the FanMode attribute is AUTO, the value of this attribute may vary across the range over time.\nSee Section 4.4.6.3.1, \u201CPercent Rules\u201D for more details."
      },
      {
        tag: "attribute",
        name: "SpeedMax",
        xref: "cluster\xA74.4.6.5",
        details: "Indicates the maximum value to which the SpeedSetting attribute can be set."
      },
      {
        tag: "attribute",
        name: "SpeedSetting",
        xref: "cluster\xA74.4.6.6",
        details: "Indicates the speed setting for the fan. This attribute may be written by a client to indicate a new fan speed. If the FanMode attribute is set to Auto, the value of this attribute shall be set to null.\nThe server shall support all values between 0 and SpeedMax.\nIf a client writes null to this attribute, the attribute value shall NOT change. If the fan is in a state where this attribute cannot be changed to the requested value, the server shall return INVALID_IN_STATE.\nWhen this attribute is successfully written to, the server shall set the value of the FanMode and PercentSetting attributes to values that abide by the mapping requirements listed below."
      },
      {
        tag: "attribute",
        name: "SpeedCurrent",
        xref: "cluster\xA74.4.6.7",
        details: "Indicates the actual currently operating fan speed, or zero to indicate that the fan is off. There may be a temporary mismatch between the value of this attribute and the value of the SpeedSetting attribute due to other system requirements or constraints that would not allow the fan to operate at the requested setting.\nFor example, if the value of this attribute is currently 5, and the SpeedSetting attribute is newly set to 2, the value of this attribute may stay above 2 for a period necessary to dissipate internal heat, maintain product operational safety, etc.\nWhen the value of the FanMode attribute is AUTO, the value of this attribute may vary across the range over time.\nSee Section 4.4.6.6.1, \u201CSpeed Rules\u201D for more details."
      },
      {
        tag: "attribute",
        name: "RockSupport",
        xref: "cluster\xA74.4.6.8",
      ...
      },
      {
        tag: "datatype",
        name: "WindBitmap",
        xref: "cluster\xA74.4.5.2",
        children: [
          {
            tag: "field",
            name: "SleepWind",
            description: "Indicate sleep wind",
            xref: "cluster\xA74.4.5.2.1",
            details: "The fan speed, based on current settings, shall gradually slow down to a final minimum speed. For this process, the sequence, speeds and duration are MS."
          },
          {
            tag: "field",
            name: "NaturalWind",
            description: "Indicate natural wind",
            xref: "cluster\xA74.4.5.2.2",
            details: "The fan speed shall vary to emulate natural wind. For this setting, the sequence, speeds and duration are MS."
          }
        ]
      },
      {
        tag: "datatype",
        name: "StepDirectionEnum",
        xref: "cluster\xA74.4.5.3",
        children: [
      ...
      {
        tag: "datatype",
        name: "AirflowDirectionEnum",
        xref: "cluster\xA74.4.5.4",
        children: [
      ...
      {
        tag: "datatype",
        name: "FanModeSequenceEnum",
        xref: "cluster\xA74.4.5.6",
        children: [
          {
            tag: "field",
            name: "OffLowMedHigh",
...
//# sourceMappingURL=fan-control.resource.js.map
