  ...
  children: [
    {
      tag: "attribute",
      name: "FeatureMap",
      xref: "cluster\xA71.5.4",
      children: [
        {
          tag: "field",
          name: "LT",
          xref: "cluster\xA71.5.4.1",
    ...
    },
    {
      tag: "attribute",
      name: "OnOff",
      xref: "cluster\xA71.5.6.2",
      details: "This attribute indicates whether the device type implemented on the endpoint is turned off or turned on, in these cases the value of the OnOff attribute equals FALSE, or TRUE respectively."
    },
    {
      tag: "attribute",
      name: "GlobalSceneControl",
      xref: "cluster\xA71.5.6.3",
    ...
    },
    {
      tag: "attribute",
      name: "StartUpOnOff",
      xref: "cluster\xA71.5.6.6",
      details: "This attribute shall define the desired startup behavior of a device when it is supplied with power and this state shall be reflected in the OnOff attribute. If the value is null, the OnOff attribute is set to its previous value. Otherwise, the behavior is defined in the table defining StartUpOnOffEnum.\nThis behavior does not apply to reboots associated with OTA. After an OTA restart, the OnOff attribute shall return to its value prior to the restart."
    },
    { tag: "command", name: "Off", xref: "cluster\xA71.5.7.1" },
    { tag: "command", name: "On", xref: "cluster\xA71.5.7.2" },
    { tag: "command", name: "Toggle", xref: "cluster\xA71.5.7.3" },
    {
      tag: "command",
      name: "OffWithEffect",
      xref: "cluster\xA71.5.7.4",
      details: "The OffWithEffect command allows devices to be turned off using enhanced ways of fading.",
      children: [
        {
          tag: "field",
          name: "EffectIdentifier",
          xref: "cluster\xA71.5.7.4.1",
          details: "This field specifies the fading effect to use when turning the device off. This field shall contain one of the non-reserved values listed in EffectIdentifierEnum."
        },
        {
          tag: "field",
          name: "EffectVariant",
          xref: "cluster\xA71.5.7.4.2",
          details: "This field is used to indicate which variant of the effect, indicated in the EffectIdentifier field, SHOULD be triggered. If the server does not support the given variant, it shall use the default variant. This field is dependent on the value of the EffectIdentifier field and shall contain one of the non-reserved values listed in either DelayedAllOffEffectVariantEnum or DyingLightEffectVariantEnum."
        }
      ]
    },
    {
