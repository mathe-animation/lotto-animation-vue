...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          xref: "core\xA79.16.7.1.2",
          details: "This field shall provide the monitored subject ID."
        },
        {
          tag: "field",
          name: "Key",
          xref: "core\xA79.16.7.1.3",
          details: "This field shall contain the ICDToken, a 128-bit symmetric key shared by the ICD and the ICD Client, used to encrypt Check-In messages from this ICD to the MonitoredSubject."
        },
        {
          tag: "field",
          name: "VerificationKey",
          xref: "core\xA79.16.7.1.4",
    ...
    },
    {
      ...
      xref: "core\xA79.16.5.3",
      children: [
        {
          tag: "field",
          name: "CheckInNodeId",
          xref: "core\xA79.16.5.3.1",
...
//# sourceMappingURL=icd-management.resource.js.map
