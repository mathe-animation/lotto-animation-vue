...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      tag: "attribute",
      name: "ThreadMetrics",
      xref: "core\xA711.13.6.1",
      details: "This attribute shall be a list of ThreadMetricsStruct structs. Each active thread on the Node shall be represented by a single entry within the ThreadMetrics attribute."
    },
    {
      tag: "attribute",
      name: "CurrentHeapFree",
      xref: "core\xA711.13.6.2",
      details: "Indicates the current amount of heap memory, in bytes, that are free for allocation. The effective amount may be smaller due to heap fragmentation or other reasons."
    },
    {
      tag: "attribute",
      name: "CurrentHeapUsed",
      xref: "core\xA711.13.6.3",
      details: "Indicates the current amount of heap memory, in bytes, that is being used."
    },
    {
      tag: "attribute",
      name: "CurrentHeapHighWatermark",
      xref: "core\xA711.13.6.4",
      details: "Indicates the maximum amount of heap memory, in bytes, that has been used by the Node. This value shall only be reset upon a Node reboot or upon receiving of the ResetWatermarks command."
    },
    {
      tag: "event",
      name: "SoftwareFault",
      xref: "core\xA711.13.8.1",
      details: "This Event shall be generated when a software fault occurs on the Node.",
      children: [
        {
          tag: "field",
          name: "Id",
          xref: "core\xA711.13.8.1.1",
          details: "This field shall be set to the ID of the software thread in which the last software fault occurred."
        },
        {
          tag: "field",
          name: "Name",
          xref: "core\xA711.13.8.1.2",
          details: "This field shall be set to a manufacturer-specified name or prefix of the software thread in which the last software fault occurred."
        },
        {
          tag: "field",
          name: "FaultRecording",
          xref: "core\xA711.13.8.1.3",
          details: "This field shall be a manufacturer-specified payload intended to convey information to assist in further diagnosing or debugging a software fault. The FaultRecording field may be used to convey information such as, but not limited to, thread backtraces or register contents."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      xref: "core\xA711.13.5.1",
      children: [
        {
          tag: "field",
          name: "Id",
          xref: "core\xA711.13.5.1.1",
...
//# sourceMappingURL=software-diagnostics.resource.js.map
