  ...
  children: [
    {
      ...
      children: [
        ...
        { tag: "field", name: "RAD", details: "Supports sensing using radar waves (microwave)" },
        {
          tag: "field",
          name: "RFS",
          details: "Supports sensing using analysis of radio signals, e.g.: RSSI, CSI and/or any other metric from the signal"
        },
    ...
    { tag: "attribute", name: "OccupancySensorType", xref: "cluster\xA72.7.6" },
    { tag: "attribute", name: "OccupancySensorTypeBitmap", xref: "cluster\xA72.7.6" },
    {
      tag: "attribute",
      name: "HoldTime",
      xref: "cluster\xA72.7.6.3",
    ...
    },
    {
      ...
      xref: "cluster\xA72.7.5.1",
      children: [{
        tag: "field",
        name: "Occupied",
        description: "Indicates the sensed occupancy state",
        xref: "cluster\xA72.7.5.1.1",
...
//# sourceMappingURL=occupancy-sensing.resource.js.map
