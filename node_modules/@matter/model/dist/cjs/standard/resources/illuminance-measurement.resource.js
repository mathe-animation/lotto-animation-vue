...
import_Resource.Resource.add(
  {
    ...
    children: [
      ...
      { tag: "attribute", name: "Tolerance", xref: "cluster\xA72.2.5.4", details: "See Measured Value." },
      {
        tag: "attribute",
        name: "LightSensorType",
        xref: "cluster\xA72.2.5.5",
      ...
      {
        tag: "datatype",
        name: "LightSensorTypeEnum",
        xref: "cluster\xA72.2.4.1",
        children: [
...
//# sourceMappingURL=illuminance-measurement.resource.js.map
