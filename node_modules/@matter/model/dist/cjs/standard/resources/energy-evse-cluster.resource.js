...
import_Resource.Resource.add(
  {
    ...
    children: [
      ...
      },
      {
        ...
        xref: "cluster\xA79.3.8.6",
        details: "Indicates the capacity that the circuit that the EVSE is connected to can provide. It is intended to allow implementation of a self-managed network of EVSEs. It is assumed that the device will allow the setting of such values by an installer."
      },
      {
        tag: "attribute",
        name: "MinimumChargeCurrent",
        xref: "cluster\xA79.3.8.7",
      ...
      },
      {
        tag: "event",
        name: "EvNotDetected",
        xref: "cluster\xA79.3.10.2",
        details: "This event shall be generated when the EV is unplugged or not detected (having been previously plugged in). When the vehicle is unplugged then the session is ended.",
        children: [
          {
            tag: "field",
            name: "SessionId",
            xref: "cluster\xA79.3.10.2.1",
            details: "This field shall indicate the current value of the SessionID attribute."
          },
          {
            tag: "field",
            name: "State",
            xref: "cluster\xA79.3.10.2.2",
            details: "This field shall indicate the value of the State attribute prior to the EV not being detected."
          },
          {
            tag: "field",
            name: "SessionDuration",
            xref: "cluster\xA79.3.10.2.3",
            details: "This field shall indicate the total duration of the session, from the start of the session when the EV was plugged in, until it was unplugged."
          },
          {
            tag: "field",
            name: "SessionEnergyCharged",
            xref: "cluster\xA79.3.10.2.4",
            details: "This field shall indicate the total amount of energy transferred from the EVSE to the EV during the session.\nNote that if bi-directional charging occurs during the session, then this value shall only include the sum of energy transferred from the EVSE to the EV, and shall NOT be a net value of charging and discharging energy."
          },
          {
            tag: "field",
            name: "SessionEnergyDischarged",
            xref: "cluster\xA79.3.10.2.5",
            details: "This field shall indicate the total amount of energy transferred from the EV to the EVSE during the session.\nNote that if bi-directional discharging occurs during the session, then this value shall only include the sum of energy transferred from the EV to the EVSE, and shall NOT be a net value of charging and discharging energy."
          }
        ]
      },
      {
        ...
        xref: "cluster\xA79.3.10.3",
        details: "This event shall be generated whenever the EV starts charging or discharging, except when an EV has switched between charging and discharging under the control of the PowerAdjustment feature of the Device Energy Management cluster of the associated Device Energy Management device.",
        children: [
          {
            tag: "field",
            name: "SessionId",
            xref: "cluster\xA79.3.10.3.1",
            details: "This field shall indicate the value of the SessionID attribute at the time the event was generated."
          },
          {
            tag: "field",
            name: "State",
            xref: "cluster\xA79.3.10.3.2",
            details: "This field shall indicate the value of the State attribute at the time the event was generated."
          },
          {
            tag: "field",
            name: "MaximumCurrent",
            xref: "cluster\xA79.3.10.3.3",
            details: "This field shall indicate the value of the maximum charging current at the time the event was generated.\nA non-zero value indicates that the EV has been enabled for charging and the value is taken directly from the MaximumChargeCurrent attribute. A zero value indicates that the EV has not been enabled for charging."
          },
          {
            tag: "field",
            name: "MaximumDischargeCurrent",
            xref: "cluster\xA79.3.10.3.4",
            details: "This field shall indicate the value of the maximum discharging current at the time the event was generated.\nA non-zero value indicates that the EV has been enabled for discharging and the value is taken directly from the MaximumDischargeCurrent attribute. A zero value indicates that the EV has not been enabled for discharging."
          }
        ]
      },
      {
        ...
        xref: "cluster\xA79.3.10.4",
        details: "This event shall be generated whenever the EV stops charging or discharging, except when an EV has switched between charging and discharging under the control of the PowerAdjustment feature of the Device Energy Management cluster of the associated Device Energy Management device.",
        children: [
          {
            tag: "field",
            name: "SessionId",
            xref: "cluster\xA79.3.10.4.1",
            details: "This field shall indicate the value of the SessionID attribute prior to the energy transfer stopping."
          },
          {
            tag: "field",
            name: "State",
            xref: "cluster\xA79.3.10.4.2",
            details: "This field shall indicate the value of the State attribute prior to the energy transfer stopping."
          },
          {
            tag: "field",
            name: "Reason",
            xref: "cluster\xA79.3.10.4.3",
            details: "This field shall indicate the reason why the energy transferred stopped."
          },
          {
            tag: "field",
            name: "EnergyTransferred",
            xref: "cluster\xA79.3.10.4.4",
            details: "This field shall indicate the amount of energy transferred from the EVSE to the EV since the previous EnergyTransferStarted event, in mWh."
          },
          {
            tag: "field",
            name: "EnergyDischarged",
            xref: "cluster\xA79.3.10.4.5",
            details: "This field shall indicate the amount of energy transferred from the EV to the EVSE since the previous EnergyTransferStarted event, in mWh."
          }
        ]
      },
      {
        tag: "event",
        name: "Fault",
        xref: "cluster\xA79.3.10.5",
        details: "If the EVSE detects a fault it shall generate a Fault Event. The SupplyState attribute shall be set to DisabledError and the type of fault detected by the EVSE shall be stored in the FaultState attribute.\nThis event shall be generated when the FaultState changes from any error state. i.e. if it changes from NoError to any other state and if the error then clears, this would generate 2 events.\nIt is assumed that the fault will be cleared locally on the EVSE device. When all faults have been cleared, the EVSE device shall set the FaultState attribute to NoError and the SupplyState attribute shall be set back to its previous state.",
        children: [
          {
            tag: "field",
            name: "SessionId",
            xref: "cluster\xA79.3.10.5.1",
            details: "This field shall indicate the value of the SessionID attribute prior to the Fault State being changed. A value of null indicates no sessions have occurred before the fault occurred."
          },
          {
            tag: "field",
            name: "State",
            xref: "cluster\xA79.3.10.5.2",
          ...
          },
          {
            ...
            xref: "cluster\xA79.3.10.5.3",
            details: "This field shall indicate the value of the FaultState attribute prior to the Fault State being changed."
          },
          {
            tag: "field",
            name: "FaultStateCurrentState",
            xref: "cluster\xA79.3.10.5.4",
      ...
      },
      {
        tag: "event",
        name: "Rfid",
        xref: "cluster\xA79.3.10.6",
        details: "This event shall be generated when a RFID card has been read. This allows a controller to register the card ID and use this to authenticate and start the charging session.",
        children: [{
          tag: "field",
          name: "Uid",
          xref: "cluster\xA79.3.10.6.1",
      ...
      },
      {
        tag: "command",
        name: "Disable",
        xref: "cluster\xA79.3.9.1",
        details: "Allows a client to disable the EVSE from charging and discharging."
      },
      {
        tag: "command",
        name: "EnableCharging",
        xref: "cluster\xA79.3.9.2",
        details: "This command allows a client to enable the EVSE to charge an EV, and to provide or update the maximum and minimum charge current.",
        children: [
          {
            tag: "field",
            name: "ChargingEnabledUntil",
            xref: "cluster\xA79.3.9.2.1",
      ...
      },
      {
        ...
        xref: "cluster\xA79.3.9.3",
        details: "Upon receipt, this shall allow a client to enable the discharge of an EV, and to provide or update the maximum discharge current.",
        children: [
          {
            tag: "field",
            name: "DischargingEnabledUntil",
            xref: "cluster\xA79.3.9.3.1",
          ...
          },
          {
            tag: "field",
            name: "MaximumDischargeCurrent",
            xref: "cluster\xA79.3.9.3.2",
            details: "This field shall indicate the maximum current that can be received by the EVSE from the EV. The EVSE current limit can be advertised to an EV in 0.6A steps. The value of the MaximumDischargeCurrent attribute shall be stored and persisted across reboots by the EVSE to the value of this field."
          }
        ]
      },
      {
        ...
        xref: "cluster\xA79.3.9.4",
        details: "Allows a client to put the EVSE into a self-diagnostics mode."
      },
      {
        tag: "command",
        name: "SetTargets",
        xref: "cluster\xA79.3.9.5",
        details: "Allows a client to set the user specified charging targets.",
        children: [{
          tag: "field",
          name: "ChargingTargetSchedules",
          xref: "cluster\xA79.3.9.5.1",
          details: "This field shall indicate a list of up to 7 sets of daily charging targets together with their associated days of the week. Each of the days of the week may only be included in a single ChargingTargetSchedule within this list field."
        }]
      },
      {
        tag: "command",
        name: "GetTargets",
        xref: "cluster\xA79.3.9.6",
        details: "Allows a client to retrieve the current set of charging targets."
      },
      {
        tag: "command",
        name: "ClearTargets",
        xref: "cluster\xA79.3.9.8",
        details: "Allows a client to clear all stored charging targets."
      },
      {
        tag: "command",
        name: "GetTargetsResponse",
        xref: "cluster\xA79.3.9.7",
        details: "The GetTargetsResponse is sent in response to the GetTargets Command.",
        children: [{
          tag: "field",
          name: "ChargingTargetSchedules",
          xref: "cluster\xA79.3.9.7.1",
          details: "This field shall indicate a list of up to 7 sets of daily charging targets together with their associated days of the week."
        }]
      },
      {
        tag: "datatype",
        name: "TargetDayOfWeekBitmap",
        xref: "cluster\xA79.3.7.1",
        children: [
        ...
        children: [
          {
            ...
            xref: "cluster\xA79.3.7.8",
            details: "This field shall indicate the days of the week that the charging targets SHOULD be associated to. This field is a bitmap and therefore the associated targets could be applied to multiple days."
          },
          {
            tag: "field",
            name: "ChargingTargets",
            xref: "cluster\xA79.3.7.9",
            details: "This field shall indicate a list of up to 10 charging targets for each of the associated days of the week."
          }
        ]
      }
    ]
...
//# sourceMappingURL=energy-evse-cluster.resource.js.map
