...
import_Resource.Resource.add(
  {
    ...
    children: [
      ...
      { tag: "attribute", name: "SecurityLevel", xref: "cluster\xA75.2.9" },
      {
        tag: "attribute",
        name: "ExpiringUserTimeout",
        xref: "cluster\xA75.2.9.36",
      ...
      },
      {
        ...
        xref: "cluster\xA75.2.9.41",
        details: "Indicates the Group Resolving Key as defined in [Aliro].\nNull if no group resolving key has been configured on the lock. See Section 5.2.10.42, \u201CSetAliroReaderConfig Command\u201D."
      },
      {
        tag: "attribute",
        name: "AliroSupportedBleuwbProtocolVersions",
        xref: "cluster\xA75.2.9.42",
      ...
      },
      {
        tag: "event",
        name: "DoorLockAlarm",
        xref: "cluster\xA75.2.11.1",
        details: "The door lock server provides several alarms which can be sent when there is a critical state on the door lock. The alarms available for the door lock server are listed in AlarmCodeEnum.",
        children: [{
          tag: "field",
          name: "AlarmCode",
          xref: "cluster\xA75.2.11.1.1",
        ...
        children: [
          {
            ...
            xref: "cluster\xA75.2.11.3.1",
            details: "This field shall indicate the type of the lock operation that was performed."
          },
          {
            tag: "field",
            name: "OperationSource",
            xref: "cluster\xA75.2.11.3.2",
            details: "This field shall indicate the source of the lock operation that was performed."
          },
          {
            tag: "field",
            name: "UserIndex",
            xref: "cluster\xA75.2.11.3.3",
            details: "This field shall indicate the UserIndex who performed the lock operation. This shall be null if there is no user index that can be determined for the given operation source. This shall NOT be null if a user index can be determined. In particular, this shall NOT be null if the operation was associated with a valid credential."
          },
          {
            tag: "field",
            name: "FabricIndex",
            xref: "cluster\xA75.2.11.3.4",
            details: 'This field shall indicate the fabric index of the fabric that performed the lock operation. This shall be null if there is no fabric that can be determined for the given operation source. This shall NOT be null if the operation source is "Remote".'
          },
          {
            tag: "field",
            name: "SourceNode",
            xref: "cluster\xA75.2.11.3.5",
            details: 'This field shall indicate the Node ID of the node that performed the lock operation. This shall be null if there is no Node associated with the given operation source. This shall NOT be null if the operation source is "Remote".'
          },
          {
            tag: "field",
            name: "Credentials",
            xref: "cluster\xA75.2.11.3.6",
            details: "This field shall indicate the list of credentials used in performing the lock operation. This shall be null if no credentials were involved."
          }
        ]
      },
      {
        ...
        xref: "cluster\xA75.2.11.4",
        details: "The door lock server sends out a LockOperationError event when a lock operation fails for various reasons.",
        children: [
          {
            tag: "field",
            name: "LockOperationType",
            xref: "cluster\xA75.2.11.4.1",
            details: "This field shall indicate the type of the lock operation that was performed."
          },
          {
            tag: "field",
            name: "OperationSource",
            xref: "cluster\xA75.2.11.4.2",
            details: "This field shall indicate the source of the lock operation that was performed."
          },
          {
            tag: "field",
            name: "OperationError",
            xref: "cluster\xA75.2.11.4.3",
            details: "This field shall indicate the lock operation error triggered when the operation was performed."
          },
          {
            tag: "field",
            name: "UserIndex",
            xref: "cluster\xA75.2.11.4.4",
            details: "This field shall indicate the lock UserIndex who performed the lock operation. This shall be null if there is no user id that can be determined for the given operation source."
          },
          {
            tag: "field",
            name: "FabricIndex",
            xref: "cluster\xA75.2.11.4.5",
            details: 'This field shall indicate the fabric index of the fabric that performed the lock operation. This shall be null if there is no fabric that can be determined for the given operation source. This shall NOT be null if the operation source is "Remote".'
          },
          {
            tag: "field",
            name: "SourceNode",
            xref: "cluster\xA75.2.11.4.6",
            details: 'This field shall indicate the Node ID of the node that performed the lock operation. This shall be null if there is no Node associated with the given operation source. This shall NOT be null if the operation source is "Remote".'
          },
          {
            tag: "field",
            name: "Credentials",
            xref: "cluster\xA75.2.11.4.7",
            details: "This field shall indicate the list of credentials used in performing the lock operation. This shall be null if no credentials were involved."
          }
        ]
      },
        ...
        children: [
          {
            tag: "field",
            name: "LockDataType",
            xref: "cluster\xA75.2.11.5.1",
            details: "This field shall indicate the lock data type that was changed."
          },
          {
            tag: "field",
            name: "DataOperationType",
            xref: "cluster\xA75.2.11.5.2",
            details: "This field shall indicate the data operation performed on the lock data type changed."
          },
          {
            tag: "field",
            name: "OperationSource",
            xref: "cluster\xA75.2.11.5.3",
            details: "This field shall indicate the source of the user data change."
          },
          {
            tag: "field",
            name: "UserIndex",
            xref: "cluster\xA75.2.11.5.4",
            details: "This field shall indicate the lock UserIndex associated with the change (if any). This shall be null if there is no specific user associated with the data operation. This shall be 0xFFFE if all users are affected (e.g. Clear Users)."
          },
          {
            tag: "field",
            name: "FabricIndex",
            xref: "cluster\xA75.2.11.5.5",
            details: 'This field shall indicate the fabric index of the fabric that performed the change (if any). This shall be null if there is no fabric that can be determined to have caused the change. This shall NOT be null if the operation source is "Remote".'
          },
          {
            tag: "field",
            name: "SourceNode",
            xref: "cluster\xA75.2.11.5.6",
            details: 'This field shall indicate the Node ID that performed the change (if any). The Node ID of the node that performed the change. This shall be null if there was no Node involved in the change. This shall NOT be null if the operation source is "Remote".'
          },
          {
            tag: "field",
            name: "DataIndex",
            xref: "cluster\xA75.2.11.5.7",
            details: "This field shall indicate the index of the specific item that was changed (e.g. schedule, PIN, RFID, etc.) in the list of items identified by LockDataType. This shall be null if the LockDataType does not correspond to a list that can be indexed into (e.g. ProgrammingUser). This shall be 0xFFFE if all indices are affected (e.g. ClearPINCode, ClearRFIDCode, ClearWeekDaySchedule, ClearYearDaySchedule, etc.)."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        children: [{
          tag: "field",
          name: "PinCode",
          xref: "cluster\xA75.2.10.2.1",
          details: "See Section 5.2.10.1.1, \u201CPINCode Field\u201D."
        }]
      },
      { tag: "command", name: "Toggle", xref: "cluster\xA75.2.10" },
      {
        tag: "command",
        name: "UnlockWithTimeout",
        xref: "cluster\xA75.2.10.3",
        ...
        children: [
          {
            tag: "field",
            name: "Timeout",
            xref: "cluster\xA75.2.10.3.1",
            details: "This field shall indicate the timeout in seconds to wait before relocking the door lock. This value is independent of the AutoRelockTime attribute value."
          },
          {
            tag: "field",
            name: "PinCode",
            xref: "cluster\xA75.2.10.3.2",
            details: "See Section 5.2.10.1.1, \u201CPINCode Field\u201D."
          }
        ]
      },
      ...
      },
      {
        tag: "command",
        name: "GetPinCode",
        xref: "cluster\xA75.2.10.5",
        details: "Retrieve a PIN Code.",
        children: [{
          tag: "field",
          name: "UserId",
          xref: "cluster\xA75.2.10.5.1",
          details: "This field shall indicate the user ID. The value of the UserID field shall be between 0 and the value of the NumberOfPINUsersSupported attribute."
        }]
      },
      {
      ...
      },
      {
        tag: "command",
        name: "SetUserStatus",
        xref: "cluster\xA75.2.10.9",
        details: "Set the status of a user ID.",
        children: [
          {
            tag: "field",
            name: "UserId",
            xref: "cluster\xA75.2.10.9.1",
            details: "This field shall indicate the user ID. The value of the UserID field shall be between 0 and the value of the NumberOfPINUsersSupported attribute."
          },
          {
            tag: "field",
            name: "UserStatus",
            xref: "cluster\xA75.2.10.9.2",
      ...
      },
      {
        tag: "command",
        name: "GetUserStatus",
        xref: "cluster\xA75.2.10.10",
        details: "Get the status of a user.",
        children: [{
          tag: "field",
          name: "UserId",
          xref: "cluster\xA75.2.10.10.1",
          details: "This field shall indicate the user ID. The value of the UserID field shall be between 0 and the value of the NumberOfPINUsersSupported attribute."
        }]
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            tag: "field",
            name: "StartHour",
            xref: "cluster\xA75.2.10.14.4",
            details: "This field shall indicate the starting hour for the Week Day schedule."
          },
          {
            tag: "field",
            name: "StartMinute",
            xref: "cluster\xA75.2.10.14.5",
            details: "This field shall indicate the starting minute for the Week Day schedule."
          },
          {
            tag: "field",
            name: "EndHour",
            xref: "cluster\xA75.2.10.14.6",
            details: "This field shall indicate the ending hour for the Week Day schedule. EndHour shall be equal to or greater than StartHour."
          },
          {
            tag: "field",
            name: "EndMinute",
            xref: "cluster\xA75.2.10.14.7",
            details: "This field shall indicate the ending minute for the Week Day schedule. If EndHour is equal to StartHour then EndMinute shall be greater than StartMinute."
          }
        ]
      },
        ...
        children: [
          {
            tag: "field",
            name: "YearDayIndex",
            xref: "cluster\xA75.2.10.16.1",
            details: "This field shall indicate the index of the Year Day schedule."
          },
          {
            tag: "field",
            name: "UserIndex",
            xref: "cluster\xA75.2.10.16.2",
            details: "This field shall indicate the user ID."
          },
          {
            tag: "field",
            name: "LocalStartTime",
            xref: "cluster\xA75.2.10.16.3",
      ...
      },
      {
        ...
        xref: "cluster\xA75.2.10.18",
        details: "Returns the year day schedule data for the specified schedule and user indexes.",
        children: [
          {
            tag: "field",
            name: "YearDayIndex",
            xref: "cluster\xA75.2.10.18.1",
            details: "This field shall indicate the index of the Year Day schedule."
          },
          {
            tag: "field",
            name: "UserIndex",
            xref: "cluster\xA75.2.10.18.2",
            details: "This field shall indicate the user ID."
          },
          {
            tag: "field",
            name: "Status",
            xref: "cluster\xA75.2.10.18.3",
      ...
      },
      {
        tag: "command",
        name: "SetUserType",
        xref: "cluster\xA75.2.10.24",
        details: "Set the user type for a specified user.\nFor user type value please refer to User Type Value.\nReturn status shall be one of the following values:\nOne or more fields violates constraints or is invalid. Door lock is unable to switch from restricted to unrestricted user (e.g. need to clear schedules to switch).",
        children: [
          {
            tag: "field",
            name: "UserId",
            xref: "cluster\xA75.2.10.24.1",
            details: "This field shall indicate the user ID."
          },
          {
            tag: "field",
            name: "UserType",
            xref: "cluster\xA75.2.10.24.2",
      ...
      },
      {
        tag: "command",
        name: "GetRfidCode",
        xref: "cluster\xA75.2.10.28",
        details: "Retrieve an RFID code.",
        children: [{
          tag: "field",
          name: "UserId",
          xref: "cluster\xA75.2.10.28.1",
          details: "This field shall indicate the user ID.\nThe value of the UserID field shall be between 0 and the value of the NumberOfRFIDUsersSupported attribute."
        }]
      },
      {
        ...
        children: [
          {
            tag: "field",
            name: "OperationType",
            xref: "cluster\xA75.2.10.32.1",
            details: "This field shall indicate the type of operation."
          },
          {
            tag: "field",
            name: "UserIndex",
            xref: "cluster\xA75.2.10.32.2",
            details: "This field shall indicate the user ID."
          },
          {
            tag: "field",
            name: "UserName",
            xref: "cluster\xA75.2.10.32.3",
      ...
      },
      {
        tag: "command",
        name: "GetUser",
        xref: "cluster\xA75.2.10.33",
        details: "Retrieve user.\nAn InvokeResponse command shall be sent with an appropriate error (e.g. FAILURE, INVALID_COMMAND, etc.) as needed otherwise the GetUserResponse Command shall be sent implying a status of SUCCESS."
      },
      {
        tag: "command",
        name: "GetUserResponse",
        xref: "cluster\xA75.2.10.34",
      ...
      {
        tag: "datatype",
        name: "CredentialRulesBitmap",
        xref: "cluster\xA75.2.6.2",
        children: [
      ...
      {
        tag: "datatype",
        name: "ConfigurationRegisterBitmap",
        xref: "cluster\xA75.2.6.4",
        children: [
          {
            tag: "field",
            name: "LocalProgramming",
            description: "The state of local programming functionality",
            xref: "cluster\xA75.2.6.4.1",
      ...
      {
        tag: "datatype",
        name: "LocalProgrammingFeaturesBitmap",
        xref: "cluster\xA75.2.6.5",
        children: [
          {
            tag: "field",
            name: "AddUsersCredentialsSchedules",
            description: "The state of the ability to add users, credentials or schedules on the device",
            xref: "cluster\xA75.2.6.5.1",
      ...
      {
        tag: "datatype",
        name: "AlarmMaskBitmap",
        xref: "cluster\xA75.2.6.6",
        children: [
      ...
      {
        tag: "datatype",
        name: "SoundVolumeEnum",
        xref: "cluster\xA75.2.6.22",
        children: [
...
//# sourceMappingURL=door-lock-cluster.resource.js.map
