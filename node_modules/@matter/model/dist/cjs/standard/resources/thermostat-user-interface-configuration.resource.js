...
import_Resource.Resource.add({
  ...
  children: [
    ...
    {
      tag: "datatype",
      name: "TemperatureDisplayModeEnum",
      xref: "cluster\xA74.5.5.1",
      children: [
        { tag: "field", name: "Celsius", description: "Temperature displayed in \xB0C" },
        { tag: "field", name: "Fahrenheit", description: "Temperature displayed in \xB0F" }
      ]
    },
    {
      tag: "datatype",
      name: "KeypadLockoutEnum",
      xref: "cluster\xA74.5.5.2",
    ...
    {
      tag: "datatype",
      name: "ScheduleProgrammingVisibilityEnum",
      xref: "cluster\xA74.5.5.3",
      children: [
        {
          tag: "field",
...
//# sourceMappingURL=thermostat-user-interface-configuration.resource.js.map
