...
import_Resource.Resource.add({
  ...
  xref: "core\xA77.19.2",
  children: [
    { tag: "field", name: "Success", description: "Operation was successful.", xref: "core\xA78.10.1" },
    { tag: "field", name: "Failure", description: "Operation was not successful.", xref: "core\xA78.10.1" },
    {
      tag: "field",
