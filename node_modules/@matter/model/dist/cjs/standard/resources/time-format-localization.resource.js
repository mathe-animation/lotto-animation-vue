...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      tag: "attribute",
      name: "HourFormat",
      xref: "core\xA711.4.6.1",
      details: "Indicates the format that the Node is currently configured to use when conveying the hour unit of time.\nIf not UseActiveLocale, this value shall take priority over any unit implied through the ActiveLocale attribute. If UseActiveLocale, any unit implied through the ActiveLocale attribute is used as the hour format, and if ActiveLocale is not present, the hour format is unknown."
    },
    {
      tag: "attribute",
      name: "ActiveCalendarType",
      xref: "core\xA711.4.6.2",
      details: "Indicates the calendar format that the Node is currently configured to use when conveying dates.\nIf not UseActiveLocale, this value shall take priority over any unit implied through the ActiveLocale attribute. If UseActiveLocale, any unit implied through the ActiveLocale attribute is used as the calendar type, and if ActiveLocale is not present, the calendar type is unknown."
    },
    {
      tag: "attribute",
      name: "SupportedCalendarTypes",
      xref: "core\xA711.4.6.3",
      details: "Indicates a list of CalendarTypeEnum values that are supported by the Node. The list shall NOT contain any duplicate entries. The ordering of items within the list SHOULD NOT express any meaning. The maximum length of the SupportedCalendarTypes list shall be equivalent to the number of enumerations within CalendarTypeEnum."
    },
    {
      tag: "datatype",
      name: "HourFormatEnum",
      xref: "core\xA711.4.5.1",
      children: [
...
//# sourceMappingURL=time-format-localization.resource.js.map
