...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      xref: "core\xA711.10.6.2",
      details: "This attribute shall describe critical parameters needed at the beginning of commissioning flow. See Section 11.10.5.3, \u201CBasicCommissioningInfo Type\u201D for more information."
    },
    {
      tag: "attribute",
      name: "RegulatoryConfig",
      xref: "core\xA711.10.6.3",
...
If the fail-safe timer expires before the CommissioningComplete command is successfully invoked, the following sequence of clean-up steps shall be executed, in order, by the receiver:
  ...
  3. If an AddNOC or UpdateNOC command has been successfully invoked, terminate all CASE sessions associated with the Fabric whose Fabric Index is recorded in the Fail-Safe context (see Section 11.10.7.2, \u201CArmFailSafe Command\u201D) by clearing any associated Secure Session Context at the Server.
  ...
  7. If the CSRRequest command had been successfully invoked, but no AddNOC or UpdateNOC command had been successfully invoked, then the new operational key pair temporarily generated for the purposes of NOC addition or update (see Section 6.4.6.1, \u201CNode Operational Certificate Signing Request (NOCSR) Procedure\u201D) shall be removed as it is no longer needed.
...
//# sourceMappingURL=general-commissioning.resource.js.map
