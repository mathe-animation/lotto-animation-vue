...
import_Resource.Resource.add({
  ...
  children: [
    { tag: "requirement", name: "OnOff", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "WakeOnLan", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "Channel", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "TargetNavigator", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "MediaPlayback", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "MediaInput", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "LowPower", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "KeypadInput", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "ContentLauncher", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "AudioOutput", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "ApplicationLauncher", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "AccountLogin", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "ContentControl", xref: "device\xA710.3.4" },
    { tag: "requirement", name: "Messages", xref: "device\xA710.3.4" },
    {
      tag: "field",
      name: "conditions",
      children: [
...
//# sourceMappingURL=casting-video-player.resource.js.map
