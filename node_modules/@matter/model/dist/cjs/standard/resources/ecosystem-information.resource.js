  ...
  children: [
    {
      ...
      xref: "core\xA79.17.5.1",
      details: "This attribute shall contain the list of logical devices represented by a Bridged Node. Most of the time this will contain a single entry, but may grow with more complex device compositions (e.g. another bridge.) An empty list indicates that the information is not available."
    },
    {
      tag: "attribute",
      name: "LocationDirectory",
      xref: "core\xA79.17.5.2",
      details: "This attribute shall contain the list of rooms, areas and groups associated with the DeviceDirectory entries, and shall NOT contain locations which are dynamically generated and removed by an ecosystem. (E.g. a location that is generated and removed based on the user being home is not permitted. However, an initially generated location name that does not quickly change is acceptable.) An empty list indicates that the information is not available.\nLocationDirectory entries shall be removed if there is no DeviceDirectory that references it."
    },
    {
      tag: "datatype",
      name: "DeviceTypeStruct",
      xref: "core\xA79.17.4.1",
    ...
    {
      tag: "datatype",
      name: "EcosystemDeviceStruct",
      xref: "core\xA79.17.4.2",
      children: [
        {
          tag: "field",
          name: "DeviceName",
          xref: "core\xA79.17.4.2.1",
...
//# sourceMappingURL=ecosystem-information.resource.js.map
