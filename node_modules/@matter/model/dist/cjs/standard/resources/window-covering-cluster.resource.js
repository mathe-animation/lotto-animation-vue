    ...
    children: [
      {
        tag: "attribute",
        name: "FeatureMap",
        xref: "cluster\xA75.3.4",
        children: [
          {
            tag: "field",
            name: "LF",
            xref: "cluster\xA75.3.4.1",
      ...
      },
      {
        ...
        xref: "cluster\xA75.3.6.10",
        details: "Indicates the actual position as a percentage with a minimal step of 0.01%. E.g Max 10000 equals 100.00%."
      },
      {
        tag: "attribute",
        name: "InstalledOpenLimitLift",
        xref: "cluster\xA75.3.6.17",
      ...
      { tag: "attribute", name: "VelocityLift", xref: "cluster\xA75.3.6" },
      { tag: "attribute", name: "AccelerationTimeLift", xref: "cluster\xA75.3.6" },
      { tag: "attribute", name: "DecelerationTimeLift", xref: "cluster\xA75.3.6" },
      {
        tag: "attribute",
        name: "Mode",
        xref: "cluster\xA75.3.6.21",
      ...
      { tag: "attribute", name: "IntermediateSetpointsLift", xref: "cluster\xA75.3.6" },
      { tag: "attribute", name: "IntermediateSetpointsTilt", xref: "cluster\xA75.3.6" },
      {
        tag: "attribute",
        name: "SafetyStatus",
        xref: "cluster\xA75.3.6.22",
      ...
      },
      {
        tag: "command",
        name: "GoToLiftValue",
        xref: "cluster\xA75.3.7.4",
        details: "This command is used to set the target lift position of the window covering to the value specified in the command.",
        children: [{
          tag: "field",
          name: "LiftValue",
          xref: "cluster\xA75.3.7.4.1",
      ...
      {
        tag: "datatype",
        name: "SafetyStatusBitmap",
        xref: "cluster\xA75.3.5.4",
        children: [
          {
            tag: "field",
            name: "RemoteLockout",
...
//# sourceMappingURL=window-covering-cluster.resource.js.map
