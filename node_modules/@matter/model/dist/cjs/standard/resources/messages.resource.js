...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      xref: "cluster\xA71.16.8.3",
      details: "This event shall be generated when the message is confirmed by the user, or when the Duration field of the message has elapsed without confirmation.",
      children: [
        {
          tag: "field",
          name: "MessageId",
          xref: "cluster\xA71.16.8.3.1",
          details: "This field shall indicate the MessageID for the message being confirmed."
        },
        {
          tag: "field",
          name: "ResponseId",
          xref: "cluster\xA71.16.8.3.2",
          details: "This field shall indicate the MessageResponseID selected by the user. If there was no response before the Duration field of the message has elapsed, this field shall be null."
        },
        {
          tag: "field",
          name: "Reply",
          xref: "cluster\xA71.16.8.3.3",
    ...
    },
    {
      ...
      xref: "cluster\xA71.16.7.2",
      children: [{
        tag: "field",
        name: "MessageIDs",
        xref: "cluster\xA71.16.7.2.1",
...
//# sourceMappingURL=messages.resource.js.map
