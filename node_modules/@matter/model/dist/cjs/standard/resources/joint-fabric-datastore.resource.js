  ...
  children: [
    {
      tag: "attribute",
      name: "AnchorRootCa",
      xref: "core\xA711.24.6.1",
      details: "This shall indicate the Anchor Root CA used to sign all NOC Issuers in the Joint Fabric for the accessing fabric. A null value indicates that the Joint Fabric is not yet formed."
    },
    {
      tag: "attribute",
      name: "AnchorNodeId",
      xref: "core\xA711.24.6.2",
      details: "This shall indicate the Node identifier of the Joint Fabric Anchor Root CA for the accessing fabric."
    },
    {
      tag: "attribute",
      name: "AnchorVendorId",
      xref: "core\xA711.24.6.3",
      details: "This shall indicate the Vendor identifier of the Joint Fabric Anchor Root CA for the accessing fabric."
    },
    {
      tag: "attribute",
      name: "FriendlyName",
    ...
    },
    {
      ...
      xref: "core\xA711.24.6.5",
      details: "This shall indicate the list of DatastoreGroupKeySetStruct used in the Joint Fabric for the accessing fabric.\nThis attribute shall contain at least one entry, the IPK, which has GroupKeySetID of 0."
    },
    {
      tag: "attribute",
      name: "GroupList",
    ...
    {
      tag: "datatype",
      name: "DatastoreStateEnum",
      xref: "core\xA711.24.5.1",
      children: [
    ...
    {
      tag: "datatype",
      name: "DatastoreStatusEntryStruct",
      xref: "core\xA711.24.5.2",
      children: [
        {
          tag: "field",
          name: "State",
          xref: "core\xA711.24.5.2.1",
          details: "This field shall contain the current state of the target device operation."
        },
        {
          tag: "field",
          name: "UpdateTimestamp",
          xref: "core\xA711.24.5.2.2",
    ...
    {
      tag: "datatype",
      name: "DatastoreNodeKeySetEntryStruct",
      xref: "core\xA711.24.5.3",
      children: [
        {
          tag: "field",
          name: "NodeId",
          xref: "core\xA711.24.5.3.1",
          details: "The unique identifier for the node."
        },
        {
          tag: "field",
          name: "StatusEntry",
          xref: "core\xA711.24.5.3.3",
    ...
    {
      tag: "datatype",
      name: "DatastoreAccessControlEntryPrivilegeEnum",
      xref: "core\xA711.24.5.4",
      children: [
    ...
    {
      tag: "datatype",
      name: "DatastoreGroupInformationEntryStruct",
      xref: "core\xA711.24.5.5",
      children: [
        {
          tag: "field",
          name: "GroupId",
          xref: "core\xA711.24.5.5.1",
          details: "The unique identifier for the group."
        },
        {
          tag: "field",
          name: "FriendlyName",
          xref: "core\xA711.24.5.5.2",
          details: "The friendly name for the group."
        },
        {
          tag: "field",
          name: "GroupKeySetId",
          xref: "core\xA711.24.5.5.3",
    ...
    {
      tag: "datatype",
      name: "DatastoreBindingTargetStruct",
      xref: "core\xA711.24.5.6",
      details: "The DatastoreBindingTargetStruct represents a Binding on a specific Node (identified by the DatastoreEndpointBindingEntryStruct) which is managed by the Datastore. Only bindings on a specific Node that are fabric-scoped to the Joint Fabric are managed by the Datastore. As a result, references to nodes and groups are specific to the Joint Fabric.",
      children: [
        {
          tag: "field",
          name: "Node",
          xref: "core\xA711.24.5.6.1",
          details: "This field is the binding\u2019s remote target node ID. If the Endpoint field is present, this field shall be present."
        },
        {
          tag: "field",
          name: "Group",
          xref: "core\xA711.24.5.6.2",
          details: "This field is the binding\u2019s target group ID that represents remote endpoints. If the Endpoint field is present, this field shall NOT be present."
        },
        {
          tag: "field",
          name: "Endpoint",
          xref: "core\xA711.24.5.6.3",
          details: "This field is the binding\u2019s remote endpoint that the local endpoint is bound to. If the Group field is present, this field shall NOT be present."
        },
        {
          tag: "field",
          name: "Cluster",
          xref: "core\xA711.24.5.6.4",
          details: "This field is the binding\u2019s cluster ID (client & server) on the local and target endpoint(s). If this field is present, the client cluster shall also exist on this endpoint (with this Binding cluster). If this field is present, the target shall be this cluster on the target endpoint(s)."
        }
      ]
    },
    {
      tag: "datatype",
      name: "DatastoreEndpointBindingEntryStruct",
      xref: "core\xA711.24.5.7",
      children: [
        {
          tag: "field",
          name: "NodeId",
          xref: "core\xA711.24.5.7.1",
          details: "The unique identifier for the node."
        },
        {
          tag: "field",
          name: "EndpointId",
          xref: "core\xA711.24.5.7.2",
          details: "The unique identifier for the endpoint."
        },
        {
          tag: "field",
          name: "ListId",
          xref: "core\xA711.24.5.7.3",
          details: "The unique identifier for the entry in the Datastore\u2019s EndpointBindingList attribute, which is a list of DatastoreEndpointBindingEntryStruct.\nThis field is used to uniquely identify an entry in the EndpointBindingList attribute for the purpose of deletion (RemoveBindingFromEndpointForNode Command)."
        },
        { tag: "field", name: "Binding", xref: "core\xA711.24.5.7.4", details: "The binding target structure." },
        {
          tag: "field",
          name: "StatusEntry",
          xref: "core\xA711.24.5.7.5",
          details: "Indicates whether entry in this list is pending, committed, delete-pending, or commit-failed."
        }
      ]
    },
    {
      tag: "datatype",
      name: "DatastoreEndpointGroupIDEntryStruct",
      xref: "core\xA711.24.5.8",
      children: [
        {
          tag: "field",
          name: "NodeId",
          xref: "core\xA711.24.5.8.1",
          details: "The unique identifier for the node."
        },
        {
          tag: "field",
          name: "EndpointId",
          xref: "core\xA711.24.5.8.2",
          details: "The unique identifier for the endpoint."
        },
        {
          tag: "field",
          name: "GroupId",
          xref: "core\xA711.24.5.8.3",
          details: "The unique identifier for the group."
        },
        {
          tag: "field",
          name: "StatusEntry",
          xref: "core\xA711.24.5.8.4",
          details: "Indicates whether entry in this list is pending, committed, delete-pending, or commit-failed."
        }
      ]
    },
    {
      tag: "datatype",
      name: "DatastoreEndpointEntryStruct",
      xref: "core\xA711.24.5.9",
      details: "The DatastoreEndpointEntryStruct represents an Endpoint on a specific Node which is managed by the Datastore. Only Nodes on the Joint Fabric are managed by the Datastore. As a result, references to NodeID are specific to the Joint Fabric.",
      children: [
        {
          tag: "field",
          name: "EndpointId",
          xref: "core\xA711.24.5.9.1",
          details: "The unique identifier for the endpoint."
        },
        {
          tag: "field",
          name: "NodeId",
          xref: "core\xA711.24.5.9.2",
          details: "The unique identifier for the node."
        },
        {
          tag: "field",
    ...
    {
      tag: "datatype",
      name: "DatastoreAccessControlEntryAuthModeEnum",
      xref: "core\xA711.24.5.10",
      children: [
    ...
    { tag: "datatype", name: "DatastoreAccessControlTargetStruct", xref: "core\xA711.24.5.11" },
    {
      tag: "datatype",
      name: "DatastoreAccessControlEntryStruct",
      xref: "core\xA711.24.5.12",
      details: "The DatastoreAccessControlEntryStruct represents an ACL on a specific Node (identified by the DatastoreACLEntryStruct) which is managed by the Datastore. Only ACLs on a specific Node that are fabric-scoped to the Joint Fabric are managed by the Datastore. As a result, references to nodes and groups are specific to the Joint Fabric."
    },
    {
      tag: "datatype",
      name: "DatastoreACLEntryStruct",
      xref: "core\xA711.24.5.13",
      details: "The DatastoreACLEntryStruct is a holder for an ACL (DatastoreAccessControlEntryStruct) on a specific Node which is managed by the Datastore. Only ACLs on a specific Node that are fabric-scoped to the Joint Fabric are managed by the Datastore. As a result, references to nodes and groups are specific to the Joint Fabric.",
      children: [
        {
          tag: "field",
          name: "NodeId",
          xref: "core\xA711.24.5.13.1",
          details: "The unique identifier for the node."
        },
        {
          tag: "field",
          name: "ListId",
          xref: "core\xA711.24.5.13.2",
          details: "The unique identifier for the ACL entry in the Datastore\u2019s list of DatastoreACLEntry."
        },
        {
          tag: "field",
          name: "AclEntry",
          xref: "core\xA711.24.5.13.3",
          details: "The Access Control Entry structure."
        },
        {
          tag: "field",
          name: "StatusEntry",
          xref: "core\xA711.24.5.13.4",
          details: "Indicates whether entry in this list is pending, committed, delete-pending, or commit-failed."
        }
      ]
    },
    {
      tag: "datatype",
      name: "DatastoreNodeInformationEntryStruct",
      xref: "core\xA711.24.5.14",
      children: [
        {
          tag: "field",
          name: "NodeId",
          xref: "core\xA711.24.5.14.1",
          details: "The unique identifier for the node."
        },
        {
          tag: "field",
        ...
        },
        {
          ...
          xref: "core\xA711.24.5.14.3",
          details: "Set to Pending prior to completing commissioning, set to Committed after commissioning complete is successful, or set to CommitFailed if commissioning failed with the FailureCode Field set to the error."
        }
      ]
    },
    {
      tag: "datatype",
      name: "DatastoreAdministratorInformationEntryStruct",
      xref: "core\xA711.24.5.15",
      children: [
        {
          tag: "field",
          name: "NodeId",
          xref: "core\xA711.24.5.15.1",
          details: "The unique identifier for the node."
        },
        {
          tag: "field",
          name: "FriendlyName",
          xref: "core\xA711.24.5.15.2",
          details: "Friendly name for this node which is not propagated to nodes."
        },
        { tag: "field", name: "VendorId", xref: "core\xA711.24.5.15.3", details: "The Vendor ID for the node." },
        { tag: "field", name: "Icac", xref: "core\xA711.24.5.15.4", details: "The ICAC used to issue the NOC." }
      ]
    },
    {
      tag: "datatype",
      name: "DatastoreGroupKeySecurityPolicyEnum",
      xref: "core\xA711.24.5.16",
      children: [
    ...
    {
      tag: "datatype",
      name: "DatastoreGroupKeyMulticastPolicyEnum",
      xref: "core\xA711.24.5.17",
      children: [
        {
          tag: "field",
          name: "PerGroupId",
    ...
    { tag: "datatype", name: "DatastoreGroupKeySetStruct", xref: "core\xA711.24.5.18" }
  ]
});
//# sourceMappingURL=joint-fabric-datastore.resource.js.map
