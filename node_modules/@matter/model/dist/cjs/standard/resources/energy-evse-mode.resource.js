...
import_Resource.Resource.add({
  ...
  children: [
    ...
    { tag: "attribute", name: "CurrentMode", xref: "cluster\xA79.4.6" },
    { tag: "attribute", name: "StartUpMode", xref: "cluster\xA79.4.6" },
    { tag: "attribute", name: "OnMode", xref: "cluster\xA79.4.6" },
    {
      tag: "datatype",
      name: "ModeOptionStruct",
      xref: "cluster\xA79.4.5.1",
    ...
    },
    {
      ...
      name: "ModeTag",
      children: [
        { tag: "field", name: "Auto", xref: "cluster\xA79.4.7.1" },
        { tag: "field", name: "Quick", xref: "cluster\xA79.4.7.1" },
        { tag: "field", name: "Quiet", xref: "cluster\xA79.4.7.1" },
        { tag: "field", name: "LowNoise", xref: "cluster\xA79.4.7.1" },
        { tag: "field", name: "LowEnergy", xref: "cluster\xA79.4.7.1" },
        { tag: "field", name: "Vacation", xref: "cluster\xA79.4.7.1" },
        { tag: "field", name: "Min", xref: "cluster\xA79.4.7.1" },
        { tag: "field", name: "Max", xref: "cluster\xA79.4.7.1" },
        { tag: "field", name: "Night", xref: "cluster\xA79.4.7.1" },
        { tag: "field", name: "Day", xref: "cluster\xA79.4.7.1" },
        {
          tag: "field",
          name: "Manual",
          xref: "cluster\xA79.4.7.1.1",
        ...
        },
        {
          tag: "field",
          name: "SolarCharging",
          xref: "cluster\xA79.4.7.1.3",
          details: "While in modes with this tag, and once enabled with the EnableCharging, the EVSE will attempt to automatically start charging based on available excess solar PV generation, limiting the charging power to avoid importing energy from the grid."
        },
        {
          tag: "field",
          name: "V2X",
          xref: "cluster\xA79.4.7.1.4",
...
//# sourceMappingURL=energy-evse-mode.resource.js.map
