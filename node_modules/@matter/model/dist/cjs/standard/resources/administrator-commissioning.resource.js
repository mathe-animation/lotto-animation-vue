...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      xref: "core\xA711.19.7.2",
      details: "When the WindowStatus attribute is not set to WindowNotOpen, this attribute shall indicate the FabricIndex associated with the Fabric scoping of the Administrator that opened the window. This may be used to cross-reference in the Fabrics attribute of the Operational Credentials cluster.\nIf, during an open commissioning window, the fabric for the Administrator that opened the window is removed, then this attribute shall be set to null.\nWhen the WindowStatus attribute is set to WindowNotOpen, this attribute shall be set to null."
    },
    {
      tag: "attribute",
      name: "AdminVendorId",
      xref: "core\xA711.19.7.3",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          tag: "field",
          name: "Discriminator",
          xref: "core\xA711.19.8.1.3",
          details: "This field shall be used by the Node as the long discriminator for DNS-SD advertisement (see Section 4.3.1.5, \u201CTXT key for discriminator (D)\u201D) for discovery by the new Administrator. The new Administrator can find and filter DNS-SD records by long discriminator to locate and initiate commissioning with the appropriate Node."
        },
        {
          tag: "field",
          name: "Iterations",
          xref: "core\xA711.19.8.1.4",
...
//# sourceMappingURL=administrator-commissioning.resource.js.map
