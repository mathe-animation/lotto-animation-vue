...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      xref: "core\xA711.5.6.1",
      details: "Indicates the unit for the Node to use only when conveying temperature in communication to the user, for example such as via a user interface on the device. If provided, this value shall take priority over any unit implied through the ActiveLocale Attribute.\nAn attempt to write to this attribute with a value not included in the SupportedTemperatureUnits attribute list shall result in a CONSTRAINT_ERROR."
    },
    {
      tag: "attribute",
      name: "SupportedTemperatureUnits",
      xref: "core\xA711.5.6.2",
      details: "Indicates a list of units supported by the Node to be used when writing the TemperatureUnit attribute of this cluster. Each entry in the list shall be unique."
    },
    {
      tag: "datatype",
      name: "TempUnitEnum",
      xref: "core\xA711.5.5.1",
      children: [
...
//# sourceMappingURL=unit-localization.resource.js.map
