  ...
  children: [
    {
      tag: "attribute",
      name: "FeatureMap",
      xref: "core\xA711.12.4",
      children: [{
        tag: "field",
        name: "DMTEST",
        xref: "core\xA711.12.4.1",
    ...
    { tag: "attribute", name: "DoNotUse", xref: "core\xA711.12.6" },
    {
      tag: "event",
      name: "HardwareFaultChange",
      xref: "core\xA711.12.8.1",
      ...
      children: [
        {
          tag: "field",
          name: "SystemTimeMs",
          xref: "core\xA711.12.7.3.1",
          details: "This shall indicate the current System Time in milliseconds (type systime-ms), with the value taken at the time of processing of the TimeSnapshot command that generated this response.\nThe value shall be taken from the same clock which populates the Timestamp field in events when using System Time for the field."
        },
        {
          tag: "field",
          name: "PosixTimeMs",
          xref: "core\xA711.12.7.3.2",
...
//# sourceMappingURL=general-diagnostics.resource.js.map
