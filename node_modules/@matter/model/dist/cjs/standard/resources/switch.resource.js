  ...
  children: [
    {
      ...
      children: [
        ...
        },
        {
          tag: "field",
          name: "AS",
          xref: "cluster\xA71.13.4.6",
          details: "This feature flag indicates simplified handling of events for multi-press-capable switches. See Section 1.13.8, \u201CSequence of events for MultiPress\u201D."
        }
      ]
    },
    {
      ...
      xref: "cluster\xA71.13.5.1",
      details: "Indicates the maximum number of positions the switch has. Any kind of switch has a minimum of 2 positions. Also see Section 1.13.10, \u201CMulti Position Details\u201D for the case NumberOfPositions>2."
    },
    {
      tag: "attribute",
      name: "CurrentPosition",
      xref: "cluster\xA71.13.5.2",
      ...
      children: [
        {
          tag: "field",
          name: "NewPosition",
          xref: "cluster\xA71.13.6.6.1",
          details: "This field shall indicate the new value of the CurrentPosition attribute, i.e. while pressed."
        },
        {
          tag: "field",
          name: "CurrentNumberOfPressesCounted",
          xref: "cluster\xA71.13.6.6.2",
