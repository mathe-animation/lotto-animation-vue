...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      tag: "attribute",
      name: "HarmonicPhases",
      xref: "cluster\xA72.13.6.17",
      details: "This shall indicate a list of HarmonicMeasurementStruct values, with each HarmonicMeasurementStruct representing the most recent phase of the harmonic current reading for the harmonic order specified by Order.\nThe reporting interval of this attribute shall be manufacturer dependent. The server may choose to omit publication of deltas considered not meaningful.\nThe server shall NOT mark this attribute ready for report if the last time this was done was more recently than 1 second ago.\nThe server may delay marking this attribute ready for report for longer periods if needed, however the server shall NOT delay marking this attribute as ready for report for longer than 60 seconds."
    },
    {
      tag: "attribute",
      name: "PowerFactor",
      xref: "cluster\xA72.13.6.18",
      details: "This shall indicate the Power Factor ratio in +/- 1/100ths of a percent.\nThe reporting interval of this attribute shall be manufacturer dependent. The server may choose to omit publication of deltas considered not meaningful.\nThe server shall NOT mark this attribute ready for report if the last time this was done was more recently than 1 second ago.\nThe server may delay marking this attribute ready for report for longer periods if needed, however the server shall NOT delay marking this attribute as ready for report for longer than 60 seconds."
    },
    {
      tag: "attribute",
      name: "NeutralCurrent",
      xref: "cluster\xA72.13.6.19",
    ...
    },
    {
      ...
      xref: "cluster\xA72.13.5.4",
      children: [
        {
          tag: "field",
          name: "Order",
          xref: "cluster\xA72.13.5.4.1",
...
//# sourceMappingURL=electrical-power-measurement.resource.js.map
