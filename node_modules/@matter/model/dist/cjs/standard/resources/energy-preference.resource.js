  ...
  children: [
    {
      tag: "attribute",
      name: "FeatureMap",
      xref: "cluster\xA79.7.4",
      children: [
        {
          tag: "field",
          name: "BALA",
          xref: "cluster\xA79.7.4.1",
          details: "This feature allows a user to select from a list of energy balances with associated descriptions of which strategies a device will use to target the specified balance."
        },
        {
          tag: "field",
          name: "LPMS",
          xref: "cluster\xA79.7.4.2",
          details: "This feature allows the user to select a condition or set of conditions which will cause the device to switch to a mode using less power. For example, a device might provide a scale of durations that must elapse without user interaction before it goes to sleep."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          xref: "cluster\xA79.7.5.1.2",
          details: "This value shall emphasize how quickly a device accomplishes its targeted use; e.g. how quickly a robot vacuum completes a cleaning cycle."
        },
        {
          tag: "field",
          name: "Efficiency",
          description: "Amount of Energy consumed by the device",
          xref: "cluster\xA79.7.5.1.3",
    ...
    },
    {
      tag: "datatype",
      name: "BalanceStruct",
      xref: "cluster\xA79.7.5.2",
      details: "This represents a step along a scale of preferences.",
      children: [
        {
          tag: "field",
          name: "Step",
          xref: "cluster\xA79.7.5.2.1",
          details: "This field shall indicate the relative value of this step."
        },
        {
          tag: "field",
          name: "Label",
          xref: "cluster\xA79.7.5.2.2",
          details: "This field shall indicate an optional string explaining which actions a device might take at the given step value."
        }
      ]
    }
  ]
});
//# sourceMappingURL=energy-preference.resource.js.map
