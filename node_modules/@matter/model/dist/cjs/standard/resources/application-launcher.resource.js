...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      tag: "attribute",
      name: "CatalogList",
      xref: "cluster\xA76.4.6.1",
      details: "This attribute shall specify the list of supported application catalogs, where each entry in the list is the Connectivity Standards Alliance-issued vendor ID for the catalog. The DIAL registry (see [DIAL Registry]) shall use value 0x0000.\nIt is expected that Content App Platform providers will have their own catalog vendor ID (set to their own Vendor ID) and will assign an ApplicationID to each Content App."
    },
    {
      tag: "attribute",
      name: "CurrentApp",
      xref: "cluster\xA76.4.6.2",
    ...
    },
    {
      ...
      xref: "cluster\xA76.4.5.3",
      details: "This specifies an app along with its corresponding endpoint."
    }
  ]
});
//# sourceMappingURL=application-launcher.resource.js.map
