...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      xref: "core\xA711.1.5.10",
      details: "This attribute shall contain the current version number for the software running on this Node. A larger value of SoftwareVersion is newer than a lower value, from the perspective of software updates (see Section 11.20.3.3, \u201CAvailability of Software Images\u201D). Nodes may query this field to determine the currently running version of software on another given Node."
    },
    {
      tag: "attribute",
      name: "SoftwareVersionString",
      xref: "core\xA711.1.5.11",
    ...
    },
    {
      ...
      xref: "core\xA711.1.5.24",
      details: "This attribute shall contain the current version number for the configuration of the Node. A larger value of ConfigurationVersion shall indicate a newer configuration than a lower value."
    },
    {
      tag: "event",
      name: "StartUp",
      xref: "core\xA711.1.6.1",
    ...
    },
    {
      ...
      xref: "core\xA711.1.6.4",
      details: "This event (when supported) shall be generated when there is a change in the Reachable attribute. Its main use case is in the derived Bridged Device Basic Information cluster.",
      children: [{
        tag: "field",
        name: "ReachableNewValue",
        xref: "core\xA711.1.6.4.1",
...
//# sourceMappingURL=basic-information.resource.js.map
