  ...
  children: [
    {
      tag: "attribute",
      name: "FeatureMap",
      xref: "cluster\xA76.10.4",
      children: [
        {
          tag: "field",
          name: "AS",
          xref: "cluster\xA76.10.4.1",
          details: 'This feature provides access to the time offset location within current playback media and allows for jumping to a specific location using time offsets. This enables clients to implement more advanced media seeking behavior in their user interface, for instance a "seek bar".'
        },
        {
          tag: "field",
          name: "VS",
          xref: "cluster\xA76.10.4.2",
          details: "This feature is for a device which supports variable speed playback on media that supports it."
        },
        {
          tag: "field",
          name: "TT",
          xref: "cluster\xA76.10.4.3",
          details: "This feature is for a device or app that supports Text Tracks."
        },
        {
          tag: "field",
          name: "AT",
          xref: "cluster\xA76.10.4.4",
          details: "This feature is for a device or app that supports Audio Tracks."
        },
        {
          tag: "field",
          name: "AA",
          xref: "cluster\xA76.10.4.5",
          details: "This feature is for a device or app that supports playing audio during fast and slow advance and rewind (e.g., while playback speed is not 1). A device that supports this feature may only support playing audio during certain speeds.\nA cluster implementing AA shall implement AS."
        }
      ]
    },
    {
    ...
    },
    {
      tag: "attribute",
      name: "StartTime",
      xref: "cluster\xA76.10.6.2",
      details: "Indicates the start time of the media, in case the media has a fixed start time (for example, live stream or television broadcast), or null when start time does not apply to the current media (for example, video-on-demand). This time is a UTC time. The client needs to handle conversion to local time, as required, taking in account time zone and possible local DST offset."
    },
    {
      tag: "attribute",
      name: "Duration",
      xref: "cluster\xA76.10.6.3",
      details: "Indicates the duration, in milliseconds, of the current media being played back or null when duration is not applicable (for example, in live streaming content with no known duration). This attribute shall never be 0."
    },
    {
      tag: "attribute",
      name: "SampledPosition",
      xref: "cluster\xA76.10.6.4",
      details: "Indicates the position of playback (Position field) at the time (UpdateAt field) specified in the attribute. The client may use the SampledPosition attribute to compute the current position within the media stream based on the PlaybackSpeed, PlaybackPositionStruct.UpdatedAt and PlaybackPositionStruct.Position fields. To enable this, the SampledPosition attribute shall be updated whenever a change in either the playback speed or the playback position is triggered outside the normal playback of the media. The events which may cause this to happen include:\n  - Starting or resumption of playback\n  - Seeking\n  - Skipping forward or backward\n  - Fast-forwarding or rewinding\n  - Updating of playback speed as a result of explicit request, or as a result of buffering events"
    },
    {
      tag: "attribute",
      name: "PlaybackSpeed",
      xref: "cluster\xA76.10.6.5",
      details: "Indicates the speed at which the current media is being played. The new PlaybackSpeed shall be reflected in this attribute whenever any of the following occurs:\n  - Starting of playback\n  - Resuming of playback\n  - Fast-forwarding\n  - Rewinding\nThe PlaybackSpeed shall reflect the ratio of time elapsed in the media to the actual time taken for the playback assuming no changes to media playback (for example buffering events or requests to pause/rewind/forward).\n  - A value for PlaybackSpeed of 1 shall indicate normal playback where, for example, playback for 1 second causes the media to advance by 1 second within the duration of the media.\n  - A value for PlaybackSpeed which is greater than 0 shall indicate that as playback is happening the media is currently advancing in time within the duration of the media.\n  - A value for PlaybackSpeed which is less than 0 shall indicate that as playback is happening the media is currently going back in time within the duration of the media.\n  - A value for PlaybackSpeed of 0 shall indicate that the media is currently not playing back. When the CurrentState attribute has the value of PAUSED, NOT_PLAYING or BUFFERING, the PlaybackSpeed shall be set to 0 to reflect that the media is not playing.\nFollowing examples illustrate the PlaybackSpeed attribute values in various conditions."
    },
    {
      tag: "attribute",
      name: "SeekRangeEnd",
      xref: "cluster\xA76.10.6.7",
      details: "Indicates the furthest forward valid position to which a client may seek forward, in milliseconds from the start of the media. When the media has an associated StartTime, a value of null shall indicate that a seek forward is valid only until the current time within the media, using a position computed from the difference between the current time offset and StartTime, in milliseconds from start of the media, truncating fractional milliseconds towards 0. A value of NULL when StartTime is not specified shall indicate that seeking forward is not allowed."
    },
    {
      tag: "attribute",
      name: "SeekRangeStart",
      xref: "cluster\xA76.10.6.6",
      details: "Indicates the earliest valid position to which a client may seek back, in milliseconds from start of the media. A value of NULL shall indicate that seeking backwards is not allowed."
    },
    {
      tag: "attribute",
      name: "ActiveAudioTrack",
      xref: "cluster\xA76.10.6.8",
      details: "ActiveTrack refers to the Audio track currently set and being used for the streaming media. A value of null shall indicate that no Audio Track corresponding to the current media is currently being played."
    },
    {
      tag: "attribute",
      name: "AvailableAudioTracks",
      xref: "cluster\xA76.10.6.9",
      details: "AvailableAudioTracks refers to the list of Audio tracks available for the current title being played. A value of null shall indicate that no Audio Tracks corresponding to the current media are selectable by the client."
    },
    {
      tag: "attribute",
      name: "ActiveTextTrack",
      xref: "cluster\xA76.10.6.10",
      details: "ActiveTrack refers to the Text track currently set and being used for the streaming media. This can be nil. A value of null shall indicate that no Text Track corresponding to the current media is currently being displayed."
    },
    {
      tag: "attribute",
      name: "AvailableTextTracks",
      xref: "cluster\xA76.10.6.11",
      details: "AvailableTextTracks refers to the list of Text tracks available for the current title being played. This can be an empty list. A value of null shall indicate that no Text Tracks corresponding to the current media are selectable by the client."
    },
    {
      tag: "event",
      name: "StateChanged",
      xref: "cluster\xA76.10.8.1",
      details: "If supported, this event shall be generated when there is a change in any of the supported attributes of the Media Playback cluster.",
      children: [
        {
          tag: "field",
          name: "CurrentState",
          xref: "cluster\xA76.10.8.1.1",
          details: "This field shall indicate the updated playback state as defined by the CurrentState attribute, and has the same constraint as that attribute."
        },
        {
          tag: "field",
          name: "StartTime",
          xref: "cluster\xA76.10.8.1.2",
          details: "This field shall indicate the updated start time as defined by the StartTime attribute, and has the same constraint as that attribute.\nThis field value shall be 0 when the value of the StartTime attribute is NULL."
        },
        {
          tag: "field",
          name: "Duration",
          xref: "cluster\xA76.10.8.1.3",
          details: "This field shall indicate the updated duration as defined by the Duration attribute, and has the same constraint as that attribute.\nThis field value shall be 0 when the value of the Duration attribute is NULL."
        },
        {
          tag: "field",
          name: "SampledPosition",
          xref: "cluster\xA76.10.8.1.4",
          details: "This field shall indicate the updated position of playback as defined by the SampledPosition attribute, and has the same constraint as that attribute.\nThe UpdatedAt field value of the PlaybackPositionStruct shall be 0, and the Position field value of the PlaybackPositionStruct shall be NULL, when the value of the SampledPosition attribute is NULL."
        },
        {
          tag: "field",
          name: "PlaybackSpeed",
          xref: "cluster\xA76.10.8.1.5",
          details: "This field shall indicate the updated speed at which the current media is being played as defined by the PlaybackSpeed attribute, and has the same constraint as that attribute."
        },
        {
          tag: "field",
          name: "SeekRangeEnd",
          xref: "cluster\xA76.10.8.1.7",
          details: "This field shall indicate the updated start of the seek range end as defined by the SeekRangeEnd attribute, and has the same constraint as that attribute.\nThis field value shall be 0 when the value of the SeekRangeEnd attribute is NULL."
        },
        {
          tag: "field",
          name: "SeekRangeStart",
          xref: "cluster\xA76.10.8.1.6",
          details: "This field shall indicate the updated start of the seek range start as defined by the SeekRangeStart attribute, and has the same constraint as that attribute.\nThis field value shall be 0 when the value of the SeekRangeStart attribute is NULL."
        },
        {
          tag: "field",
          name: "Data",
          xref: "cluster\xA76.10.8.1.8",
          details: "This field shall indicate Optional app-specific data."
        },
        {
          tag: "field",
          name: "AudioAdvanceUnmuted",
          xref: "cluster\xA76.10.8.1.9",
          details: "This field shall indicate whether audio is unmuted by the player due to a FF or REW command. This field is only meaningful when the PlaybackSpeed is present and not equal to 0 (paused) or 1 (normal playback). Typically the value will be false (muted), however, some players will play audio during certain fast forward and rewind speeds, and in these cases, the value will be true (not muted).\nA value of true does not guarantee that audio can be heard by the user since the speaker may be muted, turned down to a low level and/or unplugged."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [{
        ...
        xref: "cluster\xA76.10.7.9.1",
        details: "This field shall indicate the duration of the time span to skip forward in the media, in milliseconds. In case the resulting position falls in the middle of a frame, the server shall set the position to the beginning of that frame and set the SampledPosition attribute on the cluster accordingly. If the resultant position falls beyond the furthest valid position in the media the client may seek forward to, the position should be set to that furthest valid position. If the SampledPosition attribute is supported it shall be updated on the cluster accordingly."
      }]
    },
    {
      tag: "command",
      name: "SkipBackward",
      xref: "cluster\xA76.10.7.10",
      ...
      children: [{
        tag: "field",
        name: "DeltaPositionMilliseconds",
        xref: "cluster\xA76.10.7.10.1",
        details: "This field shall indicate the duration of the time span to skip backward in the media, in milliseconds. In case the resulting position falls in the middle of a frame, the server shall set the position to the beginning of that frame and set the SampledPosition attribute on the cluster accordingly. If the resultant position falls before the earliest valid position to which a client may seek back to, the position should be set to that earliest valid position. If the SampledPosition attribute is supported it shall be updated on the cluster accordingly."
      }]
    },
    {
      tag: "command",
      name: "PlaybackResponse",
      xref: "cluster\xA76.10.7.12",
      details: "This command is used to indicate the status of the command that was issued by the client.\nThis command shall be generated in response to various Playback Commands.",
      children: [
        {
          tag: "field",
          name: "Status",
          xref: "cluster\xA76.10.7.12.1",
          details: "This field shall indicate the status of the command which resulted in this response."
        },
        {
          tag: "field",
          name: "Data",
          xref: "cluster\xA76.10.7.12.2",
          details: "This field shall indicate Optional app-specific data."
        }
      ]
    },
    {
      ...
      children: [{
        tag: "field",
        name: "Position",
        xref: "cluster\xA76.10.7.11.1",
        details: "This field shall indicate the position (in milliseconds) in the media to seek to. In case the position falls in the middle of a frame, the server shall set the position to the beginning of that frame and set the SampledPosition attribute on the cluster accordingly. If the position falls before the earliest valid position or beyond the furthest valid position to which a client may seek back or forward to respectively, the status of SEEK_OUT_OF_RANGE shall be returned and no change shall be made to the position of the playback."
      }]
    },
    {
      tag: "command",
      name: "ActivateAudioTrack",
      xref: "cluster\xA76.10.7.13",
    ...
    },
    {
      ...
      xref: "cluster\xA76.10.5.3",
      children: [
        {
          tag: "field",
          name: "ForcedSubtitles",
        ...
        {
          tag: "field",
          name: "EnhancedAudioIntelligibility",
    ...
    },
    {
      ...
      xref: "cluster\xA76.10.5.4",
      details: "This structure defines a playback position within a media stream being played.",
      children: [
        {
          tag: "field",
          name: "UpdatedAt",
          xref: "cluster\xA76.10.5.4.1",
          details: "This field shall indicate the time when the position was last updated."
        },
        {
          tag: "field",
          name: "Position",
          xref: "cluster\xA76.10.5.4.2",
          details: "This field shall indicate the associated discrete position within the media stream, in milliseconds from the beginning of the stream, being associated with the time indicated by the UpdatedAt field. The Position shall NOT be greater than the duration of the media if duration is specified. The Position shall NOT be greater than the time difference between current time and start time of the media when start time is specified.\nA value of null shall indicate that playback position is not applicable for the current state of the media playback (For example : Live media with no known duration and where seek is not supported)."
        }
      ]
    },
    {
      tag: "datatype",
      name: "TrackStruct",
      xref: "cluster\xA76.10.5.5",
      details: "This structure defines a uniquely identifiable Text Track or Audio Track.",
      children: [
        {
          tag: "field",
          name: "Id",
          xref: "cluster\xA76.10.5.5.1",
          details: "This field shall indicate the Identifier for the Track which is unique within the Track catalog. The Track catalog contains all the Text/Audio tracks corresponding to the main media content."
        },
        {
          tag: "field",
          name: "TrackAttributes",
          xref: "cluster\xA76.10.5.5.2",
    ...
    {
      tag: "datatype",
      name: "TrackAttributesStruct",
      xref: "cluster\xA76.10.5.6",
      details: "This structure includes the attributes associated with a Text/Audio Track",
      children: [
        {
          tag: "field",
          name: "LanguageCode",
          xref: "cluster\xA76.10.5.6.1",
          details: "The value is a String containing one of the standard Tags for Identifying Languages RFC 5646, which identifies the primary language used in the Track."
        },
        {
          tag: "field",
          name: "Characteristics",
          xref: "cluster\xA76.10.5.6.2",
          details: "This is a list of enumerated CharacteristicEnum values that indicate a purpose, trait or feature associated with the Track. A value of null shall indicate that there are no Characteristics corresponding to the Track."
        },
        {
          tag: "field",
          name: "DisplayName",
          xref: "cluster\xA76.10.5.6.3",
          details: "The value is a String containing a user displayable name for the Track. A value of null shall indicate that there is no DisplayName corresponding to the Track."
        }
      ]
    }
  ]
});
//# sourceMappingURL=media-playback.resource.js.map
