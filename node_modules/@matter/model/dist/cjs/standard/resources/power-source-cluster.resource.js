...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      tag: "attribute",
      name: "Order",
      xref: "core\xA711.7.7.2",
      details: "Indicates the relative preference with which the Node will select this source to provide power. A source with a lower order shall be selected by the Node to provide power before any other source with a higher order, if the lower order source is available (see Section 11.7.7.1, \u201CStatus Attribute\u201D).\nNote, Order is read-only and therefore NOT intended to allow clients control over power source selection."
    },
    {
      tag: "attribute",
      name: "Description",
      xref: "core\xA711.7.7.3",
...
//# sourceMappingURL=power-source-cluster.resource.js.map
