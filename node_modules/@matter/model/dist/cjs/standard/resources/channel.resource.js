...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          tag: "field",
          name: "ExternalIdList",
          xref: "cluster\xA76.6.7.8.3",
          details: "This field, if present, shall indicate the list of additional external content identifiers."
        },
        {
          tag: "field",
          name: "Data",
          xref: "cluster\xA76.6.7.8.4",
          details: "This field, if present, shall indicate app-specific data."
        }
      ]
    },
    {
      tag: "datatype",
      name: "RecordingFlagBitmap",
      xref: "cluster\xA76.6.5.1",
      children: [
...
//# sourceMappingURL=channel.resource.js.map
