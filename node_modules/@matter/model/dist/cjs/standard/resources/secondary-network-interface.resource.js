...
import_Resource.Resource.add({
  ...
  children: [
    { tag: "requirement", name: "NetworkCommissioning", xref: "device\xA72.8.3" },
    { tag: "requirement", name: "EthernetNetworkDiagnostics", xref: "device\xA72.8.3" },
    { tag: "requirement", name: "WiFiNetworkDiagnostics", xref: "device\xA72.8.3" },
    { tag: "requirement", name: "ThreadNetworkDiagnostics", xref: "device\xA72.8.3" }
  ]
});
//# sourceMappingURL=secondary-network-interface.resource.js.map
