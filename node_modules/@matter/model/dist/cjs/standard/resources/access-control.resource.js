...
import_Resource.Resource.add(
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            tag: "field",
            name: "ChangeType",
            xref: "core\xA79.10.9.1.3",
            details: "The type of change as appropriate."
          },
          {
            tag: "field",
            name: "LatestValue",
            xref: "core\xA79.10.9.1.4",
        ...
        children: [
          {
            tag: "field",
            name: "AdminNodeId",
            xref: "core\xA79.10.9.2.1",
            details: "The Node ID of the Administrator that made the change, if the change occurred via a CASE session.\nExactly one of AdminNodeID and AdminPasscodeID shall be set, depending on whether the change occurred via a CASE or PASE session; the other shall be null."
          },
          {
            tag: "field",
            name: "AdminPasscodeId",
            xref: "core\xA79.10.9.2.2",
            details: "The Passcode ID of the Administrator that made the change, if the change occurred via a PASE session. Non-zero values are reserved for future use (see PasscodeId generation in PBKDFParamRequest).\nExactly one of AdminNodeID and AdminPasscodeID shall be set, depending on whether the change occurred via a CASE or PASE session; the other shall be null."
          },
          {
            tag: "field",
            name: "ChangeType",
            xref: "core\xA79.10.9.2.3",
            details: "The type of change as appropriate."
          },
          {
            tag: "field",
            name: "LatestValue",
            xref: "core\xA79.10.9.2.4",
      ...
      {
        tag: "datatype",
        name: "AccessRestrictionTypeEnum",
        xref: "core\xA79.10.5.3",
        children: [
          {
            tag: "field",
      ...
      { tag: "datatype", name: "AccessControlTargetStruct", xref: "core\xA79.10.5.5" },
      {
        tag: "datatype",
        name: "AccessControlEntryStruct",
        xref: "core\xA79.10.5.6",
        children: [
          {
            tag: "field",
            name: "Privilege",
            xref: "core\xA79.10.5.6.1",
      ...
      },
      {
        ...
        xref: "core\xA79.10.5.7",
        children: [{
          tag: "field",
          name: "Data",
          xref: "core\xA79.10.5.7.1",
...
//# sourceMappingURL=access-control.resource.js.map
