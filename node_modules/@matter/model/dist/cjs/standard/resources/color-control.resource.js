...
import_Resource.Resource.add(
  {
    ...
    children: [
      ...
      },
      {
        ...
        xref: "cluster\xA73.2.7.27",
        details: "Indicates a representation of the maximum intensity of this primary as defined in Section 3.1.3, \u201CThe Dimming Light Curve\u201D, normalized such that the primary with the highest maximum intensity contains the value 254.\nA value of null shall indicate that this primary is not available."
      },
      { tag: "attribute", name: "Primary2X", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary2Y", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary2Intensity", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary3X", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary3Y", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary3Intensity", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary4X", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary4Y", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary4Intensity", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary5X", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary5Y", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary5Intensity", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary6X", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary6Y", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "Primary6Intensity", xref: "cluster\xA73.2.7" },
      {
        tag: "attribute",
        name: "WhitePointX",
        xref: "cluster\xA73.2.7.29",
      ...
      },
      {
        ...
        xref: "cluster\xA73.2.7.33",
        details: "Indicates a representation of the relative intensity of the red color point as defined in Section 3.1.3, \u201CThe Dimming Light Curve\u201D, normalized such that the color point with the highest relative intensity contains the value 254.\nA value of null shall indicate an invalid value."
      },
      { tag: "attribute", name: "ColorPointGx", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "ColorPointGy", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "ColorPointGIntensity", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "ColorPointBx", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "ColorPointBy", xref: "cluster\xA73.2.7" },
      { tag: "attribute", name: "ColorPointBIntensity", xref: "cluster\xA73.2.7" },
      {
        tag: "attribute",
        name: "EnhancedCurrentHue",
        xref: "cluster\xA73.2.7.12",
      ...
      },
      {
        ...
        xref: "cluster\xA73.2.7.15",
        details: "Indicates the current direction of the color loop. If this attribute has the value Decrement, the EnhancedCurrentHue attribute shall be decremented. If this attribute has the value Increment, the EnhancedCurrentHue attribute shall be incremented."
      },
      {
        tag: "attribute",
        name: "ColorLoopTime",
        xref: "cluster\xA73.2.7.16",
      ...
      },
      {
        ...
        xref: "cluster\xA73.2.7.20",
        details: "Indicates the minimum mired value supported by the hardware. ColorTempPhysicalMinMireds corresponds to the maximum color temperature in kelvins supported by the hardware. ColorTempPhysicalMinMireds <= ColorTemperatureMireds."
      },
      {
        tag: "attribute",
        name: "ColorTempPhysicalMaxMireds",
        xref: "cluster\xA73.2.7.21",
        details: "Indicates the maximum mired value supported by the hardware. ColorTempPhysicalMaxMireds corresponds to the minimum color temperature in kelvins supported by the hardware. ColorTemperatureMireds <= ColorTempPhysicalMaxMireds."
      },
      {
        tag: "attribute",
        name: "CoupleColorTempToLevelMinMireds",
        xref: "cluster\xA73.2.7.22",
      ...
      },
      {
        tag: "command",
        name: "MoveHue",
        xref: "cluster\xA73.2.8.5",
        children: [
          {
            tag: "field",
            name: "MoveMode",
            xref: "cluster\xA73.2.8.5.1",
            details: "This field shall indicate the mode of movement."
          },
          {
            tag: "field",
            name: "Rate",
            xref: "cluster\xA73.2.8.5.2",
      ...
      { tag: "command", name: "MoveToHueAndSaturation", xref: "cluster\xA73.2.8.10" },
      { tag: "command", name: "MoveToColor", xref: "cluster\xA73.2.8.11" },
      {
        tag: "command",
        name: "MoveColor",
        xref: "cluster\xA73.2.8.12",
        children: [
          {
            tag: "field",
            name: "RateX",
            xref: "cluster\xA73.2.8.12.1",
      ...
      },
      {
        tag: "command",
        name: "StepColor",
        xref: "cluster\xA73.2.8.13",
        children: [{
          tag: "field",
          name: "TransitionTime",
          xref: "cluster\xA73.2.8.13.2",
          details: "The field shall indicate, in 1/10ths of a second, the time that shall be taken to perform the color change."
        }]
      },
      { tag: "command", name: "MoveToColorTemperature", xref: "cluster\xA73.2.8.14" },
      {
        tag: "command",
        name: "EnhancedMoveToHue",
        xref: "cluster\xA73.2.8.15",
        ...
        children: [
          {
            tag: "field",
            name: "EnhancedHue",
            xref: "cluster\xA73.2.8.15.1",
            details: "This field shall indicate the target extended hue for the light."
          },
          {
            tag: "field",
            name: "Direction",
            xref: "cluster\xA73.2.8.15.2",
            details: "This field shall indicate the movement direction."
          },
          {
            tag: "field",
            name: "TransitionTime",
            xref: "cluster\xA73.2.8.15.3",
        ...
        children: [
          {
            tag: "field",
            name: "StepMode",
            xref: "cluster\xA73.2.8.17.1",
            details: "This field shall indicate the mode of the step to be performed, as described in the StepHue command."
          },
          {
            tag: "field",
            name: "StepSize",
            xref: "cluster\xA73.2.8.17.2",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            xref: "cluster\xA73.2.8.21.3",
            details: "This field shall indicate a lower bound on the ColorTemperatureMireds attribute (\u2261 an upper bound on the color temperature in kelvins) for the current move operation\nColorTempPhysicalMinMireds <= ColorTemperatureMinimumMireds field <= ColorTemperatureMireds As such if the move operation takes the ColorTemperatureMireds attribute towards the value of the ColorTemperatureMinimumMireds field it shall be clipped so that the above invariant is satisfied. If the ColorTemperatureMinimumMireds field is set to 0, ColorTempPhysicalMinMireds shall be used as the lower bound for the ColorTemperatureMireds attribute."
          },
          {
            tag: "field",
            name: "ColorTemperatureMaximumMireds",
            xref: "cluster\xA73.2.8.21.4",
            details: "This field shall indicate an upper bound on the ColorTemperatureMireds attribute (\u2261 a lower bound on the color temperature in kelvins) for the current move operation\nColorTemperatureMireds <= ColorTemperatureMaximumMireds field <= ColorTempPhysicalMaxMireds As such if the move operation takes the ColorTemperatureMireds attribute towards the value of the ColorTemperatureMaximumMireds field it shall be clipped so that the above invariant is satisfied. If the ColorTemperatureMaximumMireds field is set to 0, ColorTempPhysicalMaxMireds shall be used as the upper bound for the ColorTemperatureMireds attribute."
          }
        ]
      },
      {
        ...
        children: [
          ...
          },
          {
            tag: "field",
            name: "ColorTemperatureMinimumMireds",
            xref: "cluster\xA73.2.8.22.4",
            details: "This field shall indicate a lower bound on the ColorTemperatureMireds attribute (\u2261 an upper bound on the color temperature in kelvins) for the current step operation\nColorTempPhysicalMinMireds <= ColorTemperatureMinimumMireds field <= ColorTemperatureMireds As such if the step operation takes the ColorTemperatureMireds attribute towards the value of the ColorTemperatureMinimumMireds field it shall be clipped so that the above invariant is satisfied. If the ColorTemperatureMinimumMireds field is set to 0, ColorTempPhysicalMinMireds shall be used as the lower bound for the ColorTemperatureMireds attribute."
          },
          {
            tag: "field",
            name: "ColorTemperatureMaximumMireds",
            xref: "cluster\xA73.2.8.22.5",
            details: "This field shall indicate an upper bound on the ColorTemperatureMireds attribute (\u2261 a lower bound on the color temperature in kelvins) for the current step operation\nColorTemperatureMireds \u2264 ColorTemperatureMaximumMireds field \u2264 ColorTempPhysicalMaxMireds As such if the step operation takes the ColorTemperatureMireds attribute towards the value of the ColorTemperatureMaximumMireds field it shall be clipped so that the above invariant is satisfied. If the ColorTemperatureMaximumMireds field is set to 0, ColorTempPhysicalMaxMireds shall be used as the upper bound for the ColorTemperatureMireds attribute."
          }
        ]
      },
      {
        tag: "datatype",
        name: "OptionsBitmap",
        xref: "cluster\xA73.2.6.2",
        children: [{
          tag: "field",
          name: "ExecuteIfOff",
          description: "Dependency on On/Off cluster",
          xref: "cluster\xA73.2.6.2.1",
      ...
      {
        tag: "datatype",
        name: "DriftCompensationEnum",
        xref: "cluster\xA73.2.6.4",
        children: [
      ...
      {
        tag: "datatype",
        name: "EnhancedColorModeEnum",
        xref: "cluster\xA73.2.6.6",
        children: [
          {
            tag: "field",
            name: "CurrentHueAndCurrentSaturation",
      ...
      {
        tag: "datatype",
        name: "ColorLoopActionEnum",
        xref: "cluster\xA73.2.6.10",
        children: [
      ...
      {
        tag: "datatype",
        name: "ColorLoopDirectionEnum",
        xref: "cluster\xA73.2.6.11",
        children: [
...
//# sourceMappingURL=color-control.resource.js.map
