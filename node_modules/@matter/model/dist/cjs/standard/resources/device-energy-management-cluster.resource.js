...
import_Resource.Resource.add(
  {
    ...
    children: [
      ...
      },
      {
        tag: "datatype",
        name: "CostTypeEnum",
        xref: "cluster\xA79.2.7.1",
        children: [
          {
            tag: "field",
            name: "Financial",
            description: "Financial cost",
            xref: "cluster\xA79.2.7.1.1",
      ...
      {
        tag: "datatype",
        name: "PowerAdjustReasonEnum",
        xref: "cluster\xA79.2.7.8",
        children: [
      ...
      },
      {
        ...
        xref: "cluster\xA79.2.7.10",
        children: [
          {
            tag: "field",
            name: "MinPower",
            xref: "cluster\xA79.2.7.10.1",
      ...
      {
        tag: "datatype",
        name: "PowerAdjustCapabilityStruct",
        xref: "cluster\xA79.2.7.11",
        children: [{
          tag: "field",
          name: "PowerAdjustCapability",
          xref: "cluster\xA79.2.7.12",
      ...
      },
      {
        ...
        xref: "cluster\xA79.2.7.15",
        children: [
          {
            tag: "field",
            name: "SlotIndex",
            xref: "cluster\xA79.2.7.15.1",
...
//# sourceMappingURL=device-energy-management-cluster.resource.js.map
