  ...
  children: [
    {
      tag: "attribute",
      name: "FeatureMap",
      xref: "cluster\xA71.17.4",
      children: [
        {
          tag: "field",
          name: "SELRUN",
          xref: "cluster\xA71.17.4.1",
    ...
    },
    {
      tag: "datatype",
      name: "ProgressStruct",
      xref: "cluster\xA71.17.5.5",
      details: "This is a struct indicating the progress.",
      children: [
        {
          tag: "field",
          name: "AreaId",
          xref: "cluster\xA71.17.5.5.1",
    ...
    {
      tag: "datatype",
      name: "SelectAreasStatus",
      xref: "cluster\xA71.17.5.6.1",
      children: [
        {
          tag: "field",
          name: "Success",
...
//# sourceMappingURL=service-area.resource.js.map
