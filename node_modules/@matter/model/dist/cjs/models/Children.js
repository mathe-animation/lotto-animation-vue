...
function Children(initial, adopt, reroot, disown) {
  ...
  function deleteChild(child) {
    ...
    onNameChanged?.(child.name, void 0);
    doDisown(child);
  }
  ...
  function doAdopt(child) {
    adopt(child);
    onNameChanged?.(child.name, child);
    doReroot(child, true);
  }
  function doDisown(child) {
    onNameChanged?.(child.name, void 0);
    if (disown(child)) {
