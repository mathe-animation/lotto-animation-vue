 ...
 */
export declare function Children<T extends Model = Model>(initial: Children.InputIterable<T>, adopt: (child: Model) => void, reroot: (child: Model, isOwned: boolean) => boolean, disown: (child: Model) => boolean): InternalChildren<T>;
