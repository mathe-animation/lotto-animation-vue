...
var ServerEndpointStore_exports = {};
__export(ServerEndpointStore_exports, {
  ServerEndpointStore: () => ServerEndpointStore
});
module.exports = __toCommonJS(ServerEndpointStore_exports);
var import_general = require("#general");
var import_EndpointStore = require("#storage/EndpointStore.js");
var import_DatasourceStore = require("./DatasourceStore.js");
/**
 * @license
...
class ServerEndpointStore extends import_EndpointStore.EndpointStore {
  #number;
  #childStorage;
  #childStores = {};
  get number() {
  ...
  childStoreFor(endpoint) {
    if (!endpoint.lifecycle.hasId) {
      throw new import_general.ImplementationError("Cannot access endpoint storage because endpoint has no assigned ID");
    }
