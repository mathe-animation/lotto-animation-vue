...
var StateStream_exports = {};
__export(StateStream_exports, {
  DEFAULT_COALESCE_INTERVAL: () => DEFAULT_COALESCE_INTERVAL,
  StateStream: () => StateStream
});
module.exports = __toCommonJS(StateStream_exports);
var import_general = require("#general");
var import_model = require("#model");
var import_Node = require("#node/Node.js");
var import_ChangeNotificationService = require("./ChangeNotificationService.js");
/**
 * @license
 * Copyright 2022-2026 Matter.js Authors
 * SPDX-License-Identifier: Apache-2.0
 */
const DEFAULT_COALESCE_INTERVAL = (0, import_general.Millis)(250);
function StateStream(node, { nodes: nodeFilter, clusters: clusterFilter, versions, coalesceInterval, abort } = {}) {
  const changeService = node.env.get(import_ChangeNotificationService.ChangeNotificationService);
  const gate = new import_general.Gate();
  ...
  async function* stream() {
    try {
      ...
      while (true) {
        await import_general.Abort.race(abort, gate);
        if (import_general.Abort.is(abort)) {
          break;
        }
        while (queueHead) {
          if (import_general.Abort.is(abort)) {
          ...
          if (state.dirty) {
            ...
            changes = (0, import_general.deepCopy)(changes);
          }
          yield {
            kind: "update",
            node: node2,
  ...
  function enqueueUpdate(change) {
    ...
    const node2 = endpoint.env.get(import_Node.Node);
...
((StateStream2) => {
  ...
  StateStream2.OptionsSchema = new import_model.DatatypeModel(
    { name: "ChangeOptions", type: "struct", quality: "X" },
    (0, import_model.FieldElement)({ name: "nodes", type: "list" }, (0, import_model.FieldElement)({ name: "entry", type: "string" })),
    (0, import_model.FieldElement)({ name: "clusters", type: "list" }, (0, import_model.FieldElement)({ name: "entry", type: "string" })),
    (0, import_model.FieldElement)(
      { name: "versions", type: "list" },
      (0, import_model.FieldElement)(
        { name: "entry", type: "struct" },
        (0, import_model.FieldElement)({ name: "node", type: "string", conformance: "M" }),
        (0, import_model.FieldElement)({ name: "endpoint", type: "endpoint-no", conformance: "M" }),
        (0, import_model.FieldElement)({ name: "cluster", type: "string", conformance: "M" }),
        (0, import_model.FieldElement)({ name: "version", type: "data-ver", conformance: "M" })
      )
    ),
    (0, import_model.FieldElement)({ name: "coalesceInterval", type: "duration" })
  );
  StateStream2.WireUpdateSchema = new import_model.DatatypeModel(
    { name: "UpdateNotification", type: "struct" },
    (0, import_model.FieldElement)({ name: "node", type: "string" }),
    (0, import_model.FieldElement)({ name: "endpoint", type: "endpoint-no" }),
    (0, import_model.FieldElement)({ name: "version", type: "data-ver" }),
    (0, import_model.FieldElement)({ name: "cluster", type: "string" }),
    (0, import_model.FieldElement)({ name: "changes", type: "any" })
  );
  StateStream2.WireDeleteSchema = new import_model.DatatypeModel(
