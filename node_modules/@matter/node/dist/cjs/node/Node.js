...
var import_NetworkBehavior = require("#behavior/system/network/NetworkBehavior.js");
...
var import_ProtocolService = require("./integration/ProtocolService.js");
/**
 * @license
...
class Node extends import_Endpoint.Endpoint {
  ...
  async startWithMutex() {
    ...
    try {
      ...
      this.#environment.set(import_NetworkRuntime.NetworkRuntime, this.#runtime);
  ...
  get [import_general.DiagnosticPresentation.name]() {
...
((Node2) => {
  ...
  Node2.CommonRootEndpoint = (0, import_MutableEndpoint.MutableEndpoint)({
