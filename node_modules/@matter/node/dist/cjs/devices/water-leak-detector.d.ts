...
export declare namespace WaterLeakDetectorRequirements {
     ...
     */
    const BooleanStateServer: import("../index.js").ClusterBehavior.Type<import("@matter/types").ClusterTypeModifier.WithAlterations<import("@matter/types/clusters/boolean-state").BooleanState.Cluster, {
        readonly events: {
    ...
    const server: {
        mandatory: {
            ...
            BooleanState: import("../index.js").ClusterBehavior.Type<import("@matter/types").ClusterTypeModifier.WithAlterations<import("@matter/types/clusters/boolean-state").BooleanState.Cluster, {
                readonly events: {
                    readonly stateChange: {
                        readonly optional: false;
                    };
...
export declare const WaterLeakDetectorDeviceDefinition: MutableEndpoint.With<import("../index.js").EndpointType.For<{
    ...
    readonly behaviors: {
        ...
        readonly booleanState: import("../index.js").ClusterBehavior.Type<import("@matter/types").ClusterTypeModifier.WithAlterations<import("@matter/types/clusters/boolean-state").BooleanState.Cluster, {
            readonly events: {
                readonly stateChange: {
                    readonly optional: false;
                };
