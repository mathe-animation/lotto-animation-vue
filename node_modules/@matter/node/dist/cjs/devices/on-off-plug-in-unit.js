...
((OnOffPlugInUnitRequirements2) => {
  ...
  OnOffPlugInUnitRequirements2.ScenesManagementServer = import_ScenesManagementServer.ScenesManagementServer.alter({ commands: { copyScene: { optional: false } } });
  ...
  OnOffPlugInUnitRequirements2.server = {
    mandatory: {
      Identify: OnOffPlugInUnitRequirements2.IdentifyServer,
      Groups: OnOffPlugInUnitRequirements2.GroupsServer,
      ScenesManagement: OnOffPlugInUnitRequirements2.ScenesManagementServer,
      OnOff: OnOffPlugInUnitRequirements2.OnOffServer
    },
    optional: { LevelControl: OnOffPlugInUnitRequirements2.LevelControlServer }
  };
