...
export declare namespace TargetNavigatorInterface {
    interface Base {
        /**
...
export type TargetNavigatorInterface = {
    components: [{
        flags: {};
        methods: TargetNavigatorInterface.Base;
    }];
};
//# sourceMappingURL=TargetNavigatorInterface.d.ts.map