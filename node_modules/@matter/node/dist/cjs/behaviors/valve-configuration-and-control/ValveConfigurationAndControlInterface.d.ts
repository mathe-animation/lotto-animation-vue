...
export declare namespace ValveConfigurationAndControlInterface {
    interface Base {
        /**
...
export type ValveConfigurationAndControlInterface = {
    components: [{
        flags: {};
        methods: ValveConfigurationAndControlInterface.Base;
    }];
};
//# sourceMappingURL=ValveConfigurationAndControlInterface.d.ts.map