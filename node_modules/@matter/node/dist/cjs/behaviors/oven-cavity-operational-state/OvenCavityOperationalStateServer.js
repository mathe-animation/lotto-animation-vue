...
var OvenCavityOperationalStateServer_exports = {};
__export(OvenCavityOperationalStateServer_exports, {
  OvenCavityOperationalStateServer: () => OvenCavityOperationalStateServer
});
module.exports = __toCommonJS(OvenCavityOperationalStateServer_exports);
var import_operational_state = require("#clusters/operational-state");
var import_general = require("#general");
var import_OvenCavityOperationalStateBehavior = require("./OvenCavityOperationalStateBehavior.js");
/**
 * @license
 * Copyright 2022-2026 Matter.js Authors
 * SPDX-License-Identifier: Apache-2.0
 */
class OvenCavityOperationalStateServer extends import_OvenCavityOperationalStateBehavior.OvenCavityOperationalStateBehavior {
  initialize() {
  ...
  #handleOperationalError(operationalError) {
    ...
    if (this.state.operationalState !== import_operational_state.OperationalState.OperationalStateEnum.Error) {
      this.state.operationalState = import_operational_state.OperationalState.OperationalStateEnum.Error;
    }
