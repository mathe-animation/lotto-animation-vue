 ...
 */
export declare class OvenCavityOperationalStateServer extends OvenCavityOperationalStateBehavior {
    #private;
    initialize(): MaybePromise;
}
//# sourceMappingURL=OvenCavityOperationalStateServer.d.ts.map