...
export declare namespace MediaInputInterface {
    interface Base {
        /**
...
export type MediaInputInterface = {
    components: [
        {
            flags: {};
            methods: MediaInputInterface.Base;
        },
        {
            flags: {
                nameUpdates: true;
            };
            methods: MediaInputInterface.NameUpdates;
        }
    ];
};
//# sourceMappingURL=MediaInputInterface.d.ts.map