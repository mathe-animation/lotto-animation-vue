...
export declare namespace TimeSynchronizationInterface {
    interface Base {
        /**
...
export type TimeSynchronizationInterface = {
    components: [
        {
            flags: {};
            methods: TimeSynchronizationInterface.Base;
        },
        {
            flags: {
                timeSyncClient: true;
            };
            methods: TimeSynchronizationInterface.TimeSyncClient;
        },
        {
            flags: {
                ntpClient: true;
            };
            methods: TimeSynchronizationInterface.NtpClient;
        },
        {
            flags: {
                timeZone: true;
            };
            methods: TimeSynchronizationInterface.TimeZone;
        }
    ];
};
//# sourceMappingURL=TimeSynchronizationInterface.d.ts.map