 ...
 */
export declare const Pm25ConcentrationMeasurementBehaviorConstructor: ClusterBehavior.Type<ClusterType.Of<{
    readonly id: 1066;
...
export declare const Pm25ConcentrationMeasurementBehavior: Pm25ConcentrationMeasurementBehaviorConstructor;
...
export declare namespace Pm25ConcentrationMeasurementBehavior {
    interface State extends InstanceType<typeof Pm25ConcentrationMeasurementBehavior.State> {
    }
}
//# sourceMappingURL=Pm25ConcentrationMeasurementBehavior.d.ts.map