 ...
 */
const DEFAULT_MULTIPRESS_DELAY = (0, import_general.Millis)(300);
const DEFAULT_LONG_PRESS_DELAY = (0, import_general.Seconds)(2);
...
((SwitchBaseServer2) => {
  ...
  class State extends SwitchServerBase.State {
    ...
    multiPressDelay = DEFAULT_MULTIPRESS_DELAY;
