...
export declare namespace RvcCleanModeInterface {
    interface Base {
        /**
...
export type RvcCleanModeInterface = {
    components: [{
        flags: {};
        methods: RvcCleanModeInterface.Base;
    }];
};
//# sourceMappingURL=RvcCleanModeInterface.d.ts.map