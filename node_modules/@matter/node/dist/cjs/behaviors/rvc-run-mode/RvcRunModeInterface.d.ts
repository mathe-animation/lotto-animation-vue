...
export declare namespace RvcRunModeInterface {
    interface Base {
        /**
...
export type RvcRunModeInterface = {
    components: [{
        flags: {};
        methods: RvcRunModeInterface.Base;
    }];
};
//# sourceMappingURL=RvcRunModeInterface.d.ts.map