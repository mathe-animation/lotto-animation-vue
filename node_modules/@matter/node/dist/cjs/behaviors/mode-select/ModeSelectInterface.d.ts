...
export declare namespace ModeSelectInterface {
    interface Base {
        /**
...
export type ModeSelectInterface = {
    components: [{
        flags: {};
        methods: ModeSelectInterface.Base;
    }];
};
//# sourceMappingURL=ModeSelectInterface.d.ts.map