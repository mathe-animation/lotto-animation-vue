...
var RefrigeratorAndTemperatureControlledCabinetModeServer_exports = {};
__export(RefrigeratorAndTemperatureControlledCabinetModeServer_exports, {
  RefrigeratorAndTemperatureControlledCabinetModeServer: () => RefrigeratorAndTemperatureControlledCabinetModeServer
});
module.exports = __toCommonJS(RefrigeratorAndTemperatureControlledCabinetModeServer_exports);
...
var import_RefrigeratorAndTemperatureControlledCabinetModeBehavior = require("./RefrigeratorAndTemperatureControlledCabinetModeBehavior.js");
/**
 * @license
 * Copyright 2022-2026 Matter.js Authors
 * SPDX-License-Identifier: Apache-2.0
 */
class RefrigeratorAndTemperatureControlledCabinetModeServer extends import_RefrigeratorAndTemperatureControlledCabinetModeBehavior.RefrigeratorAndTemperatureControlledCabinetModeBehavior {
  initialize() {
  ...
  #assertSupportedModes() {
    ...
    if (!this.state.supportedModes.some(
      ({ modeTags }) => modeTags.some(({ value }) => value === import_refrigerator_and_temperature_controlled_cabinet_mode.RefrigeratorAndTemperatureControlledCabinetMode.ModeTag.Auto)
    )) {
...
//# sourceMappingURL=RefrigeratorAndTemperatureControlledCabinetModeServer.js.map
