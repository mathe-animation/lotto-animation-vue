...
var DishwasherModeServer_exports = {};
__export(DishwasherModeServer_exports, {
  DishwasherModeServer: () => DishwasherModeServer
});
module.exports = __toCommonJS(DishwasherModeServer_exports);
...
var import_DishwasherModeBehavior = require("./DishwasherModeBehavior.js");
/**
 * @license
 * Copyright 2022-2026 Matter.js Authors
 * SPDX-License-Identifier: Apache-2.0
 */
class DishwasherModeServer extends import_DishwasherModeBehavior.DishwasherModeBehavior {
  initialize() {
  ...
  #assertSupportedModes() {
    ...
    if (!this.state.supportedModes.some(
      ({ modeTags }) => modeTags.some(({ value }) => value === import_dishwasher_mode.DishwasherMode.ModeTag.Normal)
    )) {
