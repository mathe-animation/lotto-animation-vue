...
var EnergyEvseModeServer_exports = {};
__export(EnergyEvseModeServer_exports, {
  EnergyEvseModeServer: () => EnergyEvseModeServer
});
module.exports = __toCommonJS(EnergyEvseModeServer_exports);
var import_mode_base = require("#behaviors/mode-base");
var import_energy_evse_mode = require("#clusters/energy-evse-mode");
var import_mode_base2 = require("#clusters/mode-base");
var import_general = require("#general");
var import_EnergyEvseModeBehavior = require("./EnergyEvseModeBehavior.js");
/**
 * @license
 * Copyright 2022-2026 Matter.js Authors
 * SPDX-License-Identifier: Apache-2.0
 */
class EnergyEvseModeServer extends import_EnergyEvseModeBehavior.EnergyEvseModeBehavior {
  initialize() {
  ...
  #assertSupportedModes() {
    ...
    if (!this.state.supportedModes.some(
      ({ modeTags }) => modeTags.some(({ value }) => value === import_energy_evse_mode.EnergyEvseMode.ModeTag.Manual) && !modeTags.some(
        ({ value }) => value === import_energy_evse_mode.EnergyEvseMode.ModeTag.TimeOfUse || value === import_energy_evse_mode.EnergyEvseMode.ModeTag.SolarCharging
      )
    )) {
...
//# sourceMappingURL=EnergyEvseModeServer.js.map
