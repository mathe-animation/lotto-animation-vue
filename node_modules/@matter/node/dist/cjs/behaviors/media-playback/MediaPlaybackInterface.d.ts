...
export declare namespace MediaPlaybackInterface {
    interface Base {
        /**
...
export type MediaPlaybackInterface = {
    components: [
        {
            flags: {};
            methods: MediaPlaybackInterface.Base;
        },
        {
            flags: {
                advancedSeek: true;
            };
            methods: MediaPlaybackInterface.AdvancedSeek;
        },
        {
            flags: {
                audioTracks: true;
            };
            methods: MediaPlaybackInterface.AudioTracks;
        },
        {
            flags: {
                textTracks: true;
            };
            methods: MediaPlaybackInterface.TextTracks;
        },
        {
            flags: {
                variableSpeed: true;
            };
            methods: MediaPlaybackInterface.VariableSpeed;
        }
    ];
};
//# sourceMappingURL=MediaPlaybackInterface.d.ts.map