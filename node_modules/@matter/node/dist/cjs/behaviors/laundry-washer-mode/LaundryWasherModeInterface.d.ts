...
export declare namespace LaundryWasherModeInterface {
    interface Base {
        /**
...
export type LaundryWasherModeInterface = {
    components: [{
        flags: {};
        methods: LaundryWasherModeInterface.Base;
    }];
};
//# sourceMappingURL=LaundryWasherModeInterface.d.ts.map