...
export declare namespace RvcOperationalStateInterface {
    interface Base {
        /**
...
export type RvcOperationalStateInterface = {
    components: [{
        flags: {};
        methods: RvcOperationalStateInterface.Base;
    }];
};
//# sourceMappingURL=RvcOperationalStateInterface.d.ts.map