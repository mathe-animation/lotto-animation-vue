...
export declare namespace JointFabricAdministratorInterface {
    interface Base {
        /**
...
export type JointFabricAdministratorInterface = {
    components: [{
        flags: {};
        methods: JointFabricAdministratorInterface.Base;
    }];
};
//# sourceMappingURL=JointFabricAdministratorInterface.d.ts.map