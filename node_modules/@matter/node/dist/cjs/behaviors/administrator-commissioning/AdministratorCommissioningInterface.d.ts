...
export declare namespace AdministratorCommissioningInterface {
    interface Base {
        /**
...
export type AdministratorCommissioningInterface = {
    components: [
        {
            flags: {};
            methods: AdministratorCommissioningInterface.Base;
        },
        {
            flags: {
                basic: true;
            };
            methods: AdministratorCommissioningInterface.Basic;
        }
    ];
};
//# sourceMappingURL=AdministratorCommissioningInterface.d.ts.map