...
export declare namespace OtaSoftwareUpdateRequestorInterface {
    interface Base {
        /**
...
export type OtaSoftwareUpdateRequestorInterface = {
    components: [{
        flags: {};
        methods: OtaSoftwareUpdateRequestorInterface.Base;
    }];
};
//# sourceMappingURL=OtaSoftwareUpdateRequestorInterface.d.ts.map