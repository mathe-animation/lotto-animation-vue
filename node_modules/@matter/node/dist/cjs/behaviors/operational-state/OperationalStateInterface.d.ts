...
export declare namespace OperationalStateInterface {
    interface Base {
        /**
...
export type OperationalStateInterface = {
    components: [{
        flags: {};
        methods: OperationalStateInterface.Base;
    }];
};
//# sourceMappingURL=OperationalStateInterface.d.ts.map