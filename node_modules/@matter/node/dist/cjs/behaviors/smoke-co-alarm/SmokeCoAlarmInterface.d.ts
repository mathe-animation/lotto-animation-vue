...
export declare namespace SmokeCoAlarmInterface {
    interface Base {
        /**
...
export type SmokeCoAlarmInterface = {
    components: [{
        flags: {};
        methods: SmokeCoAlarmInterface.Base;
    }];
};
//# sourceMappingURL=SmokeCoAlarmInterface.d.ts.map