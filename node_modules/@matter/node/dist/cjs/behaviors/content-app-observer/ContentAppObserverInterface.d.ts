...
export declare namespace ContentAppObserverInterface {
    interface Base {
        /**
...
export type ContentAppObserverInterface = {
    components: [{
        flags: {};
        methods: ContentAppObserverInterface.Base;
    }];
};
//# sourceMappingURL=ContentAppObserverInterface.d.ts.map