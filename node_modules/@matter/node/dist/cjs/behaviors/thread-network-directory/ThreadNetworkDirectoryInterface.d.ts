...
export declare namespace ThreadNetworkDirectoryInterface {
    interface Base {
        /**
...
export type ThreadNetworkDirectoryInterface = {
    components: [{
        flags: {};
        methods: ThreadNetworkDirectoryInterface.Base;
    }];
};
//# sourceMappingURL=ThreadNetworkDirectoryInterface.d.ts.map