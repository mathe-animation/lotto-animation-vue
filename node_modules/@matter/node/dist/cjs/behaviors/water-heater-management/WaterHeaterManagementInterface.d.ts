...
export declare namespace WaterHeaterManagementInterface {
    interface Base {
        /**
...
export type WaterHeaterManagementInterface = {
    components: [{
        flags: {};
        methods: WaterHeaterManagementInterface.Base;
    }];
};
//# sourceMappingURL=WaterHeaterManagementInterface.d.ts.map