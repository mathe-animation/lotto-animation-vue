...
export declare namespace MicrowaveOvenControlInterface {
    interface Base {
        /**
...
export type MicrowaveOvenControlInterface = {
    components: [{
        flags: {};
        methods: MicrowaveOvenControlInterface.Base;
    }];
};
//# sourceMappingURL=MicrowaveOvenControlInterface.d.ts.map