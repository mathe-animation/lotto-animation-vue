 ...
 */
import { ImplementationError, MatterAggregateError } from "#general";
 ...
 */
export declare class ClusterImplementationError extends MatterAggregateError {
    constructor(name: string, errors: ClusterElementError[]);
}
/**
 * Thrown when a {@link ClusterBehavior} element is implemented incorrectly.
 */
export declare class ClusterElementError extends ImplementationError {
 ...
 */
export declare class ValidatedElements {
    #private;
    /**
...
//# sourceMappingURL=ValidatedElements.d.ts.map