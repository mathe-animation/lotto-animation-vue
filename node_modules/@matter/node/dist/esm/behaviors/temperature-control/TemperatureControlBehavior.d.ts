 ...
 */
export declare const TemperatureControlBehaviorConstructor: ClusterBehavior.Type<ClusterType.Of<{
    readonly id: 86;
...
export declare const TemperatureControlBehavior: TemperatureControlBehaviorConstructor;
...
export declare namespace TemperatureControlBehavior {
    interface State extends InstanceType<typeof TemperatureControlBehavior.State> {
    }
}
