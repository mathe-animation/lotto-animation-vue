...
export declare namespace WaterHeaterModeInterface {
    interface Base {
        /**
...
export type WaterHeaterModeInterface = {
    components: [{
        flags: {};
        methods: WaterHeaterModeInterface.Base;
    }];
};
//# sourceMappingURL=WaterHeaterModeInterface.d.ts.map