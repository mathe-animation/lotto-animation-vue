...
export declare namespace ThreadNetworkDiagnosticsInterface {
...
export type ThreadNetworkDiagnosticsInterface = {
    components: [{
        ...
        methods: ThreadNetworkDiagnosticsInterface.ErrorCounts;
    }];
};
//# sourceMappingURL=ThreadNetworkDiagnosticsInterface.d.ts.map