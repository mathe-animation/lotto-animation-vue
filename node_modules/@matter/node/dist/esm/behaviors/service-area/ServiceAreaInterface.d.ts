...
export declare namespace ServiceAreaInterface {
    interface Base {
        /**
...
export type ServiceAreaInterface = {
    components: [{
        flags: {};
        methods: ServiceAreaInterface.Base;
    }];
};
//# sourceMappingURL=ServiceAreaInterface.d.ts.map