...
export declare namespace OtaSoftwareUpdateProviderInterface {
    interface Base {
        /**
...
export type OtaSoftwareUpdateProviderInterface = {
    components: [{
        flags: {};
        methods: OtaSoftwareUpdateProviderInterface.Base;
    }];
};
//# sourceMappingURL=OtaSoftwareUpdateProviderInterface.d.ts.map