...
import { Observable, Seconds, Time } from "#general";
...
class IdentifyServer extends IdentifyBehavior {
  initialize() {
    ...
    this.events.identifyTime$Changed.quiet.config = {
      shouldEmit: (newValue, oldValue, context) => hasRemoteActor(context) || (oldValue === 0 || newValue === 0) && newValue !== oldValue ? "now" : false,
