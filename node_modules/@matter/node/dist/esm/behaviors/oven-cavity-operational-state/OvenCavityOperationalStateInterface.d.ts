...
export declare namespace OvenCavityOperationalStateInterface {
    interface Base {
        /**
...
export type OvenCavityOperationalStateInterface = {
    components: [{
        flags: {};
        methods: OvenCavityOperationalStateInterface.Base;
    }];
};
//# sourceMappingURL=OvenCavityOperationalStateInterface.d.ts.map