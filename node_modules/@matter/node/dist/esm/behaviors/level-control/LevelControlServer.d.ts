...
import { AsyncObservable, Identity, MaybePromise } from "#general";
import { Val } from "#protocol";
import { ClusterType, TypeFromPartialBitSchema } from "#types";
declare const LevelControlBase: import("../../index.js").ClusterBehavior.Type<import("#types").ClusterComposer.WithFeatures<LevelControl.Cluster, readonly [LevelControl.Feature.OnOff, LevelControl.Feature.Lighting]>, import("./LevelControlBehavior.js").LevelControlBehaviorConstructor, import("./LevelControlInterface.js").LevelControlInterface>;
/**
...
export declare namespace LevelControlBaseServer {
    ...
    class State extends LevelControlBase.State {
         ...
         */
        transitionStepInterval: import("#general").Duration;
    ...
    const ExtensionInterface: {
        transition(targetLevel?: number, changePerS?: number | null | ((currentLevel: number) => number), withOnOff?: boolean, options?: TypeFromPartialBitSchema<typeof LevelControl.Options>): MaybePromise;
...
declare const LevelControlServer_base: import("../../index.js").ClusterBehavior.Type<ClusterType.Of<{
    readonly id: 8;
