...
export declare namespace EnergyEvseInterface {
    interface Base {
        /**
...
export type EnergyEvseInterface = {
    components: [
        {
            flags: {};
            methods: EnergyEvseInterface.Base;
        },
        {
            flags: {
                v2X: true;
            };
            methods: EnergyEvseInterface.V2X;
        },
        {
            flags: {
                chargingPreferences: true;
            };
            methods: EnergyEvseInterface.ChargingPreferences;
        }
    ];
};
//# sourceMappingURL=EnergyEvseInterface.d.ts.map