...
export declare namespace KeypadInputInterface {
    interface Base {
        /**
...
export type KeypadInputInterface = {
    components: [{
        flags: {};
        methods: KeypadInputInterface.Base;
    }];
};
//# sourceMappingURL=KeypadInputInterface.d.ts.map