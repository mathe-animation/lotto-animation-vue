...
declare const TimeFormatLocalizationServer_base: import("../../index.js").ClusterBehavior.Type<import("@matter/types").ClusterComposer.WithFeatures<TimeFormatLocalization.Cluster, readonly ["CalendarFormat"]>, import("./TimeFormatLocalizationBehavior.js").TimeFormatLocalizationBehaviorConstructor, {
    components: never[];
}>;
/**
