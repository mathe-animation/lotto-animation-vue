 ...
 */
export declare const OccupancySensingBehaviorConstructor: ClusterBehavior.Type<ClusterType.Of<{
    readonly id: 1030;
...
export declare const OccupancySensingBehavior: OccupancySensingBehaviorConstructor;
...
export declare namespace OccupancySensingBehavior {
    interface State extends InstanceType<typeof OccupancySensingBehavior.State> {
    }
}
