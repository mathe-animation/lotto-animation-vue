...
export declare namespace NetworkCommissioningInterface {
...
export type NetworkCommissioningInterface = {
    components: [
        ...
        },
        {
            ...
            methods: NetworkCommissioningInterface.WiFiNetworkInterface;
        },
        {
            flags: {
                threadNetworkInterface: true;
            };
            methods: NetworkCommissioningInterface.ThreadNetworkInterface;
        }
    ];
};
//# sourceMappingURL=NetworkCommissioningInterface.d.ts.map