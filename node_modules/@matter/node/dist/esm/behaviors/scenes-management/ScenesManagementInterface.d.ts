...
export declare namespace ScenesManagementInterface {
    interface Base {
        /**
...
export type ScenesManagementInterface = {
    components: [{
        flags: {};
        methods: ScenesManagementInterface.Base;
    }];
};
//# sourceMappingURL=ScenesManagementInterface.d.ts.map