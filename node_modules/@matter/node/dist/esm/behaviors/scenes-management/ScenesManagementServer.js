...
import { assertRemoteActor, FabricManager, GroupSession } from "#protocol";
import {
  AttributeId,
  ClusterId,
  Command,
...
const DataTypeToSceneAttributeDataMap = {
  [bool.name]: "valueUnsigned8" /* ValueUnsigned8 */,
  [map8.name]: "valueUnsigned8" /* ValueUnsigned8 */,
  [uint8.name]: "valueUnsigned8" /* ValueUnsigned8 */,
  [int8.name]: "valueSigned8" /* ValueSigned8 */,
  [uint16.name]: "valueUnsigned16" /* ValueUnsigned16 */,
  [map16.name]: "valueUnsigned16" /* ValueUnsigned16 */,
  [int16.name]: "valueSigned16" /* ValueSigned16 */,
  [uint24.name]: "valueUnsigned32" /* ValueUnsigned32 */,
  [uint32.name]: "valueUnsigned32" /* ValueUnsigned32 */,
  [map32.name]: "valueUnsigned32" /* ValueUnsigned32 */,
  [int32.name]: "valueSigned32" /* ValueSigned32 */,
  [uint40.name]: "valueUnsigned64" /* ValueUnsigned64 */,
  [uint48.name]: "valueUnsigned64" /* ValueUnsigned64 */,
  [uint56.name]: "valueUnsigned64" /* ValueUnsigned64 */,
  [uint64.name]: "valueUnsigned64" /* ValueUnsigned64 */,
  [map64.name]: "valueUnsigned64" /* ValueUnsigned64 */,
  [int40.name]: "valueSigned64" /* ValueSigned64 */,
  [int48.name]: "valueSigned64" /* ValueSigned64 */,
  [int56.name]: "valueSigned64" /* ValueSigned64 */,
  [int64.name]: "valueSigned64" /* ValueSigned64 */
};
...
class ScenesManagementServer extends ScenesManagementBase {
  ...
  #addOrReplaceSceneEntry(sceneData, existingSceneIndex = -1) {
    ...
    if (existingSceneIndex === -1) {
      if (this.#scenesForFabric(fabricIndex).length >= this.#fabricSceneCapacity) {
        return { status: Status.ResourceExhausted, groupId: groupId2, sceneId };
      }
    ...
    return { status: Status.Success, groupId: groupId2, sceneId };
  }
  ...
  addScene({
    ...
    if (sceneValues === void 0) {
      return { status: Status.InvalidCommand, groupId: groupId2, sceneId };
    }
  ...
  viewScene({
    ...
    if (existingSceneIndex === -1) {
      return { status: Status.NotFound, groupId: groupId2, sceneId };
    }
  ...
  removeAllScenes({
    ...
    return { status: Status.Success, groupId: groupId2 };
  }
  ...
  async recallScene({ groupId: reqGroupId, sceneId, transitionTime }) {
    ...
    if (existingSceneIndex === -1) {
      throw new StatusResponse.NotFoundError(`SceneId ${sceneId} in groupId ${groupId2} not found`);
    }
    const scene = this.state.sceneTable[existingSceneIndex];
  ...
  #decodeValueFromAttributeValuePair(attributeValuePair, { schema, type, mappedType, nullable }) {
    ...
    if (!(schema instanceof TlvNumericSchema) || schema.min === void 0 || schema.max === void 0) {
...
((ScenesManagementServer2) => {
  ...
  _sceneGroupId_dec = [field(groupId, mandatory)], _sceneId_dec = [field(uint8.extend({ constraint: "max 254" }), mandatory)], _sceneName_dec = [field(string.extend({ constraint: "max 16" }))], _sceneTransitionTime_dec = [field(uint32.extend({ constraint: "max 60000000" }), mandatory)], _sceneValues_dec = [field(any, mandatory)], _fabricIndex_dec = [field(fabricIdx, mandatory)];
  ...
  class State extends (_a = ScenesManagementBase.State, _sceneTable_dec = [field(listOf(ScenesTableEntry), nonvolatile, mandatory)], _a) {
    constructor() {
      super(...arguments);
...
export {
  DataTypeToSceneAttributeDataMap,
