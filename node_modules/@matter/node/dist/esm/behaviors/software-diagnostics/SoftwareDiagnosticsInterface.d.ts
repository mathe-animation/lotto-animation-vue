...
export declare namespace SoftwareDiagnosticsInterface {
...
export type SoftwareDiagnosticsInterface = {
    components: [{
        ...
        methods: SoftwareDiagnosticsInterface.Watermarks;
    }];
};
//# sourceMappingURL=SoftwareDiagnosticsInterface.d.ts.map