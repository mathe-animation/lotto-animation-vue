...
export declare namespace EnergyEvseModeInterface {
    interface Base {
        /**
...
export type EnergyEvseModeInterface = {
    components: [{
        flags: {};
        methods: EnergyEvseModeInterface.Base;
    }];
};
//# sourceMappingURL=EnergyEvseModeInterface.d.ts.map