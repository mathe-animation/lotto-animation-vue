...
class ColorControlBaseServer extends ColorControlBase {
  ...
  moveColorTemperatureLogic(moveMode, rate, colorTemperatureMinimumMireds, colorTemperatureMaximumMireds) {
    ...
    const targetValue = moveMode === ColorControl.MoveMode.Up ? colorTemperatureMaximumMireds : colorTemperatureMinimumMireds;
    return this.#startTransition({
      name: "colorTemperatureMireds",
      owner: this,
  ...
  #applySceneValues(values, transitionTime) {
    ...
    if (this.features.enhancedHue && typeof values.enhancedColorMode === "number" && values.enhancedColorMode <= ColorControl.EnhancedColorMode.EnhancedCurrentHueAndCurrentSaturation) {
...
((ColorControlBaseServer2) => {
  ...
  class State extends ColorControlBase.State {
    ...
    colorLoopActive = ColorControl.ColorLoopActive.Inactive;
    colorLoopDirection = ColorControl.ColorLoopDirection.Increment;
...
class ColorControlServer extends ColorControlBaseServer.for(ClusterType(ColorControl.Base)) {
}
export {
  ColorControlBaseServer,
  ColorControlServer
};
