...
export declare namespace ResourceMonitoringInterface {
    interface Base {
        /**
...
export type ResourceMonitoringInterface = {
    components: [{
        flags: {};
        methods: ResourceMonitoringInterface.Base;
    }];
};
//# sourceMappingURL=ResourceMonitoringInterface.d.ts.map