...
export declare namespace AlarmBaseInterface {
    interface Base {
        /**
...
export type AlarmBaseInterface = {
    components: [
        {
            flags: {};
            methods: AlarmBaseInterface.Base;
        },
        {
            flags: {
                reset: true;
            };
            methods: AlarmBaseInterface.Reset;
        }
    ];
};
//# sourceMappingURL=AlarmBaseInterface.d.ts.map