...
import { AsyncObservable, Duration, MaybePromise, Timestamp } from "#general";
...
export declare class Transitions<B extends Behavior> {
     ...
     */
    start(transition: Transitions.Transition<B>): MaybePromise;
    /**
...
export declare namespace Transitions {
    const DEFAULT_STEP_INTERVAL: Duration;
    const DEFAULT_EXTERNAL_TIME_UNIT: Duration;
    /**
