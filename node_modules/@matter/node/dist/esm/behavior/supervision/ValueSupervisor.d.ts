...
export declare namespace ValueSupervisor {
    /**
     ...
     */
    interface RemoteActorSession extends AccessControl.RemoteActorSession, SupervisionSettings {
        /**
    ...
    interface LocalActorSession extends AccessControl.LocalActorSession, SupervisionSettings {
    }
    type Session = LocalActorSession | RemoteActorSession;
    type Validate = (value: Val, session: Session, location: ValidationLocation) => void;
    type Manage = (reference: Val.Reference, session: Session) => Val;
    type Patch = (changes: Val.ReadonlyCollection, target: Val.Collection, path: DataModelPath) => Val;
    type Cast = (value: Val) => Val;
}
//# sourceMappingURL=ValueSupervisor.d.ts.map