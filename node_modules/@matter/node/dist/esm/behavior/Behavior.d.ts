...
import { EventEmitter, Lifetime, MaybePromise, Observable, Transaction } from "#general";
...
export declare abstract class Behavior {
     ...
     * control.
     */
    static get schema(): Schema.Struct;
    /**
    ...
    protected maybeReactTo<O extends Observable<any[], any>>(observable: O | undefined, reactor: Reactor<Parameters<O["emit"]>, ReturnType<O["emit"]>>, options?: Reactor.Options): void;
    /**
...
export declare namespace Behavior {
     ...
     */
    type InputStateOf<B extends Type> = Partial<StateOf<B>>;
    /**
