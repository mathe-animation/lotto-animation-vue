...
export declare namespace loader {
    function behavior(name: string): MaybePromise<Behavior.Type>;
    function server(name: string): MaybePromise<Behavior.Type>;
    function device(name: string): MaybePromise<EndpointType>;
    function endpoint(name: string): MaybePromise<EndpointType>;
    const registry: Record<string, Record<string, {} | undefined> | undefined>;
}
