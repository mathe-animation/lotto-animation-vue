...
function detectBlock(text, breadcrumb) {
  ...
  breadcrumb.length = 1;
  function enterBlock(kind, sourceIndent) {
    if (sourceIndent !== void 0 && kind === "-" /* Bullet1 */) {
      let matchLevel = -1;
      for (let i = breadcrumb.length - 1; i >= 0; i--) {
        if (breadcrumb[i].kind === kind) {
          if (breadcrumb[i].sourceIndent !== void 0 && breadcrumb[i].sourceIndent <= sourceIndent) {
            matchLevel = i;
