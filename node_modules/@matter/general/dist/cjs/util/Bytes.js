...
((Bytes2) => {
  ...
  function areEqual(array1, array2) {
    ...
    const data1 = Bytes2.of(array1);
    const data2 = Bytes2.of(array2);
  ...
  function asBigInt(bytes) {
    const view = Bytes2.dataViewOf(bytes);
    let result = 0n;
