...
const ContextTagged = (tagId, value) => ({
  _tag: tagId | 128 /* ContextSpecific */ | CONSTRUCTED,
  _bytes: value === void 0 ? new Uint8Array(0) : DerCodec.encode(value)
});
const ContextTaggedBytes = (tagId, value) => ({
  _tag: tagId | 128 /* ContextSpecific */,
  _bytes: value
});
...
class DerCodec {
  static encode(value) {
    if (Array.isArray(value)) {
      ...
      if (value._tag !== void 0) {
        ...
        if (bytes === void 0 || !Bytes.isBytes(bytes)) {
          throw new DerError("DER bytes is not a byte array");
        }
        return this.#encodeAsn1(
          tagId,
          bitsPadding === void 0 ? bytes : Bytes.concat(Uint8Array.of(bitsPadding), Bytes.of(bytes))
        );
      } else if (value._type !== void 0 && value._raw !== void 0) {
        if (value._type === 2 /* Integer */ && Bytes.isBytes(value._raw)) {
          return this.#encodeInteger(value._raw);
        } else if (value._type === 3 /* BitString */ && typeof value._raw === "number") {
          return this.#encodeBitString(value._raw);
        } else if (value._type === 19 /* PrintableString */ && typeof value._raw === "string") {
          return this.#encodePrintableString(value._raw);
        } else if (value._type === 22 /* IA5String */ && typeof value._raw === "string") {
          return this.#encodeIA5String(value._raw);
        } else {
          throw new DerError(`Unsupported override type ${value._type}`);
        }
      } else if ("_bytes" in value && value._bytes !== void 0 && Bytes.isBytes(value._bytes) && Object.keys(value).length === 1) {
        return Bytes.of(value._bytes);
      } else if (value._type === void 0 && value._bytes === void 0) {
  ...
  static #encodeInteger(value) {
    ...
    return this.#encodeAsn1(2 /* Integer */, start === 0 ? byteArray : Bytes.of(byteArray).slice(start));
  }
