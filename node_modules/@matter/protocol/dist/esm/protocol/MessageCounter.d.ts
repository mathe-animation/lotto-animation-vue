 ...
 */
import { Construction, Crypto, StorageContext } from "#general";
...
export declare class MessageCounter {
    protected readonly onRollover?: (() => Promise<void>) | undefined;
     ...
     */
    constructor(crypto: Crypto, onRollover?: (() => Promise<void>) | undefined, rolloverInfoDifference?: number);
...
export declare class PersistedMessageCounter extends MessageCounter {
    ...
    static create(crypto: Crypto, storageContext: StorageContext, storageKey: string, aboutToRolloverCallback?: () => Promise<void>, rolloverInfoDifference?: number): Promise<PersistedMessageCounter>;
    constructor(crypto: Crypto, storageContext: StorageContext, storageKey: string, aboutToRolloverCallback?: () => Promise<void>, rolloverInfoDifference?: number);
    getIncrementedCounter(): Promise<number>;
}
