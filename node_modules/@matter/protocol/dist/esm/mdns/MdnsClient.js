...
const GOODBYE_PROTECTION_WINDOW = Millis(1e3);
...
class MdnsClient {
  ...
  async #registerWaiterPromise(queryId, commissionable, timeout, responder, resolveOnUpdatedRecords = true, cancelResolver) {
    ...
    const timer = timeout !== void 0 ? Time.getTimer("MDNS timeout", timeout, () => {
      cancelResolver?.();
   ...
   */
  async findCommissionableDevices(identifier, timeout = Seconds(5), ignoreExistingRecords = false) {
