...
class MessageCounter {
   ...
   */
  constructor(crypto, onRollover, rolloverInfoDifference = ROLLOVER_INFO_DIFFERENCE) {
  ...
  async getIncrementedCounter() {
    ...
    if (this.messageCounter > MAX_COUNTER_VALUE_32BIT) {
      if (this.onRollover !== void 0) {
        this.messageCounter = 0;
      } else {
        throw new import_general.InternalError("Message counter rollover not allowed.");
      }
    } else if (this.onRollover !== void 0 && this.messageCounter === MAX_COUNTER_VALUE_32BIT - this.rolloverInfoDifference) {
...
class PersistedMessageCounter extends MessageCounter {
  constructor(crypto, storageContext, storageKey, aboutToRolloverCallback, rolloverInfoDifference = ROLLOVER_INFO_DIFFERENCE) {
    ...
    this.#construction = (0, import_general.Construction)(this, async () => {
      if (await storageContext.has(storageKey)) {
        ...
        if (this.onRollover !== void 0 && this.messageCounter >= MAX_COUNTER_VALUE_32BIT - this.rolloverInfoDifference) {
          await this.onRollover();
        }
      }
    });
  ...
  static async create(crypto, storageContext, storageKey, aboutToRolloverCallback, rolloverInfoDifference = ROLLOVER_INFO_DIFFERENCE) {
