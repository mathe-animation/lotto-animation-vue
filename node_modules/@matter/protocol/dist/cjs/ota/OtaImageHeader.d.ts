 ...
 */
export declare const TlvOtaImageHeader: import("#types").ObjectSchema<{
    /**
     ...
     * one vendor.
     */
    vendorId: import("#types").FieldType<number>;
    /**
     ...
     * one product.
     */
    productId: import("#types").FieldType<number>;
    /**
     ...
     */
    softwareVersion: import("#types").FieldType<number>;
    /**
     ...
     */
    softwareVersionString: import("#types").FieldType<string>;
    /**
     ...
     */
    payloadSize: import("#types").FieldType<number | bigint>;
    /**
     ...
     */
    minApplicableSoftwareVersion: import("#types").OptionalFieldType<number>;
    /**
     ...
     * received in the Query Image command from the OTA Requestor.
     */
    maxApplicableSoftwareVersion: import("#types").OptionalFieldType<number>;
    /**
     ...
     */
    releaseNotesUrl: import("#types").OptionalFieldType<string>;
    /**
     ...
     */
    imageDigestType: import("#types").FieldType<number>;
    /**
     ...
     */
    imageDigest: import("#types").FieldType<AllowSharedBufferSource>;
}>;
export interface OtaImageHeader extends TypeFromSchema<typeof TlvOtaImageHeader> {
}
//# sourceMappingURL=OtaImageHeader.d.ts.map