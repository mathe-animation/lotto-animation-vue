...
var OtaImageHeader_exports = {};
__export(OtaImageHeader_exports, {
  TlvOtaImageHeader: () => TlvOtaImageHeader
});
module.exports = __toCommonJS(OtaImageHeader_exports);
 ...
 */
const TlvOtaImageHeader = (0, import_types.TlvObject)({
  /**
   ...
   * one vendor.
   */
  vendorId: (0, import_types.TlvField)(0, import_types.TlvUInt16),
  /**
   ...
   * one product.
   */
  productId: (0, import_types.TlvField)(1, import_types.TlvUInt16),
  /**
   ...
   */
  softwareVersion: (0, import_types.TlvField)(2, import_types.TlvUInt32),
  /**
   ...
   */
  softwareVersionString: (0, import_types.TlvField)(3, import_types.TlvString.bound({ minLength: 1, maxLength: 64 })),
  /**
   ...
   */
  payloadSize: (0, import_types.TlvField)(4, import_types.TlvUInt64),
  /**
   ...
   */
  minApplicableSoftwareVersion: (0, import_types.TlvOptionalField)(5, import_types.TlvUInt32),
  /**
   ...
   * received in the Query Image command from the OTA Requestor.
   */
  maxApplicableSoftwareVersion: (0, import_types.TlvOptionalField)(6, import_types.TlvUInt32),
  /**
   ...
   */
  releaseNotesUrl: (0, import_types.TlvOptionalField)(7, import_types.TlvString.bound({ minLength: 1, maxLength: 256 })),
  /**
   ...
   */
  imageDigestType: (0, import_types.TlvField)(8, import_types.TlvUInt8),
  /**
   ...
   */
  imageDigest: (0, import_types.TlvField)(9, import_types.TlvByteString.bound({ maxLength: 64 }))
});
//# sourceMappingURL=OtaImageHeader.js.map
