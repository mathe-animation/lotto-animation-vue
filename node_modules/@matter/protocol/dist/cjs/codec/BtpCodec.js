...
class BtpCodec {
  ...
  static encodeBtpPacket({ header, payload }) {
    return import_general.Bytes.concat(this.encodeBtpPacketHeader(header), this.encodeBtpPacketPayload(header, payload));
  }
  ...
  static encodeBtpPacketPayload({ hasAckNumber, isBeginningSegment, isContinuingSegment, isEndingSegment }, { ackNumber, sequenceNumber, messageLength, segmentPayload }) {
    ...
    if ((isBeginningSegment || isContinuingSegment) && (segmentPayload === void 0 || segmentPayload.byteLength === 0)) {
